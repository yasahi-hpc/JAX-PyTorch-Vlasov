...
template <typename T>
struct TestLagrange2D2V : public ::testing::Test {
...
TYPED_TEST_SUITE(TestLagrange2D2V, test_types);

// Test lagrange interpolation for different precision types
TYPED_TEST(TestLagrange2D2V, LagrangeInterpolationExactPolynomials) {
...
TYPED_TEST(TestLagrange2D2V, LagrangeInterpolationNodes) {
  using FloatType  = typename TestFixture::float_type;
  using LayoutType = typename TestFixture::layout_type;
