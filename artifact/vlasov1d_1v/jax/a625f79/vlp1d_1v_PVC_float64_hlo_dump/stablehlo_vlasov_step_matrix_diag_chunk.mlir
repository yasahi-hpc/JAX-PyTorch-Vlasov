module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<65xf64>, %arg3: tensor<6xi32>, %arg4: tensor<128xf64>, %arg5: tensor<128xf64>, %arg6: tensor<128x128xf64>, %arg7: tensor<128xf64>, %arg8: tensor<f64>, %arg9: tensor<i64>) -> (tensor<128xf64> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<65xf64> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<6xi32> {jax.result_info = "[<flat index 0>][<flat index 3>]"}, tensor<128xf64> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 1>][<flat index 1>]"}, tensor<128x128xf64> {jax.result_info = "[<flat index 2>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 2>][<flat index 1>]"}, tensor<f64> {jax.result_info = "[<flat index 3>]"}, tensor<i64> {jax.result_info = "[<flat index 4>]"}) {
    ...
    %0:7 = stablehlo.while(%iterArg = %cst, %iterArg_4 = %c, %iterArg_5 = %cst_0, %iterArg_6 = %c_1, %iterArg_7 = %arg6, %iterArg_8 = %arg4, %iterArg_9 = %arg5) : tensor<128xf64>, tensor<6xi32>, tensor<65xf64>, tensor<i64>, tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>
     cond {
      ...
      %3:3 = func.call @None(%iterArg, %iterArg_4, %iterArg_5, %iterArg_7, %iterArg_8, %iterArg_9) : (tensor<128xf64>, tensor<6xi32>, tensor<65xf64>, tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>)
  ...
  func.func private @None(%arg0: tensor<128xf64>, %arg1: tensor<6xi32>, %arg2: tensor<65xf64>, %arg3: tensor<128x128xf64>, %arg4: tensor<128xf64>, %arg5: tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) {
    %cst = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_0 = stablehlo.constant dense<0.098174770424681035> : tensor<f64>
    %0 = call @advect_1d_matrix_diag(%arg3, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %cst_1 = stablehlo.constant dense<0.078740157480314959> : tensor<f64>
    %1:3 = call @solve_poisson(%0, %arg2, %cst_1) : (tensor<128x128xf64>, tensor<65xf64>, tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>)
    %cst_2 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %2 = call @advect_1d_matrix_diag_1(%0, %1#0, %cst_2, %cst_1, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %3 = call @advect_1d_matrix_diag(%2, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
  ...
  func.func private @advect_1d_matrix_diag(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    ...
    %19 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %20 = stablehlo.divide %11, %19 : tensor<128xf64>
    %21 = stablehlo.subtract %18, %20 : tensor<128xf64>
    %22 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %25 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %28 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %29 = stablehlo.divide %7, %28 : tensor<128xf64>
    %30 = stablehlo.negate %29 : tensor<128xf64>
    %31 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %32 = stablehlo.multiply %31, %10 : tensor<128xf64>
    %cst_4 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %33 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %34 = stablehlo.divide %32, %33 : tensor<128xf64>
    %35 = stablehlo.add %30, %34 : tensor<128xf64>
    %36 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %39 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %40 = stablehlo.divide %12, %39 : tensor<128xf64>
    %41 = stablehlo.subtract %38, %40 : tensor<128xf64>
    %42 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %43 = stablehlo.divide %13, %42 : tensor<128xf64>
    %44 = stablehlo.add %41, %43 : tensor<128xf64>
    %45 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %46 = stablehlo.divide %7, %45 : tensor<128xf64>
    %cst_6 = stablehlo.constant dense<1.000000e+00> : tensor<f64>
    %47 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %51 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %52 = stablehlo.divide %50, %51 : tensor<128xf64>
    %53 = stablehlo.subtract %48, %52 : tensor<128xf64>
    %54 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %55 = stablehlo.multiply %54, %11 : tensor<128xf64>
    %cst_9 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %56 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %57 = stablehlo.divide %55, %56 : tensor<128xf64>
    %58 = stablehlo.add %53, %57 : tensor<128xf64>
    %59 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %60 = stablehlo.divide %12, %59 : tensor<128xf64>
    %61 = stablehlo.add %58, %60 : tensor<128xf64>
    %62 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %63 = stablehlo.divide %13, %62 : tensor<128xf64>
    %64 = stablehlo.subtract %61, %63 : tensor<128xf64>
    %65 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %66 = stablehlo.multiply %65, %10 : tensor<128xf64>
    %67 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %70 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %71 = stablehlo.multiply %70, %11 : tensor<128xf64>
    %72 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %73 = stablehlo.divide %71, %72 : tensor<128xf64>
    %74 = stablehlo.subtract %69, %73 : tensor<128xf64>
    %75 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %76 = stablehlo.divide %12, %75 : tensor<128xf64>
    %77 = stablehlo.subtract %74, %76 : tensor<128xf64>
    %78 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %79 = stablehlo.divide %13, %78 : tensor<128xf64>
    %80 = stablehlo.add %77, %79 : tensor<128xf64>
    %81 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %82 = stablehlo.divide %7, %81 : tensor<128xf64>
    %83 = stablehlo.negate %82 : tensor<128xf64>
    %84 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %85 = stablehlo.divide %10, %84 : tensor<128xf64>
    %86 = stablehlo.subtract %83, %85 : tensor<128xf64>
    %87 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %88 = stablehlo.multiply %87, %11 : tensor<128xf64>
    %89 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %90 = stablehlo.divide %88, %89 : tensor<128xf64>
    %91 = stablehlo.add %86, %90 : tensor<128xf64>
    %92 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %93 = stablehlo.divide %12, %92 : tensor<128xf64>
    %94 = stablehlo.add %91, %93 : tensor<128xf64>
    %95 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %98 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %99 = stablehlo.divide %7, %98 : tensor<128xf64>
    %100 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %101 = stablehlo.divide %11, %100 : tensor<128xf64>
    %102 = stablehlo.subtract %99, %101 : tensor<128xf64>
    %103 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf64>, %arg1: tensor<65xf64>, %arg2: tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %11 = call @fft_0(%10) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    ...
    %15 = call @fft_0(%14) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
  ...
  func.func private @fft_0(%arg0: tensor<65xcomplex<f64>>) -> tensor<128xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    return %0 : tensor<128xf64>
  }
  func.func private @advect_1d_matrix_diag_1(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %2 = stablehlo.multiply %arg1, %1 : tensor<128xf64>
    %3 = stablehlo.convert %arg3 : tensor<f64>
    ...
    %15 = call @_roll_dynamic_3(%arg0, %14) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %24 = call @_roll_dynamic_3(%arg0, %23) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %33 = call @_roll_dynamic_3(%arg0, %32) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %42 = call @_roll_dynamic_3(%arg0, %41) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %51 = call @_roll_dynamic_3(%arg0, %50) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %60 = call @_roll_dynamic_3(%arg0, %59) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<128xi32>, %arg2: tensor<128xf64>) -> tensor<6x128x128xf64> {
    ...
    %c_11 = stablehlo.constant dense<128> : tensor<i64>
    %117 = stablehlo.broadcast_in_dim %c_11, dims = [] : (tensor<i64>) -> tensor<6x128x128xi64>
    ...
    %121 = call @_where_2(%119, %120, %cst_12) : (tensor<6x128x128xi1>, tensor<6x128x1xf64>, tensor<f64>) -> tensor<6x128x128xf64>
    return %121 : tensor<6x128x128xf64>
  }
  func.func private @_where_2(%arg0: tensor<6x128x128xi1>, %arg1: tensor<6x128x1xf64>, %arg2: tensor<f64>) -> tensor<6x128x128xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
  ...
  func.func private @_roll_dynamic_3(%arg0: tensor<128x128xf64>, %arg1: tensor<128xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xi32>) -> tensor<128x1xi32>
    %1 = stablehlo.slice %0 [0:128, 0:1] : (tensor<128x1xi32>) -> tensor<128x1xi32>
    %2 = stablehlo.reshape %1 : (tensor<128x1xi32>) -> tensor<128xi32>
    %c = stablehlo.constant dense<128> : tensor<i32>
