module @jit__lambda_ attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf64>) -> (tensor<128x128xf64> {jax.result_info = "[0]"}, tensor<128xf64> {jax.result_info = "[1]"}, tensor<128xf64> {jax.result_info = "[2]"}) {
    ...
    %2 = call @advect_1d_matrix_diag_1(%0, %1#0, %cst_4, %cst_3, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %3 = call @advect_1d_matrix_diag(%2, %cst, %cst_1, %cst_2, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
