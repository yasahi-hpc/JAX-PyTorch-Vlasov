module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<65xf64>, %arg3: tensor<6xi32>, %arg4: tensor<128xf64>, %arg5: tensor<128xf64>, %arg6: tensor<128x128xf64>, %arg7: tensor<128xf64>, %arg8: tensor<f64>, %arg9: tensor<i64>) -> (tensor<128xf64> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<65xf64> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<6xi32> {jax.result_info = "[<flat index 0>][<flat index 3>]"}, tensor<128xf64> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 1>][<flat index 1>]"}, tensor<128x128xf64> {jax.result_info = "[<flat index 2>][<flat index 0>]"}, tensor<128xf64> {jax.result_info = "[<flat index 2>][<flat index 1>]"}, tensor<f64> {jax.result_info = "[<flat index 3>]"}, tensor<i64> {jax.result_info = "[<flat index 4>]"}) {
    ...
    %0:6 = stablehlo.while(%iterArg = %cst, %iterArg_3 = %cst_0, %iterArg_4 = %c, %iterArg_5 = %arg6, %iterArg_6 = %arg4, %iterArg_7 = %arg5) : tensor<128xf64>, tensor<65xf64>, tensor<i64>, tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>
     cond {
      ...
      %3:3 = func.call @None(%iterArg, %iterArg_3, %iterArg_5, %iterArg_6, %iterArg_7) : (tensor<128xf64>, tensor<65xf64>, tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>)
  ...
  func.func private @None(%arg0: tensor<128xf64>, %arg1: tensor<65xf64>, %arg2: tensor<128x128xf64>, %arg3: tensor<128xf64>, %arg4: tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %9 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %10 = stablehlo.divide %1, %9 : tensor<128xf64>
    %11 = stablehlo.subtract %8, %10 : tensor<128xf64>
    %12 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %15 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %18 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %19 = stablehlo.divide %arg0, %18 : tensor<128xf64>
    %20 = stablehlo.negate %19 : tensor<128xf64>
    %21 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %22 = stablehlo.multiply %21, %0 : tensor<128xf64>
    %cst_3 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %23 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %24 = stablehlo.divide %22, %23 : tensor<128xf64>
    %25 = stablehlo.add %20, %24 : tensor<128xf64>
    %26 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %60 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %61 = stablehlo.multiply %60, %1 : tensor<128xf64>
    %62 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %63 = stablehlo.divide %61, %62 : tensor<128xf64>
    %64 = stablehlo.subtract %59, %63 : tensor<128xf64>
    %65 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %66 = stablehlo.divide %2, %65 : tensor<128xf64>
    %67 = stablehlo.subtract %64, %66 : tensor<128xf64>
    %68 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %69 = stablehlo.divide %3, %68 : tensor<128xf64>
    %70 = stablehlo.add %67, %69 : tensor<128xf64>
    %71 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %72 = stablehlo.divide %arg0, %71 : tensor<128xf64>
    %73 = stablehlo.negate %72 : tensor<128xf64>
    %74 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %75 = stablehlo.divide %0, %74 : tensor<128xf64>
    %76 = stablehlo.subtract %73, %75 : tensor<128xf64>
    %77 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %78 = stablehlo.multiply %77, %1 : tensor<128xf64>
    %79 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %80 = stablehlo.divide %78, %79 : tensor<128xf64>
    %81 = stablehlo.add %76, %80 : tensor<128xf64>
    %82 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %83 = stablehlo.divide %2, %82 : tensor<128xf64>
    %84 = stablehlo.add %81, %83 : tensor<128xf64>
    %85 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %88 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %89 = stablehlo.divide %arg0, %88 : tensor<128xf64>
    %90 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %91 = stablehlo.divide %1, %90 : tensor<128xf64>
    %92 = stablehlo.subtract %89, %91 : tensor<128xf64>
    %93 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %106 = call @_roll_static_0(%105) : (tensor<128x50xf64>) -> tensor<128x50xf64>
    %107 = stablehlo.slice %arg2 [0:128, 64:114] : (tensor<128x128xf64>) -> tensor<128x50xf64>
    %108 = call @_roll_static_1(%107) : (tensor<128x50xf64>) -> tensor<128x50xf64>
    %109 = stablehlo.slice %arg2 [0:128, 114:128] : (tensor<128x128xf64>) -> tensor<128x14xf64>
    %110 = call @_roll_static_2(%109) : (tensor<128x14xf64>) -> tensor<128x14xf64>
    ...
    %112 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %113 = call @_roll_static_3(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %120 = call @_roll_static_4(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %127 = call @_roll_static_5(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %134 = call @_roll_static_6(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %141 = call @_roll_static_7(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %148 = call @_roll_static_8(%111) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %cst_12 = stablehlo.constant dense<0.078740157480314959> : tensor<f64>
    %155:3 = call @solve_poisson(%154, %arg1, %cst_12) : (tensor<128x128xf64>, tensor<65xf64>, tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>)
    %cst_13 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %156 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %157 = stablehlo.multiply %155#0, %156 : tensor<128xf64>
    %cst_14 = stablehlo.constant dense<0.078740157480314959> : tensor<f64>
    %158 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %266 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %271 = call @_where(%268, %270, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %272 = stablehlo.add %266, %271 : tensor<128xf64>
    %c_16 = stablehlo.constant dense<-2> : tensor<i32>
    %273 = stablehlo.broadcast_in_dim %c_16, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %277 = call @_where(%274, %276, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %278 = stablehlo.add %272, %277 : tensor<128xf64>
    %c_17 = stablehlo.constant dense<-3> : tensor<i32>
    %279 = stablehlo.broadcast_in_dim %c_17, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %283 = call @_where(%280, %282, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %284 = stablehlo.add %278, %283 : tensor<128xf64>
    %c_18 = stablehlo.constant dense<-4> : tensor<i32>
    %285 = stablehlo.broadcast_in_dim %c_18, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %289 = call @_where(%286, %288, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %290 = stablehlo.add %284, %289 : tensor<128xf64>
    %c_19 = stablehlo.constant dense<-5> : tensor<i32>
    %291 = stablehlo.broadcast_in_dim %c_19, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %295 = call @_where(%292, %294, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %296 = stablehlo.add %290, %295 : tensor<128xf64>
    %c_20 = stablehlo.constant dense<-6> : tensor<i32>
    %297 = stablehlo.broadcast_in_dim %c_20, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %301 = call @_where(%298, %300, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %302 = stablehlo.add %296, %301 : tensor<128xf64>
    %303 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_21 = stablehlo.constant dense<0> : tensor<i32>
    %304 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %308 = call @_where(%305, %307, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %314 = call @_where(%311, %313, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %315 = stablehlo.add %309, %314 : tensor<128xf64>
    %316 = stablehlo.broadcast_in_dim %c_16, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %320 = call @_where(%317, %319, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %321 = stablehlo.add %315, %320 : tensor<128xf64>
    %322 = stablehlo.broadcast_in_dim %c_17, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %326 = call @_where(%323, %325, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %327 = stablehlo.add %321, %326 : tensor<128xf64>
    %328 = stablehlo.broadcast_in_dim %c_18, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %332 = call @_where(%329, %331, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %333 = stablehlo.add %327, %332 : tensor<128xf64>
    %334 = stablehlo.broadcast_in_dim %c_19, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %338 = call @_where(%335, %337, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %339 = stablehlo.add %333, %338 : tensor<128xf64>
    %340 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_22 = stablehlo.constant dense<1> : tensor<i32>
    %341 = stablehlo.broadcast_in_dim %c_22, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %345 = call @_where(%342, %344, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %346 = stablehlo.add %340, %345 : tensor<128xf64>
    %347 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %351 = call @_where(%348, %350, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %357 = call @_where(%354, %356, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %358 = stablehlo.add %352, %357 : tensor<128xf64>
    %359 = stablehlo.broadcast_in_dim %c_16, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %363 = call @_where(%360, %362, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %364 = stablehlo.add %358, %363 : tensor<128xf64>
    %365 = stablehlo.broadcast_in_dim %c_17, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %369 = call @_where(%366, %368, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %370 = stablehlo.add %364, %369 : tensor<128xf64>
    %371 = stablehlo.broadcast_in_dim %c_18, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %375 = call @_where(%372, %374, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %376 = stablehlo.add %370, %375 : tensor<128xf64>
    %377 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_23 = stablehlo.constant dense<2> : tensor<i32>
    %378 = stablehlo.broadcast_in_dim %c_23, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %382 = call @_where(%379, %381, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %383 = stablehlo.add %377, %382 : tensor<128xf64>
    %384 = stablehlo.broadcast_in_dim %c_22, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %388 = call @_where(%385, %387, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %389 = stablehlo.add %383, %388 : tensor<128xf64>
    %390 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %394 = call @_where(%391, %393, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %400 = call @_where(%397, %399, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %401 = stablehlo.add %395, %400 : tensor<128xf64>
    %402 = stablehlo.broadcast_in_dim %c_16, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %406 = call @_where(%403, %405, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %407 = stablehlo.add %401, %406 : tensor<128xf64>
    %408 = stablehlo.broadcast_in_dim %c_17, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %412 = call @_where(%409, %411, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %413 = stablehlo.add %407, %412 : tensor<128xf64>
    %414 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_24 = stablehlo.constant dense<3> : tensor<i32>
    %415 = stablehlo.broadcast_in_dim %c_24, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %419 = call @_where(%416, %418, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %420 = stablehlo.add %414, %419 : tensor<128xf64>
    %421 = stablehlo.broadcast_in_dim %c_23, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %425 = call @_where(%422, %424, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %426 = stablehlo.add %420, %425 : tensor<128xf64>
    %427 = stablehlo.broadcast_in_dim %c_22, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %431 = call @_where(%428, %430, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %432 = stablehlo.add %426, %431 : tensor<128xf64>
    %433 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %437 = call @_where(%434, %436, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %443 = call @_where(%440, %442, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %444 = stablehlo.add %438, %443 : tensor<128xf64>
    %445 = stablehlo.broadcast_in_dim %c_16, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %449 = call @_where(%446, %448, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %450 = stablehlo.add %444, %449 : tensor<128xf64>
    %451 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_25 = stablehlo.constant dense<4> : tensor<i32>
    %452 = stablehlo.broadcast_in_dim %c_25, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %456 = call @_where(%453, %455, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %457 = stablehlo.add %451, %456 : tensor<128xf64>
    %458 = stablehlo.broadcast_in_dim %c_24, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %462 = call @_where(%459, %461, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %463 = stablehlo.add %457, %462 : tensor<128xf64>
    %464 = stablehlo.broadcast_in_dim %c_23, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %468 = call @_where(%465, %467, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %469 = stablehlo.add %463, %468 : tensor<128xf64>
    %470 = stablehlo.broadcast_in_dim %c_22, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %474 = call @_where(%471, %473, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %475 = stablehlo.add %469, %474 : tensor<128xf64>
    %476 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %480 = call @_where(%477, %479, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %486 = call @_where(%483, %485, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %487 = stablehlo.add %481, %486 : tensor<128xf64>
    %488 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %c_26 = stablehlo.constant dense<5> : tensor<i32>
    %489 = stablehlo.broadcast_in_dim %c_26, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %493 = call @_where(%490, %492, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %494 = stablehlo.add %488, %493 : tensor<128xf64>
    %495 = stablehlo.broadcast_in_dim %c_25, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %499 = call @_where(%496, %498, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %500 = stablehlo.add %494, %499 : tensor<128xf64>
    %501 = stablehlo.broadcast_in_dim %c_24, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %505 = call @_where(%502, %504, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %506 = stablehlo.add %500, %505 : tensor<128xf64>
    %507 = stablehlo.broadcast_in_dim %c_23, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %511 = call @_where(%508, %510, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %512 = stablehlo.add %506, %511 : tensor<128xf64>
    %513 = stablehlo.broadcast_in_dim %c_22, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %517 = call @_where(%514, %516, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %518 = stablehlo.add %512, %517 : tensor<128xf64>
    %519 = stablehlo.broadcast_in_dim %c_21, dims = [] : (tensor<i32>) -> tensor<128xi32>
    ...
    %523 = call @_where(%520, %522, %cst_15) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %533 = call @_pad(%154, %c_27) : (tensor<128x128xf64>, tensor<i64>) -> tensor<128x134xf64>
    %534 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %587 = call @_roll_static_0(%586) : (tensor<128x50xf64>) -> tensor<128x50xf64>
    %588 = stablehlo.slice %583 [0:128, 64:114] : (tensor<128x128xf64>) -> tensor<128x50xf64>
    %589 = call @_roll_static_1(%588) : (tensor<128x50xf64>) -> tensor<128x50xf64>
    %590 = stablehlo.slice %583 [0:128, 114:128] : (tensor<128x128xf64>) -> tensor<128x14xf64>
    %591 = call @_roll_static_2(%590) : (tensor<128x14xf64>) -> tensor<128x14xf64>
    ...
    %593 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %594 = call @_roll_static_3(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %601 = call @_roll_static_4(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %608 = call @_roll_static_5(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %615 = call @_roll_static_6(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %622 = call @_roll_static_7(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
    ...
    %629 = call @_roll_static_8(%592) : (tensor<128x128xf64>) -> tensor<128x128xf64>
  ...
  func.func private @_roll_static_0(%arg0: tensor<128x50xf64>) -> tensor<128x50xf64> {
  ...
  func.func private @_roll_static_1(%arg0: tensor<128x50xf64>) -> tensor<128x50xf64> {
  ...
  func.func private @_roll_static_2(%arg0: tensor<128x14xf64>) -> tensor<128x14xf64> {
  ...
  func.func private @_roll_static_3(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @_roll_static_4(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @_roll_static_5(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @_roll_static_6(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @_roll_static_7(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @_roll_static_8(%arg0: tensor<128x128xf64>) -> tensor<128x128xf64> {
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf64>, %arg1: tensor<65xf64>, %arg2: tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %11 = call @fft_9(%10) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    ...
    %15 = call @fft_9(%14) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
  ...
  func.func private @fft_9(%arg0: tensor<65xcomplex<f64>>) -> tensor<128xf64> {
