module @jit__lambda_ attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf64>) -> (tensor<128x128xf64> {jax.result_info = "[0]"}, tensor<128xf64> {jax.result_info = "[1]"}, tensor<128xf64> {jax.result_info = "[2]"}) {
    ...
    %0 = stablehlo.transpose %arg0, dims = [1, 0] : (tensor<128x128xf64>) -> tensor<128x128xf64>
    %cst_1 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_2 = stablehlo.constant dense<0.098174770424681035> : tensor<f64>
    %1 = call @advect_1d_vectorized(%0, %cst, %cst_1, %cst_2, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    ...
    %3:3 = call @solve_poisson(%2, %cst_0, %cst_3) : (tensor<128x128xf64>, tensor<65xf64>, tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>)
    %cst_4 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %4 = call @advect_1d_vectorized_1(%2, %3#0, %cst_4, %cst_3, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %5 = stablehlo.transpose %4, dims = [1, 0] : (tensor<128x128xf64>) -> tensor<128x128xf64>
    %6 = call @advect_1d_vectorized(%5, %cst, %cst_1, %cst_2, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
