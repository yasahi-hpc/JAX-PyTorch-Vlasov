module @jit__lambda_ attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf64>) -> (tensor<128x128xf64> {jax.result_info = "[0]"}, tensor<128xf64> {jax.result_info = "[1]"}, tensor<128xf64> {jax.result_info = "[2]"}) {
    ...
    %9 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %21 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %22 = stablehlo.multiply %21, %0 : tensor<128xf64>
    %cst_5 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %23 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %24 = stablehlo.divide %22, %23 : tensor<128xf64>
    %25 = stablehlo.add %20, %24 : tensor<128xf64>
    %26 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %27 = stablehlo.divide %1, %26 : tensor<128xf64>
    %28 = stablehlo.subtract %25, %27 : tensor<128xf64>
    %cst_6 = stablehlo.constant dense<6.000000e+00> : tensor<f64>
    %29 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %30 = stablehlo.divide %2, %29 : tensor<128xf64>
    %31 = stablehlo.subtract %28, %30 : tensor<128xf64>
    %32 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %33 = stablehlo.divide %3, %32 : tensor<128xf64>
    %34 = stablehlo.add %31, %33 : tensor<128xf64>
    %35 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %36 = stablehlo.divide %cst, %35 : tensor<128xf64>
    %cst_7 = stablehlo.constant dense<1.000000e+00> : tensor<f64>
    %37 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %38 = stablehlo.subtract %37, %36 : tensor<128xf64>
    %cst_8 = stablehlo.constant dense<5.000000e+00> : tensor<f64>
    %39 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %40 = stablehlo.multiply %39, %0 : tensor<128xf64>
    %cst_9 = stablehlo.constant dense<4.000000e+00> : tensor<f64>
    %41 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %42 = stablehlo.divide %40, %41 : tensor<128xf64>
    %43 = stablehlo.subtract %38, %42 : tensor<128xf64>
    %44 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %45 = stablehlo.multiply %44, %1 : tensor<128xf64>
    %cst_10 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %46 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %47 = stablehlo.divide %45, %46 : tensor<128xf64>
    %48 = stablehlo.add %43, %47 : tensor<128xf64>
    %49 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %50 = stablehlo.divide %2, %49 : tensor<128xf64>
    %51 = stablehlo.add %48, %50 : tensor<128xf64>
    %52 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %53 = stablehlo.divide %3, %52 : tensor<128xf64>
    %54 = stablehlo.subtract %51, %53 : tensor<128xf64>
    %55 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %56 = stablehlo.multiply %55, %0 : tensor<128xf64>
    %57 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %58 = stablehlo.divide %56, %57 : tensor<128xf64>
    %59 = stablehlo.add %cst, %58 : tensor<128xf64>
    %cst_11 = stablehlo.constant dense<7.000000e+00> : tensor<f64>
    %60 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %61 = stablehlo.multiply %60, %1 : tensor<128xf64>
    %62 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %63 = stablehlo.divide %61, %62 : tensor<128xf64>
    %64 = stablehlo.subtract %59, %63 : tensor<128xf64>
    %65 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %66 = stablehlo.divide %2, %65 : tensor<128xf64>
    %67 = stablehlo.subtract %64, %66 : tensor<128xf64>
    %68 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %69 = stablehlo.divide %3, %68 : tensor<128xf64>
    %70 = stablehlo.add %67, %69 : tensor<128xf64>
    %71 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %72 = stablehlo.divide %cst, %71 : tensor<128xf64>
    %73 = stablehlo.negate %72 : tensor<128xf64>
    %74 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %75 = stablehlo.divide %0, %74 : tensor<128xf64>
    %76 = stablehlo.subtract %73, %75 : tensor<128xf64>
    %77 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %78 = stablehlo.multiply %77, %1 : tensor<128xf64>
    %79 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %80 = stablehlo.divide %78, %79 : tensor<128xf64>
    %81 = stablehlo.add %76, %80 : tensor<128xf64>
    %82 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %83 = stablehlo.divide %2, %82 : tensor<128xf64>
    %84 = stablehlo.add %81, %83 : tensor<128xf64>
    %85 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %86 = stablehlo.divide %3, %85 : tensor<128xf64>
    %87 = stablehlo.subtract %84, %86 : tensor<128xf64>
    %cst_12 = stablehlo.constant dense<3.000000e+01> : tensor<f64>
    %88 = stablehlo.broadcast_in_dim %cst_12, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %89 = stablehlo.divide %cst, %88 : tensor<128xf64>
    %90 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %91 = stablehlo.divide %1, %90 : tensor<128xf64>
    %92 = stablehlo.subtract %89, %91 : tensor<128xf64>
    %93 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %112 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %155:3 = call @solve_poisson(%154, %cst_0, %cst_14) : (tensor<128x128xf64>, tensor<65xf64>, tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>)
    %cst_15 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %156 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %157 = stablehlo.multiply %155#0, %156 : tensor<128xf64>
    %cst_16 = stablehlo.constant dense<0.078740157480314959> : tensor<f64>
    %158 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %266 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %271 = call @_where(%268, %270, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %277 = call @_where(%274, %276, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %283 = call @_where(%280, %282, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %289 = call @_where(%286, %288, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %295 = call @_where(%292, %294, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %301 = call @_where(%298, %300, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %302 = stablehlo.add %296, %301 : tensor<128xf64>
    %303 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %308 = call @_where(%305, %307, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %314 = call @_where(%311, %313, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %320 = call @_where(%317, %319, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %326 = call @_where(%323, %325, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %332 = call @_where(%329, %331, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %338 = call @_where(%335, %337, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %339 = stablehlo.add %333, %338 : tensor<128xf64>
    %340 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %345 = call @_where(%342, %344, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %351 = call @_where(%348, %350, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %357 = call @_where(%354, %356, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %363 = call @_where(%360, %362, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %369 = call @_where(%366, %368, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %375 = call @_where(%372, %374, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %376 = stablehlo.add %370, %375 : tensor<128xf64>
    %377 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %382 = call @_where(%379, %381, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %388 = call @_where(%385, %387, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %394 = call @_where(%391, %393, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %400 = call @_where(%397, %399, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %406 = call @_where(%403, %405, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %412 = call @_where(%409, %411, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %413 = stablehlo.add %407, %412 : tensor<128xf64>
    %414 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %419 = call @_where(%416, %418, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %425 = call @_where(%422, %424, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %431 = call @_where(%428, %430, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %437 = call @_where(%434, %436, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %443 = call @_where(%440, %442, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %449 = call @_where(%446, %448, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %450 = stablehlo.add %444, %449 : tensor<128xf64>
    %451 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %456 = call @_where(%453, %455, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %462 = call @_where(%459, %461, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %468 = call @_where(%465, %467, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %474 = call @_where(%471, %473, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %480 = call @_where(%477, %479, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %486 = call @_where(%483, %485, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    %487 = stablehlo.add %481, %486 : tensor<128xf64>
    %488 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128xf64>
    ...
    %493 = call @_where(%490, %492, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %499 = call @_where(%496, %498, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %505 = call @_where(%502, %504, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %511 = call @_where(%508, %510, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %517 = call @_where(%514, %516, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %523 = call @_where(%520, %522, %cst_17) : (tensor<128xi1>, tensor<128xf64>, tensor<f64>) -> tensor<128xf64>
    ...
    %533 = call @_pad(%154, %c_29) : (tensor<128x128xf64>, tensor<i64>) -> tensor<128x134xf64>
    %534 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %593 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
