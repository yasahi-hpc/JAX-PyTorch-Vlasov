module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @None(%arg0: tensor<128xf64>, %arg1: tensor<6xi32>, %arg2: tensor<65xf64>, %arg3: tensor<128x128xf64>, %arg4: tensor<128xf64>, %arg5: tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %4 = call @advect_1d_vectorized_1(%2, %3#0, %cst_2, %cst_1, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %5 = stablehlo.transpose %4, dims = [1, 0] : (tensor<128x128xf64>) -> tensor<128x128xf64>
    %6 = call @advect_1d_vectorized(%5, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
  ...
  func.func private @advect_1d_vectorized(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    ...
    %48 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %49 = stablehlo.divide %40, %48 : tensor<128x128xf64>
    %50 = stablehlo.subtract %47, %49 : tensor<128x128xf64>
    %51 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %57 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %58 = stablehlo.divide %13, %57 : tensor<128x128xf64>
    %59 = stablehlo.negate %58 : tensor<128x128xf64>
    %60 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %61 = stablehlo.multiply %60, %39 : tensor<128x128xf64>
    %cst_6 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %62 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %63 = stablehlo.divide %61, %62 : tensor<128x128xf64>
    %64 = stablehlo.add %59, %63 : tensor<128x128xf64>
    %65 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %127 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %128 = stablehlo.divide %13, %127 : tensor<128x128xf64>
    %129 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %130 = stablehlo.divide %40, %129 : tensor<128x128xf64>
    %131 = stablehlo.subtract %128, %130 : tensor<128x128xf64>
    %132 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
  ...
  func.func private @advect_1d_vectorized_1(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.iota dim = 0 : tensor<128xf64>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xf64>) -> tensor<128x1xf64>
    %2 = stablehlo.convert %arg2 : tensor<f64>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f64>) -> tensor<128x1xf64>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f64>
    %44 = call @_where_2(%24, %43, %cst) : (tensor<128x128x6xi1>, tensor<128x128x6xf64>, tensor<f64>) -> tensor<128x128x6xf64>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %63 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %64 = stablehlo.divide %13, %63 : tensor<128x128xf64>
    %65 = stablehlo.negate %64 : tensor<128x128xf64>
    %66 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %67 = stablehlo.multiply %66, %45 : tensor<128x128xf64>
    %cst_10 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %68 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %69 = stablehlo.divide %67, %68 : tensor<128x128xf64>
    %70 = stablehlo.add %65, %69 : tensor<128x128xf64>
    %71 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %74 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %75 = stablehlo.divide %47, %74 : tensor<128x128xf64>
    %76 = stablehlo.subtract %73, %75 : tensor<128x128xf64>
    %77 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    ...
    %133 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %134 = stablehlo.divide %13, %133 : tensor<128x128xf64>
    %135 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
    %136 = stablehlo.divide %46, %135 : tensor<128x128xf64>
    %137 = stablehlo.subtract %134, %136 : tensor<128x128xf64>
    %138 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<128x128xf64>
  ...
  func.func private @_where_2(%arg0: tensor<128x128x6xi1>, %arg1: tensor<128x128x6xf64>, %arg2: tensor<f64>) -> tensor<128x128x6xf64> {
