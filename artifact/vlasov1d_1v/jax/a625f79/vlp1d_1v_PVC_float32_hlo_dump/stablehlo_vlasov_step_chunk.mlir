module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<65xf32>, %arg3: tensor<6xi32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>, %arg6: tensor<128x128xf32>, %arg7: tensor<128xf32>, %arg8: tensor<f32>, %arg9: tensor<i32>) -> (tensor<128xf32> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<65xf32> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<6xi32> {jax.result_info = "[<flat index 0>][<flat index 3>]"}, tensor<128xf32> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 1>][<flat index 1>]"}, tensor<128x128xf32> {jax.result_info = "[<flat index 2>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 2>][<flat index 1>]"}, tensor<f32> {jax.result_info = "[<flat index 3>]"}, tensor<i32> {jax.result_info = "[<flat index 4>]"}) {
    ...
    %0:7 = stablehlo.while(%iterArg = %cst, %iterArg_4 = %c, %iterArg_5 = %cst_0, %iterArg_6 = %c_1, %iterArg_7 = %arg6, %iterArg_8 = %arg4, %iterArg_9 = %arg5) : tensor<128xf32>, tensor<6xi32>, tensor<65xf32>, tensor<i32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>
     cond {
      %c_10 = stablehlo.constant dense<1000> : tensor<i32>
      %3 = stablehlo.compare  LT, %iterArg_6, %c_10,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %3 : tensor<i1>
    } do {
      %3:3 = func.call @None(%iterArg, %iterArg_4, %iterArg_5, %iterArg_7, %iterArg_8, %iterArg_9) : (tensor<128xf32>, tensor<6xi32>, tensor<65xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>)
      %c_10 = stablehlo.constant dense<1> : tensor<i32>
      %4 = stablehlo.add %iterArg_6, %c_10 : tensor<i32>
      stablehlo.return %iterArg, %iterArg_4, %iterArg_5, %4, %3#0, %3#1, %3#2 : tensor<128xf32>, tensor<6xi32>, tensor<65xf32>, tensor<i32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>
    }
    %cst_2 = stablehlo.constant dense<5.000000e+01> : tensor<f32>
    %1 = stablehlo.add %arg8, %cst_2 : tensor<f32>
    %c_3 = stablehlo.constant dense<1000> : tensor<i32>
    %2 = stablehlo.add %arg9, %c_3 : tensor<i32>
    return %arg0, %arg1, %arg2, %arg3, %0#5, %0#6, %0#4, %arg7, %1, %2 : tensor<128xf32>, tensor<128xf32>, tensor<65xf32>, tensor<6xi32>, tensor<128xf32>, tensor<128xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<i32>
  }
  func.func private @None(%arg0: tensor<128xf32>, %arg1: tensor<6xi32>, %arg2: tensor<65xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) {
    %0 = stablehlo.transpose %arg3, dims = [1, 0] : (tensor<128x128xf32>) -> tensor<128x128xf32>
    %cst = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_0 = stablehlo.constant dense<0.0981747731> : tensor<f32>
    %1 = call @advect_1d_vectorized(%0, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    %2 = stablehlo.transpose %1, dims = [1, 0] : (tensor<128x128xf32>) -> tensor<128x128xf32>
    %cst_1 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %3:3 = call @solve_poisson(%2, %arg2, %cst_1) : (tensor<128x128xf32>, tensor<65xf32>, tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>)
    %cst_2 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %4 = call @advect_1d_vectorized_1(%2, %3#0, %cst_2, %cst_1, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    %5 = stablehlo.transpose %4, dims = [1, 0] : (tensor<128x128xf32>) -> tensor<128x128xf32>
    %6 = call @advect_1d_vectorized(%5, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
  ...
  func.func private @advect_1d_vectorized(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    ...
    %46 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %47 = stablehlo.divide %38, %46 : tensor<128x128xf32>
    %48 = stablehlo.subtract %45, %47 : tensor<128x128xf32>
    %49 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %55 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %56 = stablehlo.divide %13, %55 : tensor<128x128xf32>
    %57 = stablehlo.negate %56 : tensor<128x128xf32>
    %58 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %59 = stablehlo.multiply %58, %37 : tensor<128x128xf32>
    %cst_6 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %60 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %61 = stablehlo.divide %59, %60 : tensor<128x128xf32>
    %62 = stablehlo.add %57, %61 : tensor<128x128xf32>
    %63 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %125 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %126 = stablehlo.divide %13, %125 : tensor<128x128xf32>
    %127 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %128 = stablehlo.divide %38, %127 : tensor<128x128xf32>
    %129 = stablehlo.subtract %126, %128 : tensor<128x128xf32>
    %130 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
  ...
  func.func private @remainder(%arg0: tensor<128x128x6xi32>, %arg1: tensor<i32>) -> tensor<128x128x6xi32> {
    ...
    %5 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<128x128x6xi32>
    %6 = stablehlo.compare  NE, %4, %5,  SIGNED : (tensor<128x128x6xi32>, tensor<128x128x6xi32>) -> tensor<128x128x6xi1>
    %7 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<128x128x6xi32>
  ...
  func.func private @advect_1d_vectorized_1(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.iota dim = 0 : tensor<128xf32>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xf32>) -> tensor<128x1xf32>
    %2 = stablehlo.convert %arg2 : tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<128x1xf32>
    ...
    %28 = stablehlo.broadcast_in_dim %c_0, dims = [] : (tensor<i32>) -> tensor<128x1x1xi32>
    ...
    %34 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<98304xi32>
    %35 = stablehlo.compare  LT, %33, %34,  SIGNED : (tensor<98304xi32>, tensor<98304xi32>) -> tensor<98304xi1>
    %c_3 = stablehlo.constant dense<16384> : tensor<i32>
    %36 = stablehlo.broadcast_in_dim %c_3, dims = [] : (tensor<i32>) -> tensor<98304xi32>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %42 = call @_where_2(%24, %41, %cst) : (tensor<128x128x6xi1>, tensor<128x128x6xf32>, tensor<f32>) -> tensor<128x128x6xf32>
    ...
    %47 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %58 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %61 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %62 = stablehlo.divide %13, %61 : tensor<128x128xf32>
    %63 = stablehlo.negate %62 : tensor<128x128xf32>
    %64 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %65 = stablehlo.multiply %64, %43 : tensor<128x128xf32>
    %cst_8 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %66 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %67 = stablehlo.divide %65, %66 : tensor<128x128xf32>
    %68 = stablehlo.add %63, %67 : tensor<128x128xf32>
    %69 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %103 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %104 = stablehlo.multiply %103, %44 : tensor<128x128xf32>
    %105 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %106 = stablehlo.divide %104, %105 : tensor<128x128xf32>
    %107 = stablehlo.subtract %102, %106 : tensor<128x128xf32>
    %108 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %109 = stablehlo.divide %45, %108 : tensor<128x128xf32>
    %110 = stablehlo.subtract %107, %109 : tensor<128x128xf32>
    %111 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %117 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %118 = stablehlo.divide %43, %117 : tensor<128x128xf32>
    %119 = stablehlo.subtract %116, %118 : tensor<128x128xf32>
    %120 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %121 = stablehlo.multiply %120, %44 : tensor<128x128xf32>
    %122 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %123 = stablehlo.divide %121, %122 : tensor<128x128xf32>
    %124 = stablehlo.add %119, %123 : tensor<128x128xf32>
    %125 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %126 = stablehlo.divide %45, %125 : tensor<128x128xf32>
    %127 = stablehlo.add %124, %126 : tensor<128x128xf32>
    %128 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %131 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %132 = stablehlo.divide %13, %131 : tensor<128x128xf32>
    %133 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    %134 = stablehlo.divide %44, %133 : tensor<128x128xf32>
    %135 = stablehlo.subtract %132, %134 : tensor<128x128xf32>
    %136 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
  ...
  func.func private @_where_2(%arg0: tensor<128x128x6xi1>, %arg1: tensor<128x128x6xf32>, %arg2: tensor<f32>) -> tensor<128x128x6xf32> {
