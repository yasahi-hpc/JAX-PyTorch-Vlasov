module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<65xf32>, %arg3: tensor<6xi32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>, %arg6: tensor<128x128xf32>, %arg7: tensor<128xf32>, %arg8: tensor<f32>, %arg9: tensor<i32>) -> (tensor<128xf32> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<65xf32> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<6xi32> {jax.result_info = "[<flat index 0>][<flat index 3>]"}, tensor<128xf32> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 1>][<flat index 1>]"}, tensor<128x128xf32> {jax.result_info = "[<flat index 2>][<flat index 0>]"}, tensor<128xf32> {jax.result_info = "[<flat index 2>][<flat index 1>]"}, tensor<f32> {jax.result_info = "[<flat index 3>]"}, tensor<i32> {jax.result_info = "[<flat index 4>]"}) {
    ...
    %0:6 = stablehlo.while(%iterArg = %cst, %iterArg_3 = %cst_0, %iterArg_4 = %c, %iterArg_5 = %arg6, %iterArg_6 = %arg4, %iterArg_7 = %arg5) : tensor<128xf32>, tensor<65xf32>, tensor<i32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>
     cond {
      %c_8 = stablehlo.constant dense<1000> : tensor<i32>
      %3 = stablehlo.compare  LT, %iterArg_4, %c_8,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %3 : tensor<i1>
    } do {
      %3:3 = func.call @None(%iterArg, %iterArg_3, %iterArg_5, %iterArg_6, %iterArg_7) : (tensor<128xf32>, tensor<65xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>)
    ...
    %c_2 = stablehlo.constant dense<1000> : tensor<i32>
  ...
  func.func private @None(%arg0: tensor<128xf32>, %arg1: tensor<65xf32>, %arg2: tensor<128x128xf32>, %arg3: tensor<128xf32>, %arg4: tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %112 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %cst_12 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %155:3 = call @solve_poisson(%154, %arg1, %cst_12) : (tensor<128x128xf32>, tensor<65xf32>, tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>)
    %cst_13 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %156 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %157 = stablehlo.multiply %155#0, %156 : tensor<128xf32>
    %cst_14 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %158 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %266 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %271 = call @_where(%268, %270, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %277 = call @_where(%274, %276, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %283 = call @_where(%280, %282, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %289 = call @_where(%286, %288, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %295 = call @_where(%292, %294, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %301 = call @_where(%298, %300, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %302 = stablehlo.add %296, %301 : tensor<128xf32>
    %303 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %308 = call @_where(%305, %307, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %314 = call @_where(%311, %313, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %320 = call @_where(%317, %319, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %326 = call @_where(%323, %325, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %332 = call @_where(%329, %331, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %338 = call @_where(%335, %337, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %339 = stablehlo.add %333, %338 : tensor<128xf32>
    %340 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %345 = call @_where(%342, %344, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %351 = call @_where(%348, %350, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %357 = call @_where(%354, %356, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %363 = call @_where(%360, %362, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %369 = call @_where(%366, %368, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %375 = call @_where(%372, %374, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %376 = stablehlo.add %370, %375 : tensor<128xf32>
    %377 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %382 = call @_where(%379, %381, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %388 = call @_where(%385, %387, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %394 = call @_where(%391, %393, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %400 = call @_where(%397, %399, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %406 = call @_where(%403, %405, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %412 = call @_where(%409, %411, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %413 = stablehlo.add %407, %412 : tensor<128xf32>
    %414 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %419 = call @_where(%416, %418, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %425 = call @_where(%422, %424, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %431 = call @_where(%428, %430, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %437 = call @_where(%434, %436, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %443 = call @_where(%440, %442, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %449 = call @_where(%446, %448, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %450 = stablehlo.add %444, %449 : tensor<128xf32>
    %451 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %456 = call @_where(%453, %455, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %462 = call @_where(%459, %461, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %468 = call @_where(%465, %467, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %474 = call @_where(%471, %473, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %480 = call @_where(%477, %479, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %486 = call @_where(%483, %485, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %487 = stablehlo.add %481, %486 : tensor<128xf32>
    %488 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %493 = call @_where(%490, %492, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %499 = call @_where(%496, %498, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %505 = call @_where(%502, %504, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %511 = call @_where(%508, %510, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %517 = call @_where(%514, %516, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %523 = call @_where(%520, %522, %cst_15) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %533 = call @_pad(%154, %c_27) : (tensor<128x128xf32>, tensor<i32>) -> tensor<128x134xf32>
    %534 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %593 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
