module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<128xf32>, %arg1: tensor<65xf32>, %arg2: tensor<128x128xf32>, %arg3: tensor<128xf32>, %arg4: tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %283 = call @_where(%280, %282, %cst_76) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %289 = call @_where(%286, %288, %cst_78) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %295 = call @_where(%292, %294, %cst_80) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %301 = call @_where(%298, %300, %cst_82) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %302 = stablehlo.add %296, %301 : tensor<128xf32>
    %cst_83 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %303 = stablehlo.broadcast_in_dim %cst_83, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %308 = call @_where(%305, %307, %cst_85) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %314 = call @_where(%311, %313, %cst_87) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %320 = call @_where(%317, %319, %cst_89) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %326 = call @_where(%323, %325, %cst_91) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %332 = call @_where(%329, %331, %cst_93) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %338 = call @_where(%335, %337, %cst_95) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %339 = stablehlo.add %333, %338 : tensor<128xf32>
    %cst_96 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %340 = stablehlo.broadcast_in_dim %cst_96, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %345 = call @_where(%342, %344, %cst_98) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %351 = call @_where(%348, %350, %cst_100) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %357 = call @_where(%354, %356, %cst_102) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %363 = call @_where(%360, %362, %cst_104) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %369 = call @_where(%366, %368, %cst_106) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %375 = call @_where(%372, %374, %cst_108) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %376 = stablehlo.add %370, %375 : tensor<128xf32>
    %cst_109 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %377 = stablehlo.broadcast_in_dim %cst_109, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %382 = call @_where(%379, %381, %cst_111) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %388 = call @_where(%385, %387, %cst_113) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %394 = call @_where(%391, %393, %cst_115) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %400 = call @_where(%397, %399, %cst_117) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %406 = call @_where(%403, %405, %cst_119) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %412 = call @_where(%409, %411, %cst_121) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %413 = stablehlo.add %407, %412 : tensor<128xf32>
    %cst_122 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %414 = stablehlo.broadcast_in_dim %cst_122, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %419 = call @_where(%416, %418, %cst_124) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %425 = call @_where(%422, %424, %cst_126) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %431 = call @_where(%428, %430, %cst_128) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %437 = call @_where(%434, %436, %cst_130) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %443 = call @_where(%440, %442, %cst_132) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %449 = call @_where(%446, %448, %cst_134) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %450 = stablehlo.add %444, %449 : tensor<128xf32>
    %cst_135 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %451 = stablehlo.broadcast_in_dim %cst_135, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %456 = call @_where(%453, %455, %cst_137) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %462 = call @_where(%459, %461, %cst_139) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %468 = call @_where(%465, %467, %cst_141) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %474 = call @_where(%471, %473, %cst_143) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %480 = call @_where(%477, %479, %cst_145) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %486 = call @_where(%483, %485, %cst_147) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %487 = stablehlo.add %481, %486 : tensor<128xf32>
    %cst_148 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %488 = stablehlo.broadcast_in_dim %cst_148, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %493 = call @_where(%490, %492, %cst_150) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %499 = call @_where(%496, %498, %cst_152) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %505 = call @_where(%502, %504, %cst_154) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %511 = call @_where(%508, %510, %cst_156) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %517 = call @_where(%514, %516, %cst_158) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %523 = call @_where(%520, %522, %cst_160) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %533 = call @_pad(%154, %c_161) : (tensor<128x128xf32>, tensor<i32>) -> tensor<128x134xf32>
    %cst_162 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %534 = stablehlo.broadcast_in_dim %cst_162, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %593 = stablehlo.broadcast_in_dim %cst_163, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
