module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf32>) -> (tensor<128x128xf32> {jax.result_info = "result[0]"}, tensor<128xf32> {jax.result_info = "result[1]"}, tensor<128xf32> {jax.result_info = "result[2]"}) {
    ...
    %cst_5 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %2 = call @advect_1d_matrix_diag_35(%0, %1#0, %cst_4, %cst_5, %c) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    %cst_6 = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_7 = stablehlo.constant dense<0.0981747731> : tensor<f32>
    %3 = call @advect_1d_matrix_diag(%2, %cst, %cst_6, %cst_7, %c) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf32>, %arg1: tensor<65xf32>, %arg2: tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %11 = call @fft_33(%10) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    ...
    %15 = call @fft_33(%14) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
  ...
  func.func private @fft_33(%arg0: tensor<65xcomplex<f32>>) -> tensor<128xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    return %0 : tensor<128xf32>
  }
  func.func private @advect_1d_matrix_diag_35(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %2 = stablehlo.multiply %arg1, %1 : tensor<128xf32>
    %3 = stablehlo.convert %arg3 : tensor<f32>
    ...
    %15 = call @_roll_dynamic_49(%arg0, %14) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %24 = call @_roll_dynamic_49(%arg0, %23) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %33 = call @_roll_dynamic_49(%arg0, %32) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %42 = call @_roll_dynamic_49(%arg0, %41) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %51 = call @_roll_dynamic_49(%arg0, %50) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %60 = call @_roll_dynamic_49(%arg0, %59) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<128xi32>, %arg2: tensor<128xf32>) -> tensor<6x128x128xf32> {
    ...
    %120 = call @_where_45(%118, %119, %cst_34) : (tensor<6x128x128xi1>, tensor<6x128x1xf32>, tensor<f32>) -> tensor<6x128x128xf32>
    return %120 : tensor<6x128x128xf32>
  }
  func.func private @_where_45(%arg0: tensor<6x128x128xi1>, %arg1: tensor<6x128x1xf32>, %arg2: tensor<f32>) -> tensor<6x128x128xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
  ...
  func.func private @_roll_dynamic_49(%arg0: tensor<128x128xf32>, %arg1: tensor<128xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xi32>) -> tensor<128x1xi32>
    %1 = stablehlo.slice %0 [0:128, 0:1] : (tensor<128x1xi32>) -> tensor<128x1xi32>
    %2 = stablehlo.reshape %1 : (tensor<128x1xi32>) -> tensor<128xi32>
    %c = stablehlo.constant dense<128> : tensor<i32>
