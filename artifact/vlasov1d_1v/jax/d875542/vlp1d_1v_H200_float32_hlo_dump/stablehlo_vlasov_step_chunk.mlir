module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<128xf32>, %arg1: tensor<6xi32>, %arg2: tensor<65xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %4 = call @advect_1d_vectorized_39(%2, %3#0, %cst_2, %cst_3, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    ...
    %6 = call @advect_1d_vectorized(%5, %arg0, %cst_4, %cst_5, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf32>, %arg1: tensor<65xf32>, %arg2: tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %11 = call @fft_37(%10) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    ...
    %15 = call @fft_37(%14) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
  ...
  func.func private @fft_37(%arg0: tensor<65xcomplex<f32>>) -> tensor<128xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    return %0 : tensor<128xf32>
  }
  func.func private @advect_1d_vectorized_39(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.iota dim = 0 : tensor<128xf32>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xf32>) -> tensor<128x1xf32>
    %2 = stablehlo.convert %arg2 : tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<128x1xf32>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %42 = call @_where_40(%24, %41, %cst) : (tensor<128x128x6xi1>, tensor<128x128x6xf32>, tensor<f32>) -> tensor<128x128x6xf32>
  ...
  func.func private @_where_40(%arg0: tensor<128x128x6xi1>, %arg1: tensor<128x128x6xf32>, %arg2: tensor<f32>) -> tensor<128x128x6xf32> {
