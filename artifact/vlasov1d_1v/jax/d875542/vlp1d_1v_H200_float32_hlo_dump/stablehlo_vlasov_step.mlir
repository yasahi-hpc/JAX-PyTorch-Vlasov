module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf32>) -> (tensor<128x128xf32> {jax.result_info = "result[0]"}, tensor<128xf32> {jax.result_info = "result[1]"}, tensor<128xf32> {jax.result_info = "result[2]"}) {
    ...
    %4 = call @advect_1d_vectorized_38(%2, %3#0, %cst_4, %cst_5, %c) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    ...
    %6 = call @advect_1d_vectorized(%5, %cst, %cst_6, %cst_7, %c) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
