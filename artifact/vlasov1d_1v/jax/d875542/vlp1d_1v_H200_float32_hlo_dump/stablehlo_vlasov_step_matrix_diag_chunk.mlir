module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<65xf32>, %arg3: tensor<6xi32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>, %arg6: tensor<128x128xf32>, %arg7: tensor<128xf32>, %arg8: tensor<f32>, %arg9: tensor<i32>) -> (tensor<128xf32> {jax.result_info = "result[0][0]"}, tensor<128xf32> {jax.result_info = "result[0][1]"}, tensor<65xf32> {jax.result_info = "result[0][2]"}, tensor<6xi32> {jax.result_info = "result[0][3]"}, tensor<128xf32> {jax.result_info = "result[1][0]"}, tensor<128xf32> {jax.result_info = "result[1][1]"}, tensor<128x128xf32> {jax.result_info = "result[2][0]"}, tensor<128xf32> {jax.result_info = "result[2][1]"}, tensor<f32> {jax.result_info = "result[3]"}, tensor<i32> {jax.result_info = "result[4]"}) {
    ...
    cond {
      ...
      %3:3 = func.call @closed_call(%iterArg, %iterArg_4, %iterArg_5, %iterArg_7, %iterArg_8, %iterArg_9) : (tensor<128xf32>, tensor<6xi32>, tensor<65xf32>, tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>)
  ...
  func.func private @closed_call(%arg0: tensor<128xf32>, %arg1: tensor<6xi32>, %arg2: tensor<65xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>) -> (tensor<128x128xf32>, tensor<128xf32>, tensor<128xf32>) {
    %cst = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_0 = stablehlo.constant dense<0.0981747731> : tensor<f32>
    %0 = call @advect_1d_matrix_diag(%arg3, %arg0, %cst, %cst_0, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    %cst_1 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %1:3 = call @solve_poisson(%0, %arg2, %cst_1) : (tensor<128x128xf32>, tensor<65xf32>, tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>)
    %cst_2 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %cst_3 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %2 = call @advect_1d_matrix_diag_36(%0, %1#0, %cst_2, %cst_3, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
    %cst_4 = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_5 = stablehlo.constant dense<0.0981747731> : tensor<f32>
    %3 = call @advect_1d_matrix_diag(%2, %arg0, %cst_4, %cst_5, %arg1) : (tensor<128x128xf32>, tensor<128xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<128x128xf32>
  ...
  func.func private @advect_1d_matrix_diag(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    ...
    %19 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %22 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %25 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %28 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %31 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %32 = stablehlo.multiply %31, %10 : tensor<128xf32>
    %cst_7 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %33 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %36 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %39 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %42 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %55 = stablehlo.multiply %54, %11 : tensor<128xf32>
    %cst_16 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %56 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %59 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %62 = stablehlo.broadcast_in_dim %cst_18, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %65 = stablehlo.broadcast_in_dim %cst_19, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %66 = stablehlo.multiply %65, %10 : tensor<128xf32>
    %cst_20 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %67 = stablehlo.broadcast_in_dim %cst_20, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %70 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %71 = stablehlo.multiply %70, %11 : tensor<128xf32>
    %cst_22 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %72 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %75 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %78 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %81 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %84 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %87 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %88 = stablehlo.multiply %87, %11 : tensor<128xf32>
    %cst_28 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %89 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %92 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %95 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %98 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %99 = stablehlo.divide %7, %98 : tensor<128xf32>
    %cst_32 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %100 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %103 = stablehlo.broadcast_in_dim %cst_33, dims = [] : (tensor<f32>) -> tensor<128xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf32>, %arg1: tensor<65xf32>, %arg2: tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>) {
    ...
    %11 = call @fft_34(%10) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    ...
    %15 = call @fft_34(%14) : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
  ...
  func.func private @fft_34(%arg0: tensor<65xcomplex<f32>>) -> tensor<128xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f32>>) -> tensor<128xf32>
    return %0 : tensor<128xf32>
  }
  func.func private @advect_1d_matrix_diag_36(%arg0: tensor<128x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %2 = stablehlo.multiply %arg1, %1 : tensor<128xf32>
    %3 = stablehlo.convert %arg3 : tensor<f32>
    ...
    %15 = call @_roll_dynamic_50(%arg0, %14) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %24 = call @_roll_dynamic_50(%arg0, %23) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %33 = call @_roll_dynamic_50(%arg0, %32) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %42 = call @_roll_dynamic_50(%arg0, %41) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %51 = call @_roll_dynamic_50(%arg0, %50) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
    ...
    %60 = call @_roll_dynamic_50(%arg0, %59) : (tensor<128x128xf32>, tensor<128xi32>) -> tensor<128x128xf32>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<128xi32>, %arg2: tensor<128xf32>) -> tensor<6x128x128xf32> {
    ...
    %c_33 = stablehlo.constant dense<128> : tensor<i32>
    %116 = stablehlo.broadcast_in_dim %c_33, dims = [] : (tensor<i32>) -> tensor<6x128x128xi32>
    ...
    %120 = call @_where_46(%118, %119, %cst_34) : (tensor<6x128x128xi1>, tensor<6x128x1xf32>, tensor<f32>) -> tensor<6x128x128xf32>
    return %120 : tensor<6x128x128xf32>
  }
  func.func private @_where_46(%arg0: tensor<6x128x128xi1>, %arg1: tensor<6x128x1xf32>, %arg2: tensor<f32>) -> tensor<6x128x128xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
  ...
  func.func private @_roll_dynamic_50(%arg0: tensor<128x128xf32>, %arg1: tensor<128xi32>) -> tensor<128x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xi32>) -> tensor<128x1xi32>
    %1 = stablehlo.slice %0 [0:128, 0:1] : (tensor<128x1xi32>) -> tensor<128x1xi32>
    %2 = stablehlo.reshape %1 : (tensor<128x1xi32>) -> tensor<128xi32>
    %c = stablehlo.constant dense<128> : tensor<i32>
