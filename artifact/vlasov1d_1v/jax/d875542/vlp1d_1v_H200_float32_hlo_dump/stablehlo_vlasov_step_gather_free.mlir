module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf32>) -> (tensor<128x128xf32> {jax.result_info = "result[0]"}, tensor<128xf32> {jax.result_info = "result[1]"}, tensor<128xf32> {jax.result_info = "result[2]"}) {
    ...
    %cst_0 = stablehlo.constant dense<[0.000000e+00, 2.000000e+00, 1.000000e+00, 0.666666746, 5.000000e-01, 4.000000e-01, 0.333333373, 0.285714298, 2.500000e-01, 0.222222224, 2.000000e-01, 0.181818187, 0.166666687, 0.153846174, 0.142857149, 0.13333334, 1.250000e-01, 0.117647059, 0.111111112, 0.105263159, 1.000000e-01, 0.095238097, 0.0909090936, 0.0869565233, 0.0833333432, 8.000000e-02, 0.0769230872, 0.0740740672, 0.0714285746, 0.068965517, 0.0666666701, 0.0645161271, 6.250000e-02, 0.0606060587, 0.0588235296, 0.0571428575, 0.055555556, 0.0540540516, 0.0526315793, 0.051282052, 5.000000e-02, 0.048780486, 0.0476190485, 0.0465116277, 0.0454545468, 0.0444444455, 0.0434782617, 0.0425531901, 0.0416666716, 0.0408163257, 4.000000e-02, 0.0392156914, 0.0384615436, 0.0377358496, 0.0370370336, 0.0363636352, 0.0357142873, 0.0350877196, 0.0344827585, 0.0338983051, 0.0333333351, 0.0327868871, 0.0322580636, 0.0317460336, 3.125000e-02]> : tensor<65xf32>
    ...
    %12 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %15 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %18 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %21 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %22 = stablehlo.multiply %21, %0 : tensor<128xf32>
    %cst_8 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %23 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %26 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %27 = stablehlo.divide %1, %26 : tensor<128xf32>
    %28 = stablehlo.subtract %25, %27 : tensor<128xf32>
    %cst_10 = stablehlo.constant dense<6.000000e+00> : tensor<f32>
    %29 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %30 = stablehlo.divide %2, %29 : tensor<128xf32>
    %31 = stablehlo.subtract %28, %30 : tensor<128xf32>
    %cst_11 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %32 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %33 = stablehlo.divide %3, %32 : tensor<128xf32>
    %34 = stablehlo.add %31, %33 : tensor<128xf32>
    %cst_12 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %35 = stablehlo.broadcast_in_dim %cst_12, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %36 = stablehlo.divide %cst, %35 : tensor<128xf32>
    %cst_13 = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %37 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %38 = stablehlo.subtract %37, %36 : tensor<128xf32>
    %cst_14 = stablehlo.constant dense<5.000000e+00> : tensor<f32>
    %39 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %40 = stablehlo.multiply %39, %0 : tensor<128xf32>
    %cst_15 = stablehlo.constant dense<4.000000e+00> : tensor<f32>
    %41 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %42 = stablehlo.divide %40, %41 : tensor<128xf32>
    %43 = stablehlo.subtract %38, %42 : tensor<128xf32>
    %cst_16 = stablehlo.constant dense<5.000000e+00> : tensor<f32>
    %44 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %45 = stablehlo.multiply %44, %1 : tensor<128xf32>
    %cst_17 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %46 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %49 = stablehlo.broadcast_in_dim %cst_18, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %50 = stablehlo.divide %2, %49 : tensor<128xf32>
    %51 = stablehlo.add %48, %50 : tensor<128xf32>
    %cst_19 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %52 = stablehlo.broadcast_in_dim %cst_19, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %55 = stablehlo.broadcast_in_dim %cst_20, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %56 = stablehlo.multiply %55, %0 : tensor<128xf32>
    %cst_21 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %57 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %58 = stablehlo.divide %56, %57 : tensor<128xf32>
    %59 = stablehlo.add %cst, %58 : tensor<128xf32>
    %cst_22 = stablehlo.constant dense<7.000000e+00> : tensor<f32>
    %60 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %61 = stablehlo.multiply %60, %1 : tensor<128xf32>
    %cst_23 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %62 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %63 = stablehlo.divide %61, %62 : tensor<128xf32>
    %64 = stablehlo.subtract %59, %63 : tensor<128xf32>
    %cst_24 = stablehlo.constant dense<6.000000e+00> : tensor<f32>
    %65 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %66 = stablehlo.divide %2, %65 : tensor<128xf32>
    %67 = stablehlo.subtract %64, %66 : tensor<128xf32>
    %cst_25 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %68 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %71 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %74 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %75 = stablehlo.divide %0, %74 : tensor<128xf32>
    %76 = stablehlo.subtract %73, %75 : tensor<128xf32>
    %cst_28 = stablehlo.constant dense<7.000000e+00> : tensor<f32>
    %77 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %78 = stablehlo.multiply %77, %1 : tensor<128xf32>
    %cst_29 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %79 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %82 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %85 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %86 = stablehlo.divide %3, %85 : tensor<128xf32>
    %87 = stablehlo.subtract %84, %86 : tensor<128xf32>
    %cst_32 = stablehlo.constant dense<3.000000e+01> : tensor<f32>
    %88 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %89 = stablehlo.divide %cst, %88 : tensor<128xf32>
    %cst_33 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %90 = stablehlo.broadcast_in_dim %cst_33, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %91 = stablehlo.divide %1, %90 : tensor<128xf32>
    %92 = stablehlo.subtract %89, %91 : tensor<128xf32>
    %cst_34 = stablehlo.constant dense<1.200000e+02> : tensor<f32>
    %93 = stablehlo.broadcast_in_dim %cst_34, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %112 = stablehlo.broadcast_in_dim %cst_35, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %155:3 = call @solve_poisson(%154, %cst_0, %cst_36) : (tensor<128x128xf32>, tensor<65xf32>, tensor<f32>) -> (tensor<128xf32>, tensor<128xf32>, tensor<128xf32>)
    %cst_37 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %156 = stablehlo.broadcast_in_dim %cst_37, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %157 = stablehlo.multiply %155#0, %156 : tensor<128xf32>
    %cst_38 = stablehlo.constant dense<0.0787401571> : tensor<f32>
    %158 = stablehlo.broadcast_in_dim %cst_38, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %cst_39 = stablehlo.constant dense<2.000000e+01> : tensor<f32>
    %167 = stablehlo.broadcast_in_dim %cst_39, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %168 = stablehlo.divide %161, %167 : tensor<128xf32>
    %cst_40 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %169 = stablehlo.broadcast_in_dim %cst_40, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %172 = stablehlo.broadcast_in_dim %cst_41, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %173 = stablehlo.divide %164, %172 : tensor<128xf32>
    %174 = stablehlo.subtract %171, %173 : tensor<128xf32>
    %cst_42 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %175 = stablehlo.broadcast_in_dim %cst_42, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %176 = stablehlo.divide %165, %175 : tensor<128xf32>
    %177 = stablehlo.add %174, %176 : tensor<128xf32>
    %cst_43 = stablehlo.constant dense<1.200000e+02> : tensor<f32>
    %178 = stablehlo.broadcast_in_dim %cst_43, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %181 = stablehlo.broadcast_in_dim %cst_44, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %184 = stablehlo.broadcast_in_dim %cst_45, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %185 = stablehlo.multiply %184, %163 : tensor<128xf32>
    %cst_46 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %186 = stablehlo.broadcast_in_dim %cst_46, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %189 = stablehlo.broadcast_in_dim %cst_47, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %190 = stablehlo.divide %164, %189 : tensor<128xf32>
    %191 = stablehlo.subtract %188, %190 : tensor<128xf32>
    %cst_48 = stablehlo.constant dense<6.000000e+00> : tensor<f32>
    %192 = stablehlo.broadcast_in_dim %cst_48, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %193 = stablehlo.divide %165, %192 : tensor<128xf32>
    %194 = stablehlo.subtract %191, %193 : tensor<128xf32>
    %cst_49 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %195 = stablehlo.broadcast_in_dim %cst_49, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %196 = stablehlo.divide %166, %195 : tensor<128xf32>
    %197 = stablehlo.add %194, %196 : tensor<128xf32>
    %cst_50 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %198 = stablehlo.broadcast_in_dim %cst_50, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %199 = stablehlo.divide %161, %198 : tensor<128xf32>
    %cst_51 = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %200 = stablehlo.broadcast_in_dim %cst_51, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %201 = stablehlo.subtract %200, %199 : tensor<128xf32>
    %cst_52 = stablehlo.constant dense<5.000000e+00> : tensor<f32>
    %202 = stablehlo.broadcast_in_dim %cst_52, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %203 = stablehlo.multiply %202, %163 : tensor<128xf32>
    %cst_53 = stablehlo.constant dense<4.000000e+00> : tensor<f32>
    %204 = stablehlo.broadcast_in_dim %cst_53, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %205 = stablehlo.divide %203, %204 : tensor<128xf32>
    %206 = stablehlo.subtract %201, %205 : tensor<128xf32>
    %cst_54 = stablehlo.constant dense<5.000000e+00> : tensor<f32>
    %207 = stablehlo.broadcast_in_dim %cst_54, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %208 = stablehlo.multiply %207, %164 : tensor<128xf32>
    %cst_55 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %209 = stablehlo.broadcast_in_dim %cst_55, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %212 = stablehlo.broadcast_in_dim %cst_56, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %215 = stablehlo.broadcast_in_dim %cst_57, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %216 = stablehlo.divide %166, %215 : tensor<128xf32>
    %217 = stablehlo.subtract %214, %216 : tensor<128xf32>
    %cst_58 = stablehlo.constant dense<2.000000e+00> : tensor<f32>
    %218 = stablehlo.broadcast_in_dim %cst_58, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %219 = stablehlo.multiply %218, %163 : tensor<128xf32>
    %cst_59 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %220 = stablehlo.broadcast_in_dim %cst_59, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %223 = stablehlo.broadcast_in_dim %cst_60, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %224 = stablehlo.multiply %223, %164 : tensor<128xf32>
    %cst_61 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %225 = stablehlo.broadcast_in_dim %cst_61, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %226 = stablehlo.divide %224, %225 : tensor<128xf32>
    %227 = stablehlo.subtract %222, %226 : tensor<128xf32>
    %cst_62 = stablehlo.constant dense<6.000000e+00> : tensor<f32>
    %228 = stablehlo.broadcast_in_dim %cst_62, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %229 = stablehlo.divide %165, %228 : tensor<128xf32>
    %230 = stablehlo.subtract %227, %229 : tensor<128xf32>
    %cst_63 = stablehlo.constant dense<1.200000e+01> : tensor<f32>
    %231 = stablehlo.broadcast_in_dim %cst_63, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %232 = stablehlo.divide %166, %231 : tensor<128xf32>
    %233 = stablehlo.add %230, %232 : tensor<128xf32>
    %cst_64 = stablehlo.constant dense<4.000000e+00> : tensor<f32>
    %234 = stablehlo.broadcast_in_dim %cst_64, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %237 = stablehlo.broadcast_in_dim %cst_65, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %238 = stablehlo.divide %163, %237 : tensor<128xf32>
    %239 = stablehlo.subtract %236, %238 : tensor<128xf32>
    %cst_66 = stablehlo.constant dense<7.000000e+00> : tensor<f32>
    %240 = stablehlo.broadcast_in_dim %cst_66, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %241 = stablehlo.multiply %240, %164 : tensor<128xf32>
    %cst_67 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %242 = stablehlo.broadcast_in_dim %cst_67, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %245 = stablehlo.broadcast_in_dim %cst_68, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %248 = stablehlo.broadcast_in_dim %cst_69, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %249 = stablehlo.divide %166, %248 : tensor<128xf32>
    %250 = stablehlo.subtract %247, %249 : tensor<128xf32>
    %cst_70 = stablehlo.constant dense<3.000000e+01> : tensor<f32>
    %251 = stablehlo.broadcast_in_dim %cst_70, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %252 = stablehlo.divide %161, %251 : tensor<128xf32>
    %cst_71 = stablehlo.constant dense<2.400000e+01> : tensor<f32>
    %253 = stablehlo.broadcast_in_dim %cst_71, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %254 = stablehlo.divide %164, %253 : tensor<128xf32>
    %255 = stablehlo.subtract %252, %254 : tensor<128xf32>
    %cst_72 = stablehlo.constant dense<1.200000e+02> : tensor<f32>
    %256 = stablehlo.broadcast_in_dim %cst_72, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %266 = stablehlo.broadcast_in_dim %cst_73, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %271 = call @_where(%268, %270, %cst_74) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %277 = call @_where(%274, %276, %cst_76) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %283 = call @_where(%280, %282, %cst_78) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %289 = call @_where(%286, %288, %cst_80) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %295 = call @_where(%292, %294, %cst_82) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %301 = call @_where(%298, %300, %cst_84) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %302 = stablehlo.add %296, %301 : tensor<128xf32>
    %cst_85 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %303 = stablehlo.broadcast_in_dim %cst_85, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %308 = call @_where(%305, %307, %cst_87) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %314 = call @_where(%311, %313, %cst_89) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %320 = call @_where(%317, %319, %cst_91) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %326 = call @_where(%323, %325, %cst_93) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %332 = call @_where(%329, %331, %cst_95) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %338 = call @_where(%335, %337, %cst_97) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %339 = stablehlo.add %333, %338 : tensor<128xf32>
    %cst_98 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %340 = stablehlo.broadcast_in_dim %cst_98, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %345 = call @_where(%342, %344, %cst_100) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %351 = call @_where(%348, %350, %cst_102) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %357 = call @_where(%354, %356, %cst_104) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %363 = call @_where(%360, %362, %cst_106) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %369 = call @_where(%366, %368, %cst_108) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %375 = call @_where(%372, %374, %cst_110) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %376 = stablehlo.add %370, %375 : tensor<128xf32>
    %cst_111 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %377 = stablehlo.broadcast_in_dim %cst_111, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %382 = call @_where(%379, %381, %cst_113) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %388 = call @_where(%385, %387, %cst_115) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %394 = call @_where(%391, %393, %cst_117) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %400 = call @_where(%397, %399, %cst_119) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %406 = call @_where(%403, %405, %cst_121) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %412 = call @_where(%409, %411, %cst_123) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %413 = stablehlo.add %407, %412 : tensor<128xf32>
    %cst_124 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %414 = stablehlo.broadcast_in_dim %cst_124, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %419 = call @_where(%416, %418, %cst_126) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %425 = call @_where(%422, %424, %cst_128) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %431 = call @_where(%428, %430, %cst_130) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %437 = call @_where(%434, %436, %cst_132) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %443 = call @_where(%440, %442, %cst_134) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %449 = call @_where(%446, %448, %cst_136) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %450 = stablehlo.add %444, %449 : tensor<128xf32>
    %cst_137 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %451 = stablehlo.broadcast_in_dim %cst_137, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %456 = call @_where(%453, %455, %cst_139) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %462 = call @_where(%459, %461, %cst_141) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %468 = call @_where(%465, %467, %cst_143) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %474 = call @_where(%471, %473, %cst_145) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %480 = call @_where(%477, %479, %cst_147) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %486 = call @_where(%483, %485, %cst_149) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    %487 = stablehlo.add %481, %486 : tensor<128xf32>
    %cst_150 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %488 = stablehlo.broadcast_in_dim %cst_150, dims = [] : (tensor<f32>) -> tensor<128xf32>
    ...
    %493 = call @_where(%490, %492, %cst_152) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %499 = call @_where(%496, %498, %cst_154) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %505 = call @_where(%502, %504, %cst_156) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %511 = call @_where(%508, %510, %cst_158) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %517 = call @_where(%514, %516, %cst_160) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %523 = call @_where(%520, %522, %cst_162) : (tensor<128xi1>, tensor<128xf32>, tensor<f32>) -> tensor<128xf32>
    ...
    %533 = call @_pad(%154, %c_163) : (tensor<128x128xf32>, tensor<i32>) -> tensor<128x134xf32>
    %cst_164 = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %534 = stablehlo.broadcast_in_dim %cst_164, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
    ...
    %593 = stablehlo.broadcast_in_dim %cst_165, dims = [] : (tensor<f32>) -> tensor<128x128xf32>
