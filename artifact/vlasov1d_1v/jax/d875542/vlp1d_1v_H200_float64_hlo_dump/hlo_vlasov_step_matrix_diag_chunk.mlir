...
_roll_dynamic.3 {
  ...
  transpose.2 = f64[128,128]{0,1} transpose(Arg_0.7), dimensions={1,0}
  transpose.3 = f64[128,128]{0,1} transpose(Arg_0.7), dimensions={1,0}
...
advect_1d_matrix_diag.4 {
  Arg_0.8 = f64[128,128]{1,0} parameter(0)
  Arg_1.8 = f64[128]{0} parameter(1)
  Arg_2.4 = f64[] parameter(2)
  mul.36 = f64[128]{0} broadcast(Arg_2.4), dimensions={}
  mul.37 = f64[128]{0} multiply(Arg_1.8, mul.36)
  Arg_3.2 = f64[] parameter(3)
  div.33 = f64[128]{0} broadcast(Arg_3.2), dimensions={}
  ...
  vmap_jit__roll_dynamic__.6 = f64[128,128]{1,0} call(Arg_0.8, add.46), to_apply=_roll_dynamic.3
  ...
  div.32 = f64[128]{0} broadcast(constant.48), dimensions={}
  div.35 = f64[128]{0} divide(sub.20, div.32)
  mul.38 = f64[128]{0} multiply(sub.20, sub.20)
  constant.47 = f64[] constant(24)
  broadcast.19 = f64[128]{0} broadcast(constant.47), dimensions={}
  ...
  constant.46 = f64[] constant(120)
  broadcast.18 = f64[128]{0} broadcast(constant.46), dimensions={}
  ...
  vmap_jit__roll_dynamic__.7 = f64[128,128]{1,0} call(Arg_0.8, add.48), to_apply=_roll_dynamic.3
  transpose.11 = f64[128,128]{0,1} transpose(vmap_jit__roll_dynamic__.7), dimensions={1,0}
  constant.45 = f64[] constant(2)
  broadcast.17 = f64[128]{0} broadcast(constant.45), dimensions={}
  div.40 = f64[128]{0} divide(sub.20, broadcast.17)
  neg.2 = f64[128]{0} negate(div.40)
  mul.42 = f64[128]{0} multiply(mul.38, broadcast.17)
  constant.44 = f64[] constant(3)
  broadcast.16 = f64[128]{0} broadcast(constant.44), dimensions={}
  ...
  constant.43 = f64[] constant(6)
  broadcast.15 = f64[128]{0} broadcast(constant.43), dimensions={}
  ...
  vmap_jit__roll_dynamic__.8 = f64[128,128]{1,0} call(Arg_0.8, add.51), to_apply=_roll_dynamic.3
  transpose.12 = f64[128,128]{0,1} transpose(vmap_jit__roll_dynamic__.8), dimensions={1,0}
  constant.42 = f64[] constant(1)
  sub.19 = f64[128]{0} broadcast(constant.42), dimensions={}
  div.45 = f64[128]{0} divide(sub.20, broadcast.16)
  sub.26 = f64[128]{0} subtract(sub.19, div.45)
  constant.41 = f64[] constant(5)
  broadcast.14 = f64[128]{0} broadcast(constant.41), dimensions={}
  mul.43 = f64[128]{0} multiply(mul.38, broadcast.14)
  constant.40 = f64[] constant(4)
  broadcast.13 = f64[128]{0} broadcast(constant.40), dimensions={}
  ...
  constant.39 = f64[] constant(12)
  broadcast.12 = f64[128]{0} broadcast(constant.39), dimensions={}
  ...
  vmap_jit__roll_dynamic__.9 = f64[128,128]{1,0} call(Arg_0.8, add.54), to_apply=_roll_dynamic.3
  ...
  constant.38 = f64[] constant(7)
  broadcast.11 = f64[128]{0} broadcast(constant.38), dimensions={}
  ...
  vmap_jit__roll_dynamic__.10 = f64[128,128]{1,0} call(Arg_0.8, add.57), to_apply=_roll_dynamic.3
  ...
  vmap_jit__roll_dynamic__.11 = f64[128,128]{1,0} call(Arg_0.8, add.60), to_apply=_roll_dynamic.3
  transpose.15 = f64[128,128]{0,1} transpose(vmap_jit__roll_dynamic__.11), dimensions={1,0}
  constant.37 = f64[] constant(30)
  div.31 = f64[128]{0} broadcast(constant.37), dimensions={}
...
fft.6 {
  Arg_0.11 = f64[128]{0} parameter(0)
  ROOT fft.1 = c128[65]{0} fft(Arg_0.11), fft_type=RFFT, fft_length={128}
}

fft_34.7 {
  Arg_0.13 = c128[65]{0} parameter(0)
  ROOT fft.3 = f64[128]{0} fft(Arg_0.13), fft_type=IRFFT, fft_length={128}
}

solve_poisson.8 {
  Arg_0.14 = f64[128,128]{1,0} parameter(0)
  constant.54 = f64[] constant(0)
  reduce_sum.7 = f64[128]{0} reduce(Arg_0.14, constant.54), dimensions={1}, to_apply=region_1.5
  Arg_2.6 = f64[] parameter(2)
  mul.79 = f64[128]{0} broadcast(Arg_2.6), dimensions={}
  mul.80 = f64[128]{0} multiply(reduce_sum.7, mul.79)
  constant.53 = f64[] constant(1)
  sub.36 = f64[128]{0} broadcast(constant.53), dimensions={}
  sub.37 = f64[128]{0} subtract(mul.80, sub.36)
  jit_fft_.3 = c128[65]{0} call(sub.37), to_apply=fft.6
  constant.52 = c128[] constant((-0, -1))
  mul.78 = c128[65]{0} broadcast(constant.52), dimensions={}
  mul.81 = c128[65]{0} multiply(jit_fft_.3, mul.78)
  Arg_1.10 = f64[65]{0} parameter(1)
  convert_element_type.4 = c128[65]{0} convert(Arg_1.10)
  mul.82 = c128[65]{0} multiply(mul.81, convert_element_type.4)
  jit_fft_.4 = f64[128]{0} call(mul.82), to_apply=fft_34.7
  integer_pow.1 = f64[65]{0} multiply(Arg_1.10, Arg_1.10)
  convert_element_type.5 = c128[65]{0} convert(integer_pow.1)
  mul.83 = c128[65]{0} multiply(jit_fft_.3, convert_element_type.5)
  jit_fft_.5 = f64[128]{0} call(mul.83), to_apply=fft_34.7
  ROOT tuple.1 = (f64[128]{0}, f64[128]{0}, f64[128]{0}) tuple(jit_fft_.4, sub.37, jit_fft_.5)
}

_where_47.9 {
  Arg_0.18 = pred[6,128,128]{2,1,0} parameter(0)
  Arg_1.14 = f64[6,128,1]{2,1,0} parameter(1)
  broadcast_in_dim.29 = f64[6,128,1]{2,1,0} broadcast(Arg_1.14), dimensions={0,1,2}
  ...
  broadcast_in_dim.32 = f64[6,128,128]{2,1,0} broadcast(Arg_2.10), dimensions={}
  ROOT select_n.7 = f64[6,128,128]{2,1,0} select(Arg_0.18, broadcast_in_dim.31, broadcast_in_dim.32)
}
...
build_v_diag_weights.10 {
  ...
  constant.71 = s64[] constant(0)
  ge.2 = s64[6,128,128]{2,1,0} broadcast(constant.71), dimensions={}
  ge.3 = pred[6,128,128]{2,1,0} compare(sub.80, ge.2), direction=GE
  constant.70 = s64[] constant(128)
  lt.10 = s64[6,128,128]{2,1,0} broadcast(constant.70), dimensions={}
  lt.11 = pred[6,128,128]{2,1,0} compare(sub.80, lt.10), direction=LT
  and.3 = pred[6,128,128]{2,1,0} and(ge.3, lt.11)
  Arg_2.11 = f64[128]{0} parameter(2)
  constant.83 = f64[] constant(20)
  div.94 = f64[128]{0} broadcast(constant.83), dimensions={}
  div.95 = f64[128]{0} divide(Arg_2.11, div.94)
  mul.96 = f64[128]{0} multiply(Arg_2.11, Arg_2.11)
  constant.82 = f64[] constant(24)
  broadcast.37 = f64[128]{0} broadcast(constant.82), dimensions={}
  div.96 = f64[128]{0} divide(mul.96, broadcast.37)
  sub.61 = f64[128]{0} subtract(div.95, div.96)
  mul.97 = f64[128]{0} multiply(mul.96, Arg_2.11)
  div.97 = f64[128]{0} divide(mul.97, broadcast.37)
  sub.62 = f64[128]{0} subtract(sub.61, div.97)
  mul.98 = f64[128]{0} multiply(mul.97, Arg_2.11)
  div.98 = f64[128]{0} divide(mul.98, broadcast.37)
  add.79 = f64[128]{0} add(sub.62, div.98)
  mul.99 = f64[128]{0} multiply(mul.98, Arg_2.11)
  constant.81 = f64[] constant(120)
  broadcast.36 = f64[128]{0} broadcast(constant.81), dimensions={}
  ...
  constant.80 = f64[] constant(2)
  broadcast.35 = f64[128]{0} broadcast(constant.80), dimensions={}
  div.100 = f64[128]{0} divide(Arg_2.11, broadcast.35)
  neg.6 = f64[128]{0} negate(div.100)
  mul.100 = f64[128]{0} multiply(mul.96, broadcast.35)
  constant.79 = f64[] constant(3)
  broadcast.34 = f64[128]{0} broadcast(constant.79), dimensions={}
  ...
  constant.78 = f64[] constant(6)
  broadcast.33 = f64[128]{0} broadcast(constant.78), dimensions={}
  ...
  constant.77 = f64[] constant(1)
  sub.60 = f64[128]{0} broadcast(constant.77), dimensions={}
  div.105 = f64[128]{0} divide(Arg_2.11, broadcast.34)
  sub.66 = f64[128]{0} subtract(sub.60, div.105)
  constant.76 = f64[] constant(5)
  broadcast.32 = f64[128]{0} broadcast(constant.76), dimensions={}
  mul.101 = f64[128]{0} multiply(mul.96, broadcast.32)
  constant.75 = f64[] constant(4)
  broadcast.31 = f64[128]{0} broadcast(constant.75), dimensions={}
  ...
  constant.74 = f64[] constant(12)
  broadcast.30 = f64[128]{0} broadcast(constant.74), dimensions={}
  ...
  add.84 = f64[128]{0} add(Arg_2.11, div.110)
  constant.73 = f64[] constant(7)
  broadcast.29 = f64[128]{0} broadcast(constant.73), dimensions={}
  ...
  div.114 = f64[128]{0} divide(Arg_2.11, broadcast.31)
  ...
  constant.72 = f64[] constant(30)
  div.93 = f64[128]{0} broadcast(constant.72), dimensions={}
  div.119 = f64[128]{0} divide(Arg_2.11, div.93)
  ...
  constant.84 = f64[] constant(0)
  ROOT jit__where_.3 = f64[6,128,128]{2,1,0} call(and.3, broadcast_in_dim.43, constant.84), to_apply=_where_47.9
}

_roll_dynamic_51.11 {
  Arg_0.21 = f64[128,128]{1,0} parameter(0)
  concatenate.5 = f64[128,256]{1,0} concatenate(Arg_0.21, Arg_0.21), dimensions={1}
...
advect_1d_matrix_diag_36.12 {
  ...
  Arg_1.18 = f64[128]{0} parameter(1)
  Arg_2.12 = f64[] parameter(2)
  mul.112 = f64[128]{0} broadcast(Arg_2.12), dimensions={}
  mul.113 = f64[128]{0} multiply(Arg_1.18, mul.112)
  Arg_3.4 = f64[] parameter(3)
  div.122 = f64[128]{0} broadcast(Arg_3.4), dimensions={}
  ...
  jit_build_v_diag_weights_.1 = f64[6,128,128]{2,1,0} call(Arg_4.4, convert_element_type.9, sub.85), to_apply=build_v_diag_weights.10
  ...
  Arg_0.22 = f64[128,128]{1,0} parameter(0)
  ...
  vmap_jit__roll_dynamic__.18 = f64[128,128]{1,0} call(Arg_0.22, add.118), to_apply=_roll_dynamic_51.11
  ...
  vmap_jit__roll_dynamic__.19 = f64[128,128]{1,0} call(Arg_0.22, add.120), to_apply=_roll_dynamic_51.11
  ...
  vmap_jit__roll_dynamic__.20 = f64[128,128]{1,0} call(Arg_0.22, add.123), to_apply=_roll_dynamic_51.11
  ...
  vmap_jit__roll_dynamic__.21 = f64[128,128]{1,0} call(Arg_0.22, add.126), to_apply=_roll_dynamic_51.11
  ...
  vmap_jit__roll_dynamic__.22 = f64[128,128]{1,0} call(Arg_0.22, add.129), to_apply=_roll_dynamic_51.11
  ...
  vmap_jit__roll_dynamic__.23 = f64[128,128]{1,0} call(Arg_0.22, add.132), to_apply=_roll_dynamic_51.11
...
closed_call.13 {
  ...
  Arg_5.1 = f64[128]{0} parameter(5)
  Arg_3.5 = f64[128,128]{1,0} parameter(3)
  Arg_0.23 = f64[128]{0} parameter(0)
  constant.95 = f64[] constant(0.025)
  constant.96 = f64[] constant(0.098174770424681035)
  Arg_1.19 = s32[6]{0} parameter(1)
  jit_advect_1d_matrix_diag_.3 = f64[128,128]{0,1} call(Arg_3.5, Arg_0.23, constant.95, constant.96, Arg_1.19), to_apply=advect_1d_matrix_diag.4
  Arg_2.13 = f64[65]{0} parameter(2)
  constant.94 = f64[] constant(0.07874015748031496)
  jit_solve_poisson_.4 = (f64[128]{0}, f64[128]{0}, f64[128]{0}) call(jit_advect_1d_matrix_diag_.3, Arg_2.13, constant.94), to_apply=solve_poisson.8
  jit_solve_poisson_.5 = f64[128]{0} get-tuple-element(jit_solve_poisson_.4), index=0
  constant.93 = f64[] constant(0.05)
  jit_advect_1d_matrix_diag_.4 = f64[128,128]{1,0} call(jit_advect_1d_matrix_diag_.3, jit_solve_poisson_.5, constant.93, constant.94, Arg_1.19), to_apply=advect_1d_matrix_diag_36.12
  jit_advect_1d_matrix_diag_.5 = f64[128,128]{0,1} call(jit_advect_1d_matrix_diag_.4, Arg_0.23, constant.95, constant.96, Arg_1.19), to_apply=advect_1d_matrix_diag.4
...
region_0.14 {
  ...
  constant.97 = s64[] constant(1)
  add.135 = s64[] add(get-tuple-element.4, constant.97)
  constant.100 = f64[128]{0} constant({...})
  constant.99 = s32[6]{0} constant({-2, -1, 0, 1, 2, 3})
  constant.98 = f64[65]{0} constant({...})
  ...
  closed_call.4 = (f64[128,128]{0,1}, f64[128]{0}, f64[128]{0}) call(constant.100, constant.99, constant.98, get-tuple-element.5, get-tuple-element.6, get-tuple-element.7), to_apply=closed_call.13
  closed_call.5 = f64[128,128]{0,1} get-tuple-element(closed_call.4), index=0
  ...
  ROOT tuple.5 = (s64[], f64[128,128]{0,1}, f64[128]{0}, f64[128]{0}) tuple(add.135, closed_call.5, closed_call.6, closed_call.7)
}
...
region_2.15 {
  ...
  constant.102 = s64[] constant(1000)
...
ENTRY main.16 {
  ...
  while.6 = (s64[], f64[128,128]{1,0}, f64[128]{0}, f64[128]{0}) tuple(constant.105, start_state_2__0_.1, start_state_1__0_.1, start_state_1__1_.1)
  while.7 = (s64[], f64[128,128]{1,0}, f64[128]{0}, f64[128]{0}) while(while.6), condition=region_2.15, body=region_0.14
  ...
  constant.103 = f64[] constant(50)
  add.138 = f64[] add(start_state_3_.1, constant.103)
  start_state_4_.1 = s64[] parameter(9)
  constant.104 = s64[] constant(1000)
  add.139 = s64[] add(start_state_4_.1, constant.104)
  ROOT tuple.7 = (f64[128]{0}, f64[128]{0}, f64[65]{0}, s32[6]{0}, f64[128]{0}, /*index=5*/f64[128]{0}, f64[128,128]{1,0}, f64[128]{0}, f64[], s64[]) tuple(start_state_0__0_.1, start_state_0__1_.1, start_state_0__2_.1, start_state_0__3_.1, while.10, while.11, while.9, start_state_2__1_.1, add.138, add.139)
}
