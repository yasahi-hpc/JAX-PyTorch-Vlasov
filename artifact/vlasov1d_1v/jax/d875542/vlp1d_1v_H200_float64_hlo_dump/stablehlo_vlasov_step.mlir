module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x128xf64>) -> (tensor<128x128xf64> {jax.result_info = "result[0]"}, tensor<128xf64> {jax.result_info = "result[1]"}, tensor<128xf64> {jax.result_info = "result[2]"}) {
    ...
    %4 = call @advect_1d_vectorized_40(%2, %3#0, %cst_4, %cst_5, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    ...
    %6 = call @advect_1d_vectorized(%5, %cst, %cst_6, %cst_7, %c) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf64>, %arg1: tensor<65xf64>, %arg2: tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %11 = call @fft_38(%10) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    ...
    %15 = call @fft_38(%14) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
  ...
  func.func private @fft_38(%arg0: tensor<65xcomplex<f64>>) -> tensor<128xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    return %0 : tensor<128xf64>
  }
  func.func private @advect_1d_vectorized_40(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.iota dim = 0 : tensor<128xf64>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xf64>) -> tensor<128x1xf64>
    %2 = stablehlo.convert %arg2 : tensor<f64>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f64>) -> tensor<128x1xf64>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f64>
    %44 = call @_where_41(%24, %43, %cst) : (tensor<128x128x6xi1>, tensor<128x128x6xf64>, tensor<f64>) -> tensor<128x128x6xf64>
  ...
  func.func private @_where_41(%arg0: tensor<128x128x6xi1>, %arg1: tensor<128x128x6xf64>, %arg2: tensor<f64>) -> tensor<128x128x6xf64> {
