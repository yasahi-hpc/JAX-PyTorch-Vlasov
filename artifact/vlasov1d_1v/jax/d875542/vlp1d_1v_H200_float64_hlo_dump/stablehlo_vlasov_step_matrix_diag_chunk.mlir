module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<128xf64>, %arg1: tensor<6xi32>, %arg2: tensor<65xf64>, %arg3: tensor<128x128xf64>, %arg4: tensor<128xf64>, %arg5: tensor<128xf64>) -> (tensor<128x128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %2 = call @advect_1d_matrix_diag_36(%0, %1#0, %cst_2, %cst_3, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
    %cst_4 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_5 = stablehlo.constant dense<0.098174770424681035> : tensor<f64>
    %3 = call @advect_1d_matrix_diag(%2, %arg0, %cst_4, %cst_5, %arg1) : (tensor<128x128xf64>, tensor<128xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<128x128xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<128x128xf64>, %arg1: tensor<65xf64>, %arg2: tensor<f64>) -> (tensor<128xf64>, tensor<128xf64>, tensor<128xf64>) {
    ...
    %11 = call @fft_34(%10) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    ...
    %15 = call @fft_34(%14) : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
  ...
  func.func private @fft_34(%arg0: tensor<65xcomplex<f64>>) -> tensor<128xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [128] : (tensor<65xcomplex<f64>>) -> tensor<128xf64>
    return %0 : tensor<128xf64>
  }
  func.func private @advect_1d_matrix_diag_36(%arg0: tensor<128x128xf64>, %arg1: tensor<128xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f64>) -> tensor<128xf64>
    %2 = stablehlo.multiply %arg1, %1 : tensor<128xf64>
    %3 = stablehlo.convert %arg3 : tensor<f64>
    ...
    %15 = call @_roll_dynamic_51(%arg0, %14) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %24 = call @_roll_dynamic_51(%arg0, %23) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %33 = call @_roll_dynamic_51(%arg0, %32) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %42 = call @_roll_dynamic_51(%arg0, %41) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %51 = call @_roll_dynamic_51(%arg0, %50) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
    ...
    %60 = call @_roll_dynamic_51(%arg0, %59) : (tensor<128x128xf64>, tensor<128xi32>) -> tensor<128x128xf64>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<128xi32>, %arg2: tensor<128xf64>) -> tensor<6x128x128xf64> {
    ...
    %121 = call @_where_47(%119, %120, %cst_34) : (tensor<6x128x128xi1>, tensor<6x128x1xf64>, tensor<f64>) -> tensor<6x128x128xf64>
    return %121 : tensor<6x128x128xf64>
  }
  func.func private @_where_47(%arg0: tensor<6x128x128xi1>, %arg1: tensor<6x128x1xf64>, %arg2: tensor<f64>) -> tensor<6x128x128xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
  ...
  func.func private @_roll_dynamic_51(%arg0: tensor<128x128xf64>, %arg1: tensor<128xi32>) -> tensor<128x128xf64> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<128xi32>) -> tensor<128x1xi32>
    %1 = stablehlo.slice %0 [0:128, 0:1] : (tensor<128x1xi32>) -> tensor<128x1xi32>
    %2 = stablehlo.reshape %1 : (tensor<128x1xi32>) -> tensor<128xi32>
    %c = stablehlo.constant dense<128> : tensor<i32>
