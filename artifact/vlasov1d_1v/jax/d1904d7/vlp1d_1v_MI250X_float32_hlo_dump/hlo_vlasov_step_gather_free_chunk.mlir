...
closed_call.17 {
  ...
  broadcast_in_dim.8 = f32[1,128]{1,0} reshape(sub.33)
  mul.121 = f32[1,128]{1,0} broadcast(broadcast_in_dim.8), dimensions={0,1}
  ...
  broadcast_in_dim.9 = f32[1,128]{1,0} reshape(add.73)
  mul.125 = f32[1,128]{1,0} broadcast(broadcast_in_dim.9), dimensions={0,1}
  ...
  broadcast_in_dim.10 = f32[1,128]{1,0} reshape(sub.38)
  mul.129 = f32[1,128]{1,0} broadcast(broadcast_in_dim.10), dimensions={0,1}
  ...
  broadcast_in_dim.11 = f32[1,128]{1,0} reshape(add.77)
  mul.133 = f32[1,128]{1,0} broadcast(broadcast_in_dim.11), dimensions={0,1}
  ...
  broadcast_in_dim.12 = f32[1,128]{1,0} reshape(sub.42)
  mul.137 = f32[1,128]{1,0} broadcast(broadcast_in_dim.12), dimensions={0,1}
  ...
  broadcast_in_dim.13 = f32[1,128]{1,0} reshape(add.80)
  mul.141 = f32[1,128]{1,0} broadcast(broadcast_in_dim.13), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.7 = f32[128,1]{1,0} reshape(add.100)
  mul.156 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.7), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.8 = f32[128,1]{1,0} reshape(add.105)
  mul.160 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.8), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.9 = f32[128,1]{1,0} reshape(add.110)
  mul.164 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.9), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.10 = f32[128,1]{1,0} reshape(add.115)
  mul.168 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.10), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.11 = f32[128,1]{1,0} reshape(add.120)
  mul.172 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.11), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.12 = f32[128,1]{1,0} reshape(add.125)
  mul.176 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.12), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.13 = f32[128,1]{1,0} reshape(add.130)
  mul.180 = f32[128,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.13), dimensions={0,1}
  ...
  mul.184 = f32[1,128]{1,0} broadcast(broadcast_in_dim.8), dimensions={0,1}
  ...
  mul.188 = f32[1,128]{1,0} broadcast(broadcast_in_dim.9), dimensions={0,1}
  ...
  mul.192 = f32[1,128]{1,0} broadcast(broadcast_in_dim.10), dimensions={0,1}
  ...
  mul.196 = f32[1,128]{1,0} broadcast(broadcast_in_dim.11), dimensions={0,1}
  ...
  mul.200 = f32[1,128]{1,0} broadcast(broadcast_in_dim.12), dimensions={0,1}
  ...
  mul.204 = f32[1,128]{1,0} broadcast(broadcast_in_dim.13), dimensions={0,1}
