...
remainder.2 {
  ...
  eq.1 = pred[] compare(convert_element_type.2, constant.32), direction=EQ
  constant.31 = s32[] constant(1)
  jit__where_.1 = s32[] call(eq.1, constant.31, convert_element_type.2), to_apply=_where.1
...
advect_1d_vectorized.3 {
  ...
  Arg_1.6 = f64[128]{0} parameter(1)
  broadcast_in_dim.6 = f64[128,1]{1,0} reshape(Arg_1.6)
  Arg_2.4 = f64[] parameter(2)
  mul.21 = f64[128,1]{1,0} broadcast(Arg_2.4), dimensions={}
  mul.22 = f64[128,1]{1,0} multiply(broadcast_in_dim.6, mul.21)
  Arg_3.2 = f64[] parameter(3)
  div.33 = f64[128,1]{1,0} broadcast(Arg_3.2), dimensions={}
  ...
  div.32 = f64[128,128]{1,0} broadcast(constant.44), dimensions={}
  div.35 = f64[128,128]{1,0} divide(sub.30, div.32)
  mul.24 = f64[128,128]{1,0} multiply(sub.30, sub.30)
  constant.43 = f64[] constant(24)
  broadcast.19 = f64[128,128]{1,0} broadcast(constant.43), dimensions={}
  ...
  broadcast.18 = f64[128,128]{1,0} broadcast(constant.42), dimensions={}
  ...
  reshape.3 = f64[16384]{0} reshape(Arg_0.6)
  iota.3 = s64[128]{0} iota(), iota_dimension=0
  broadcast_in_dim.10 = s64[128,1,1]{2,1,0} reshape(iota.3)
  constant.47 = s64[] constant(128)
  mul.20 = s64[128,1,1]{2,1,0} broadcast(constant.47), dimensions={}
  ...
  constant.46 = s64[] constant(0)
  lt.6 = s64[98304]{0} broadcast(constant.46), dimensions={}
  lt.7 = pred[98304]{0} compare(reshape.4, lt.6), direction=LT
  constant.45 = s64[] constant(16384)
  add.32 = s64[98304]{0} broadcast(constant.45), dimensions={}
  ...
  broadcast.17 = f64[128,128]{1,0} broadcast(constant.41), dimensions={}
  ...
  broadcast.16 = f64[128,128]{1,0} broadcast(constant.40), dimensions={}
  ...
  broadcast.15 = f64[128,128]{1,0} broadcast(constant.39), dimensions={}
  ...
  broadcast.12 = f64[128,128]{1,0} broadcast(constant.35), dimensions={}
  ...
  broadcast.11 = f64[128,128]{1,0} broadcast(constant.34), dimensions={}
  ...
  div.31 = f64[128,128]{1,0} broadcast(constant.33), dimensions={}
...
fft.5 {
  Arg_0.9 = f64[128]{0} parameter(0)
  ROOT fft.1 = c128[65]{0} fft(Arg_0.9), fft_type=RFFT, fft_length={128}
}

fft_39.6 {
  Arg_0.11 = c128[65]{0} parameter(0)
  ROOT fft.3 = f64[128]{0} fft(Arg_0.11), fft_type=IRFFT, fft_length={128}
}

solve_poisson.7 {
  Arg_0.12 = f64[128,128]{1,0} parameter(0)
  constant.54 = f64[] constant(0)
  reduce_sum.7 = f64[128]{0} reduce(Arg_0.12, constant.54), dimensions={1}, to_apply=region_1.4
  Arg_2.6 = f64[] parameter(2)
  mul.47 = f64[128]{0} broadcast(Arg_2.6), dimensions={}
  mul.48 = f64[128]{0} multiply(reduce_sum.7, mul.47)
  constant.53 = f64[] constant(1)
  sub.46 = f64[128]{0} broadcast(constant.53), dimensions={}
  sub.47 = f64[128]{0} subtract(mul.48, sub.46)
  jit_fft_.3 = c128[65]{0} call(sub.47), to_apply=fft.5
  constant.52 = c128[] constant((-0, -1))
  mul.46 = c128[65]{0} broadcast(constant.52), dimensions={}
  mul.49 = c128[65]{0} multiply(jit_fft_.3, mul.46)
  Arg_1.8 = f64[65]{0} parameter(1)
  convert_element_type.10 = c128[65]{0} convert(Arg_1.8)
  mul.50 = c128[65]{0} multiply(mul.49, convert_element_type.10)
  jit_fft_.4 = f64[128]{0} call(mul.50), to_apply=fft_39.6
  integer_pow.1 = f64[65]{0} multiply(Arg_1.8, Arg_1.8)
  convert_element_type.11 = c128[65]{0} convert(integer_pow.1)
  mul.51 = c128[65]{0} multiply(jit_fft_.3, convert_element_type.11)
  jit_fft_.5 = f64[128]{0} call(mul.51), to_apply=fft_39.6
  ROOT tuple.1 = (f64[128]{0}, f64[128]{0}, f64[128]{0}) tuple(jit_fft_.4, sub.47, jit_fft_.5)
}

clip.8 {
  Arg_2.9 = s64[] parameter(2)
  convert_element_type.16 = s32[] convert(Arg_2.9)
  min.2 = s32[128,128,6]{2,1,0} broadcast(convert_element_type.16), dimensions={}
  Arg_1.11 = s64[] parameter(1)
  convert_element_type.15 = s32[] convert(Arg_1.11)
...
_where_42.9 {
  ...
  Arg_1.13 = f64[128,128,6]{2,1,0} parameter(1)
  Arg_2.11 = f64[] parameter(2)
  broadcast_in_dim.19 = f64[128,128,6]{2,1,0} broadcast(Arg_2.11), dimensions={}
  ROOT select_n.8 = f64[128,128,6]{2,1,0} select(Arg_0.17, Arg_1.13, broadcast_in_dim.19)
}

advect_1d_vectorized_41.10 {
  ...
  Arg_1.14 = f64[128]{0} parameter(1)
  broadcast_in_dim.20 = f64[128,1]{1,0} reshape(Arg_1.14)
  Arg_2.12 = f64[] parameter(2)
  mul.73 = f64[128,1]{1,0} broadcast(Arg_2.12), dimensions={}
  mul.74 = f64[128,1]{1,0} multiply(broadcast_in_dim.20, mul.73)
  Arg_3.4 = f64[] parameter(3)
  div.95 = f64[128,1]{1,0} broadcast(Arg_3.4), dimensions={}
  ...
  div.94 = f64[128,128]{1,0} broadcast(constant.86), dimensions={}
  div.97 = f64[128,128]{1,0} divide(sub.78, div.94)
  mul.76 = f64[128,128]{1,0} multiply(sub.78, sub.78)
  constant.85 = f64[] constant(24)
  broadcast.37 = f64[128,128]{1,0} broadcast(constant.85), dimensions={}
  ...
  broadcast.36 = f64[128,128]{1,0} broadcast(constant.84), dimensions={}
  ...
  reshape.9 = f64[16384]{0} reshape(Arg_0.18)
  iota.7 = s64[128]{0} iota(), iota_dimension=0
  broadcast_in_dim.24 = s64[128,1,1]{2,1,0} reshape(iota.7)
  constant.89 = s64[] constant(128)
  mul.72 = s64[128,1,1]{2,1,0} broadcast(constant.89), dimensions={}
  ...
  constant.88 = s64[] constant(0)
  lt.12 = s64[98304]{0} broadcast(constant.88), dimensions={}
  lt.15 = pred[98304]{0} compare(reshape.10, lt.12), direction=LT
  constant.87 = s64[] constant(16384)
  add.88 = s64[98304]{0} broadcast(constant.87), dimensions={}
  ...
  jit__where_.3 = f64[128,128,6]{2,1,0} call(and.3, reshape.11, constant.92), to_apply=_where_42.9
  ...
  broadcast.35 = f64[128,128]{1,0} broadcast(constant.83), dimensions={}
  ...
  broadcast.34 = f64[128,128]{1,0} broadcast(constant.82), dimensions={}
  ...
  broadcast.33 = f64[128,128]{1,0} broadcast(constant.81), dimensions={}
  ...
  sub.70 = f64[128,128]{1,0} broadcast(constant.80), dimensions={}
  ...
  broadcast.32 = f64[128,128]{1,0} broadcast(constant.79), dimensions={}
  mul.81 = f64[128,128]{1,0} multiply(mul.76, broadcast.32)
  constant.78 = f64[] constant(4)
  broadcast.31 = f64[128,128]{1,0} broadcast(constant.78), dimensions={}
  ...
  broadcast.30 = f64[128,128]{1,0} broadcast(constant.77), dimensions={}
  ...
  broadcast.29 = f64[128,128]{1,0} broadcast(constant.76), dimensions={}
  ...
  div.93 = f64[128,128]{1,0} broadcast(constant.75), dimensions={}
...
closed_call.11 {
  ...
  transpose.4 = f64[128,128]{0,1} transpose(Arg_3.5), dimensions={1,0}
  Arg_0.19 = f64[128]{0} parameter(0)
  constant.98 = f64[] constant(0.025)
  constant.97 = f64[] constant(0.098174770424681035)
  Arg_1.15 = s32[6]{0} parameter(1)
  jit_advect_1d_vectorized_.3 = f64[128,128]{1,0} call(transpose.4, Arg_0.19, constant.98, constant.97, Arg_1.15), to_apply=advect_1d_vectorized.3
  transpose.5 = f64[128,128]{0,1} transpose(jit_advect_1d_vectorized_.3), dimensions={1,0}
  Arg_2.13 = f64[65]{0} parameter(2)
  constant.96 = f64[] constant(0.07874015748031496)
  jit_solve_poisson_.4 = (f64[128]{0}, f64[128]{0}, f64[128]{0}) call(transpose.5, Arg_2.13, constant.96), to_apply=solve_poisson.7
  jit_solve_poisson_.5 = f64[128]{0} get-tuple-element(jit_solve_poisson_.4), index=0
  constant.95 = f64[] constant(0.05)
  jit_advect_1d_vectorized_.4 = f64[128,128]{1,0} call(transpose.5, jit_solve_poisson_.5, constant.95, constant.96, Arg_1.15), to_apply=advect_1d_vectorized_41.10
  transpose.6 = f64[128,128]{0,1} transpose(jit_advect_1d_vectorized_.4), dimensions={1,0}
  jit_advect_1d_vectorized_.5 = f64[128,128]{1,0} call(transpose.6, Arg_0.19, constant.98, constant.97, Arg_1.15), to_apply=advect_1d_vectorized.3
...
region_0.12 {
  ...
  add.117 = s64[] add(get-tuple-element.4, constant.99)
  constant.102 = f64[128]{0} constant({...})
  constant.101 = s32[6]{0} constant({-2, -1, 0, 1, 2, 3})
  constant.100 = f64[65]{0} constant({...})
  ...
  closed_call.4 = (f64[128,128]{0,1}, f64[128]{0}, f64[128]{0}) call(constant.102, constant.101, constant.100, get-tuple-element.5, get-tuple-element.6, get-tuple-element.7), to_apply=closed_call.11
  ...
  ROOT tuple.5 = (s64[], f64[128,128]{0,1}, f64[128]{0}, f64[128]{0}) tuple(add.117, closed_call.5, closed_call.6, closed_call.7)
}
...
ENTRY main.14 {
  ...
  while.6 = (s64[], f64[128,128]{1,0}, f64[128]{0}, f64[128]{0}) tuple(constant.107, start_state_2__0_.1, start_state_1__0_.1, start_state_1__1_.1)
  while.7 = (s64[], f64[128,128]{1,0}, f64[128]{0}, f64[128]{0}) while(while.6), condition=region_2.13, body=region_0.12
  ...
  constant.105 = f64[] constant(50)
  add.120 = f64[] add(start_state_3_.1, constant.105)
  start_state_4_.1 = s64[] parameter(9)
  constant.106 = s64[] constant(1000)
  add.121 = s64[] add(start_state_4_.1, constant.106)
  ROOT tuple.7 = (f64[128]{0}, f64[128]{0}, f64[65]{0}, s32[6]{0}, f64[128]{0}, /*index=5*/f64[128]{0}, f64[128,128]{1,0}, f64[128]{0}, f64[], s64[]) tuple(start_state_0__0_.1, start_state_0__1_.1, start_state_0__2_.1, start_state_0__3_.1, while.10, while.11, while.9, start_state_2__1_.1, add.120, add.121)
}
