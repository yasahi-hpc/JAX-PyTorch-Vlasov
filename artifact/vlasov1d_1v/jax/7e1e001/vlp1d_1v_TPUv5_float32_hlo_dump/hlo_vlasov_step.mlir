...
remainder.2 {
  ...
  eq.1 = pred[] compare(Arg_1.4, constant.28), direction=EQ
  constant.27 = s32[] constant(1)
  jit__where_.1 = s32[] call(eq.1, constant.27, Arg_1.4), to_apply=_where.1
...
advect_1d_vectorized.3 {
  ...
  Arg_1.5 = f32[128]{0} parameter(1)
  broadcast_in_dim.6 = f32[128,1]{1,0} reshape(Arg_1.5)
  Arg_2.3 = f32[] parameter(2)
  mul.21 = f32[128,1]{1,0} broadcast(Arg_2.3), dimensions={}
  mul.22 = f32[128,1]{1,0} multiply(broadcast_in_dim.6, mul.21)
  Arg_3.1 = f32[] parameter(3)
  div.33 = f32[128,1]{1,0} broadcast(Arg_3.1), dimensions={}
  ...
  constant.40 = f32[] constant(20)
  div.32 = f32[128,128]{1,0} broadcast(constant.40), dimensions={}
  div.35 = f32[128,128]{1,0} divide(sub.30, div.32)
  mul.24 = f32[128,128]{1,0} multiply(sub.30, sub.30)
  constant.39 = f32[] constant(24)
  broadcast.19 = f32[128,128]{1,0} broadcast(constant.39), dimensions={}
  ...
  constant.38 = f32[] constant(120)
  broadcast.18 = f32[128,128]{1,0} broadcast(constant.38), dimensions={}
  div.39 = f32[128,128]{1,0} divide(mul.27, broadcast.18)
  sub.33 = f32[128,128]{1,0} subtract(add.45, div.39)
  Arg_0.5 = f32[128,128]{1,0} parameter(0)
  reshape.3 = f32[16384]{0} reshape(Arg_0.5)
  iota.3 = s32[128]{0} iota(), iota_dimension=0
  broadcast_in_dim.10 = s32[128,1,1]{2,1,0} reshape(iota.3)
  constant.43 = s32[] constant(128)
  mul.20 = s32[128,1,1]{2,1,0} broadcast(constant.43), dimensions={}
  ...
  lt.6 = s32[98304]{0} broadcast(constant.42), dimensions={}
  lt.7 = pred[98304]{0} compare(reshape.4, lt.6), direction=LT
  constant.41 = s32[] constant(16384)
  add.32 = s32[98304]{0} broadcast(constant.41), dimensions={}
  ...
  constant.37 = f32[] constant(2)
  broadcast.17 = f32[128,128]{1,0} broadcast(constant.37), dimensions={}
  ...
  constant.36 = f32[] constant(3)
  broadcast.16 = f32[128,128]{1,0} broadcast(constant.36), dimensions={}
  ...
  constant.35 = f32[] constant(6)
  broadcast.15 = f32[128,128]{1,0} broadcast(constant.35), dimensions={}
  ...
  sub.22 = f32[128,128]{1,0} broadcast(constant.34), dimensions={}
  div.45 = f32[128,128]{1,0} divide(sub.30, broadcast.16)
  sub.36 = f32[128,128]{1,0} subtract(sub.22, div.45)
  constant.33 = f32[] constant(5)
  broadcast.14 = f32[128,128]{1,0} broadcast(constant.33), dimensions={}
  mul.29 = f32[128,128]{1,0} multiply(mul.24, broadcast.14)
  constant.32 = f32[] constant(4)
  broadcast.13 = f32[128,128]{1,0} broadcast(constant.32), dimensions={}
  ...
  constant.31 = f32[] constant(12)
  broadcast.12 = f32[128,128]{1,0} broadcast(constant.31), dimensions={}
  ...
  constant.30 = f32[] constant(7)
  broadcast.11 = f32[128,128]{1,0} broadcast(constant.30), dimensions={}
  ...
  constant.29 = f32[] constant(30)
  div.31 = f32[128,128]{1,0} broadcast(constant.29), dimensions={}
...
fft.5 {
  Arg_0.8 = f32[128]{0} parameter(0)
  ROOT fft.1 = c64[65]{0} fft(Arg_0.8), fft_type=RFFT, fft_length={128}
}

fft_36.6 {
  Arg_0.10 = c64[65]{0} parameter(0)
  ROOT fft.3 = f32[128]{0} fft(Arg_0.10), fft_type=IRFFT, fft_length={128}
}

solve_poisson.7 {
  Arg_0.11 = f32[128,128]{1,0} parameter(0)
  constant.50 = f32[] constant(0)
  reduce_sum.7 = f32[128]{0} reduce(Arg_0.11, constant.50), dimensions={1}, to_apply=region_0.4
  Arg_2.5 = f32[] parameter(2)
  mul.47 = f32[128]{0} broadcast(Arg_2.5), dimensions={}
  mul.48 = f32[128]{0} multiply(reduce_sum.7, mul.47)
  constant.49 = f32[] constant(1)
  sub.46 = f32[128]{0} broadcast(constant.49), dimensions={}
  sub.47 = f32[128]{0} subtract(mul.48, sub.46)
  jit_fft_.3 = c64[65]{0} call(sub.47), to_apply=fft.5
  constant.48 = c64[] constant((-0, -1))
  mul.46 = c64[65]{0} broadcast(constant.48), dimensions={}
  mul.49 = c64[65]{0} multiply(jit_fft_.3, mul.46)
  Arg_1.7 = f32[65]{0} parameter(1)
  convert_element_type.4 = c64[65]{0} convert(Arg_1.7)
  mul.50 = c64[65]{0} multiply(mul.49, convert_element_type.4)
  jit_fft_.4 = f32[128]{0} call(mul.50), to_apply=fft_36.6
  integer_pow.1 = f32[65]{0} multiply(Arg_1.7, Arg_1.7)
  convert_element_type.5 = c64[65]{0} convert(integer_pow.1)
  mul.51 = c64[65]{0} multiply(jit_fft_.3, convert_element_type.5)
  jit_fft_.5 = f32[128]{0} call(mul.51), to_apply=fft_36.6
  ROOT tuple.1 = (f32[128]{0}, f32[128]{0}, f32[128]{0}) tuple(jit_fft_.4, sub.47, jit_fft_.5)
}

clip.8 {
  Arg_2.8 = s32[] parameter(2)
  min.2 = s32[128,128,6]{2,1,0} broadcast(Arg_2.8), dimensions={}
  Arg_1.10 = s32[] parameter(1)
  max.2 = s32[128,128,6]{2,1,0} broadcast(Arg_1.10), dimensions={}
...
_where_39.9 {
  ...
  Arg_1.12 = f32[128,128,6]{2,1,0} parameter(1)
  Arg_2.10 = f32[] parameter(2)
  broadcast_in_dim.19 = f32[128,128,6]{2,1,0} broadcast(Arg_2.10), dimensions={}
  ROOT select_n.8 = f32[128,128,6]{2,1,0} select(Arg_0.16, Arg_1.12, broadcast_in_dim.19)
}

advect_1d_vectorized_38.10 {
  ...
  Arg_1.13 = f32[128]{0} parameter(1)
  broadcast_in_dim.20 = f32[128,1]{1,0} reshape(Arg_1.13)
  Arg_2.11 = f32[] parameter(2)
  mul.73 = f32[128,1]{1,0} broadcast(Arg_2.11), dimensions={}
  mul.74 = f32[128,1]{1,0} multiply(broadcast_in_dim.20, mul.73)
  Arg_3.3 = f32[] parameter(3)
  div.95 = f32[128,1]{1,0} broadcast(Arg_3.3), dimensions={}
  ...
  constant.82 = f32[] constant(20)
  div.94 = f32[128,128]{1,0} broadcast(constant.82), dimensions={}
  div.97 = f32[128,128]{1,0} divide(sub.78, div.94)
  mul.76 = f32[128,128]{1,0} multiply(sub.78, sub.78)
  constant.81 = f32[] constant(24)
  broadcast.37 = f32[128,128]{1,0} broadcast(constant.81), dimensions={}
  ...
  constant.80 = f32[] constant(120)
  broadcast.36 = f32[128,128]{1,0} broadcast(constant.80), dimensions={}
  ...
  reshape.9 = f32[16384]{0} reshape(Arg_0.17)
  iota.7 = s32[128]{0} iota(), iota_dimension=0
  broadcast_in_dim.24 = s32[128,1,1]{2,1,0} reshape(iota.7)
  constant.85 = s32[] constant(128)
  mul.72 = s32[128,1,1]{2,1,0} broadcast(constant.85), dimensions={}
  ...
  lt.12 = s32[98304]{0} broadcast(constant.84), dimensions={}
  lt.15 = pred[98304]{0} compare(reshape.10, lt.12), direction=LT
  constant.83 = s32[] constant(16384)
  add.88 = s32[98304]{0} broadcast(constant.83), dimensions={}
  ...
  jit__where_.3 = f32[128,128,6]{2,1,0} call(and.3, reshape.11, constant.88), to_apply=_where_39.9
  ...
  constant.79 = f32[] constant(2)
  broadcast.35 = f32[128,128]{1,0} broadcast(constant.79), dimensions={}
  ...
  constant.78 = f32[] constant(3)
  broadcast.34 = f32[128,128]{1,0} broadcast(constant.78), dimensions={}
  ...
  constant.77 = f32[] constant(6)
  broadcast.33 = f32[128,128]{1,0} broadcast(constant.77), dimensions={}
  ...
  sub.70 = f32[128,128]{1,0} broadcast(constant.76), dimensions={}
  div.107 = f32[128,128]{1,0} divide(sub.78, broadcast.34)
  sub.84 = f32[128,128]{1,0} subtract(sub.70, div.107)
  constant.75 = f32[] constant(5)
  broadcast.32 = f32[128,128]{1,0} broadcast(constant.75), dimensions={}
  mul.81 = f32[128,128]{1,0} multiply(mul.76, broadcast.32)
  constant.74 = f32[] constant(4)
  broadcast.31 = f32[128,128]{1,0} broadcast(constant.74), dimensions={}
  ...
  constant.73 = f32[] constant(12)
  broadcast.30 = f32[128,128]{1,0} broadcast(constant.73), dimensions={}
  ...
  constant.72 = f32[] constant(7)
  broadcast.29 = f32[128,128]{1,0} broadcast(constant.72), dimensions={}
  ...
  constant.71 = f32[] constant(30)
  div.93 = f32[128,128]{1,0} broadcast(constant.71), dimensions={}
...
ENTRY main.11 {
  ...
  transpose.4 = f32[128,128]{0,1} transpose(carry_0_.1), dimensions={1,0}
  constant.95 = f32[128]{0} constant({...})
  constant.94 = f32[] constant(0.025)
  constant.93 = f32[] constant(0.0981747732)
  constant.96 = s32[6]{0} constant({-2, -1, 0, 1, 2, 3})
  jit_advect_1d_vectorized_.3 = f32[128,128]{1,0} call(transpose.4, constant.95, constant.94, constant.93, constant.96), to_apply=advect_1d_vectorized.3
  transpose.5 = f32[128,128]{0,1} transpose(jit_advect_1d_vectorized_.3), dimensions={1,0}
  constant.97 = f32[65]{0} constant({...})
  constant.92 = f32[] constant(0.0787401572)
  jit_solve_poisson_.4 = (f32[128]{0}, f32[128]{0}, f32[128]{0}) call(transpose.5, constant.97, constant.92), to_apply=solve_poisson.7
  jit_solve_poisson_.5 = f32[128]{0} get-tuple-element(jit_solve_poisson_.4), index=0
  constant.91 = f32[] constant(0.05)
  jit_advect_1d_vectorized_.4 = f32[128,128]{1,0} call(transpose.5, jit_solve_poisson_.5, constant.91, constant.92, constant.96), to_apply=advect_1d_vectorized_38.10
  transpose.6 = f32[128,128]{0,1} transpose(jit_advect_1d_vectorized_.4), dimensions={1,0}
  jit_advect_1d_vectorized_.5 = f32[128,128]{1,0} call(transpose.6, constant.95, constant.94, constant.93, constant.96), to_apply=advect_1d_vectorized.3
