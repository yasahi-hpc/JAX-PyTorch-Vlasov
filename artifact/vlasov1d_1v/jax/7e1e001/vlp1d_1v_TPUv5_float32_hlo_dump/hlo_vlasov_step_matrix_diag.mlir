HloModule jit__lambda, entry_computation_layout={(f32[128,128]{1,0})->(f32[128,128]{0,1}, f32[128]{0}, f32[128]{0})}
...
_roll_dynamic.3 {
  ...
  transpose.2 = f32[128,128]{0,1} transpose(Arg_0.6), dimensions={1,0}
  transpose.3 = f32[128,128]{0,1} transpose(Arg_0.6), dimensions={1,0}
  ...
  broadcast_in_dim.1 = s32[128,1]{1,0} reshape(select_n.5)
  ROOT gather.1 = f32[128,128]{1,0} gather(concatenate.1, broadcast_in_dim.1), offset_dims={1}, collapsed_slice_dims={}, start_index_map={1}, operand_batching_dims={0}, start_indices_batching_dims={0}, index_vector_dim=1, slice_sizes={1,128}, indices_are_sorted=true
}

advect_1d_matrix_diag.4 {
  Arg_0.7 = f32[128,128]{1,0} parameter(0)
  Arg_1.7 = f32[128]{0} parameter(1)
  Arg_2.3 = f32[] parameter(2)
  mul.36 = f32[128]{0} broadcast(Arg_2.3), dimensions={}
  mul.37 = f32[128]{0} multiply(Arg_1.7, mul.36)
  Arg_3.1 = f32[] parameter(3)
  div.33 = f32[128]{0} broadcast(Arg_3.1), dimensions={}
  ...
  vmap_jit__roll_dynamic__.6 = f32[128,128]{1,0} call(Arg_0.7, add.46), to_apply=_roll_dynamic.3
  ...
  div.32 = f32[128]{0} broadcast(constant.44), dimensions={}
  div.35 = f32[128]{0} divide(sub.20, div.32)
  mul.38 = f32[128]{0} multiply(sub.20, sub.20)
  constant.43 = f32[] constant(24)
  broadcast.19 = f32[128]{0} broadcast(constant.43), dimensions={}
  ...
  broadcast.18 = f32[128]{0} broadcast(constant.42), dimensions={}
  ...
  vmap_jit__roll_dynamic__.7 = f32[128,128]{1,0} call(Arg_0.7, add.48), to_apply=_roll_dynamic.3
  transpose.11 = f32[128,128]{0,1} transpose(vmap_jit__roll_dynamic__.7), dimensions={1,0}
  constant.41 = f32[] constant(2)
  broadcast.17 = f32[128]{0} broadcast(constant.41), dimensions={}
  ...
  broadcast.16 = f32[128]{0} broadcast(constant.40), dimensions={}
  ...
  broadcast.15 = f32[128]{0} broadcast(constant.39), dimensions={}
  ...
  broadcast.12 = f32[128]{0} broadcast(constant.35), dimensions={}
  ...
  vmap_jit__roll_dynamic__.9 = f32[128,128]{1,0} call(Arg_0.7, add.54), to_apply=_roll_dynamic.3
  ...
  broadcast.11 = f32[128]{0} broadcast(constant.34), dimensions={}
  ...
  vmap_jit__roll_dynamic__.10 = f32[128,128]{1,0} call(Arg_0.7, add.57), to_apply=_roll_dynamic.3
  ...
  vmap_jit__roll_dynamic__.11 = f32[128,128]{1,0} call(Arg_0.7, add.60), to_apply=_roll_dynamic.3
  transpose.15 = f32[128,128]{0,1} transpose(vmap_jit__roll_dynamic__.11), dimensions={1,0}
  constant.33 = f32[] constant(30)
  div.31 = f32[128]{0} broadcast(constant.33), dimensions={}
...
fft.6 {
  Arg_0.10 = f32[128]{0} parameter(0)
  ROOT fft.1 = c64[65]{0} fft(Arg_0.10), fft_type=RFFT, fft_length={128}
}

fft_33.7 {
  Arg_0.12 = c64[65]{0} parameter(0)
  ROOT fft.3 = f32[128]{0} fft(Arg_0.12), fft_type=IRFFT, fft_length={128}
}

solve_poisson.8 {
  Arg_0.13 = f32[128,128]{1,0} parameter(0)
  constant.50 = f32[] constant(0)
  reduce_sum.7 = f32[128]{0} reduce(Arg_0.13, constant.50), dimensions={1}, to_apply=region_0.5
  Arg_2.5 = f32[] parameter(2)
  mul.79 = f32[128]{0} broadcast(Arg_2.5), dimensions={}
  mul.80 = f32[128]{0} multiply(reduce_sum.7, mul.79)
  constant.49 = f32[] constant(1)
  sub.36 = f32[128]{0} broadcast(constant.49), dimensions={}
  sub.37 = f32[128]{0} subtract(mul.80, sub.36)
  jit_fft_.3 = c64[65]{0} call(sub.37), to_apply=fft.6
  constant.48 = c64[] constant((-0, -1))
  mul.78 = c64[65]{0} broadcast(constant.48), dimensions={}
  mul.81 = c64[65]{0} multiply(jit_fft_.3, mul.78)
  Arg_1.9 = f32[65]{0} parameter(1)
  convert_element_type.4 = c64[65]{0} convert(Arg_1.9)
  mul.82 = c64[65]{0} multiply(mul.81, convert_element_type.4)
  jit_fft_.4 = f32[128]{0} call(mul.82), to_apply=fft_33.7
  integer_pow.1 = f32[65]{0} multiply(Arg_1.9, Arg_1.9)
  convert_element_type.5 = c64[65]{0} convert(integer_pow.1)
  mul.83 = c64[65]{0} multiply(jit_fft_.3, convert_element_type.5)
  jit_fft_.5 = f32[128]{0} call(mul.83), to_apply=fft_33.7
  ROOT tuple.1 = (f32[128]{0}, f32[128]{0}, f32[128]{0}) tuple(jit_fft_.4, sub.37, jit_fft_.5)
}

_where_45.9 {
  Arg_0.17 = pred[6,128,128]{2,1,0} parameter(0)
  Arg_1.13 = f32[6,128,1]{2,1,0} parameter(1)
  broadcast_in_dim.29 = f32[6,128,1]{2,1,0} broadcast(Arg_1.13), dimensions={0,1,2}
  ...
  broadcast_in_dim.32 = f32[6,128,128]{2,1,0} broadcast(Arg_2.9), dimensions={}
  ROOT select_n.7 = f32[6,128,128]{2,1,0} select(Arg_0.17, broadcast_in_dim.31, broadcast_in_dim.32)
}
...
build_v_diag_weights.10 {
  ...
  ge.2 = s32[6,128,128]{2,1,0} broadcast(constant.67), dimensions={}
  ge.3 = pred[6,128,128]{2,1,0} compare(sub.80, ge.2), direction=GE
  constant.66 = s32[] constant(128)
  lt.10 = s32[6,128,128]{2,1,0} broadcast(constant.66), dimensions={}
  lt.11 = pred[6,128,128]{2,1,0} compare(sub.80, lt.10), direction=LT
  and.3 = pred[6,128,128]{2,1,0} and(ge.3, lt.11)
  Arg_2.10 = f32[128]{0} parameter(2)
  constant.79 = f32[] constant(20)
  div.94 = f32[128]{0} broadcast(constant.79), dimensions={}
  div.95 = f32[128]{0} divide(Arg_2.10, div.94)
  mul.96 = f32[128]{0} multiply(Arg_2.10, Arg_2.10)
  constant.78 = f32[] constant(24)
  broadcast.37 = f32[128]{0} broadcast(constant.78), dimensions={}
  div.96 = f32[128]{0} divide(mul.96, broadcast.37)
  sub.61 = f32[128]{0} subtract(div.95, div.96)
  mul.97 = f32[128]{0} multiply(mul.96, Arg_2.10)
  div.97 = f32[128]{0} divide(mul.97, broadcast.37)
  sub.62 = f32[128]{0} subtract(sub.61, div.97)
  mul.98 = f32[128]{0} multiply(mul.97, Arg_2.10)
  div.98 = f32[128]{0} divide(mul.98, broadcast.37)
  add.79 = f32[128]{0} add(sub.62, div.98)
  mul.99 = f32[128]{0} multiply(mul.98, Arg_2.10)
  constant.77 = f32[] constant(120)
  broadcast.36 = f32[128]{0} broadcast(constant.77), dimensions={}
  ...
  constant.76 = f32[] constant(2)
  broadcast.35 = f32[128]{0} broadcast(constant.76), dimensions={}
  div.100 = f32[128]{0} divide(Arg_2.10, broadcast.35)
  neg.6 = f32[128]{0} negate(div.100)
  mul.100 = f32[128]{0} multiply(mul.96, broadcast.35)
  constant.75 = f32[] constant(3)
  broadcast.34 = f32[128]{0} broadcast(constant.75), dimensions={}
  ...
  constant.74 = f32[] constant(6)
  broadcast.33 = f32[128]{0} broadcast(constant.74), dimensions={}
  ...
  sub.60 = f32[128]{0} broadcast(constant.73), dimensions={}
  div.105 = f32[128]{0} divide(Arg_2.10, broadcast.34)
  sub.66 = f32[128]{0} subtract(sub.60, div.105)
  constant.72 = f32[] constant(5)
  broadcast.32 = f32[128]{0} broadcast(constant.72), dimensions={}
  mul.101 = f32[128]{0} multiply(mul.96, broadcast.32)
  constant.71 = f32[] constant(4)
  broadcast.31 = f32[128]{0} broadcast(constant.71), dimensions={}
  ...
  constant.70 = f32[] constant(12)
  broadcast.30 = f32[128]{0} broadcast(constant.70), dimensions={}
  ...
  add.84 = f32[128]{0} add(Arg_2.10, div.110)
  constant.69 = f32[] constant(7)
  broadcast.29 = f32[128]{0} broadcast(constant.69), dimensions={}
  ...
  div.114 = f32[128]{0} divide(Arg_2.10, broadcast.31)
  ...
  constant.68 = f32[] constant(30)
  div.93 = f32[128]{0} broadcast(constant.68), dimensions={}
  div.119 = f32[128]{0} divide(Arg_2.10, div.93)
  ...
  ROOT jit__where_.3 = f32[6,128,128]{2,1,0} call(and.3, broadcast_in_dim.43, constant.80), to_apply=_where_45.9
}

_roll_dynamic_49.11 {
  Arg_0.20 = f32[128,128]{1,0} parameter(0)
  concatenate.5 = f32[128,256]{1,0} concatenate(Arg_0.20, Arg_0.20), dimensions={1}
...
advect_1d_matrix_diag_35.12 {
  ...
  Arg_1.17 = f32[128]{0} parameter(1)
  Arg_2.11 = f32[] parameter(2)
  mul.112 = f32[128]{0} broadcast(Arg_2.11), dimensions={}
  mul.113 = f32[128]{0} multiply(Arg_1.17, mul.112)
  Arg_3.3 = f32[] parameter(3)
  div.122 = f32[128]{0} broadcast(Arg_3.3), dimensions={}
  ...
  jit_build_v_diag_weights_.1 = f32[6,128,128]{2,1,0} call(Arg_4.3, convert_element_type.7, sub.85), to_apply=build_v_diag_weights.10
  ...
  vmap_jit__roll_dynamic__.18 = f32[128,128]{1,0} call(Arg_0.21, add.118), to_apply=_roll_dynamic_49.11
  ...
  vmap_jit__roll_dynamic__.19 = f32[128,128]{1,0} call(Arg_0.21, add.120), to_apply=_roll_dynamic_49.11
  ...
  vmap_jit__roll_dynamic__.20 = f32[128,128]{1,0} call(Arg_0.21, add.123), to_apply=_roll_dynamic_49.11
  ...
  vmap_jit__roll_dynamic__.21 = f32[128,128]{1,0} call(Arg_0.21, add.126), to_apply=_roll_dynamic_49.11
  ...
  vmap_jit__roll_dynamic__.22 = f32[128,128]{1,0} call(Arg_0.21, add.129), to_apply=_roll_dynamic_49.11
  ...
  vmap_jit__roll_dynamic__.23 = f32[128,128]{1,0} call(Arg_0.21, add.132), to_apply=_roll_dynamic_49.11
...
ENTRY main.13 {
  ...
  constant.91 = f32[128]{0} constant({...})
  constant.94 = f32[] constant(0.025)
  constant.95 = f32[] constant(0.0981747732)
  constant.92 = s32[6]{0} constant({-2, -1, 0, 1, 2, 3})
  jit_advect_1d_matrix_diag_.3 = f32[128,128]{0,1} call(carry_0_.1, constant.91, constant.94, constant.95, constant.92), to_apply=advect_1d_matrix_diag.4
  constant.93 = f32[65]{0} constant({...})
  constant.90 = f32[] constant(0.0787401572)
  jit_solve_poisson_.4 = (f32[128]{0}, f32[128]{0}, f32[128]{0}) call(jit_advect_1d_matrix_diag_.3, constant.93, constant.90), to_apply=solve_poisson.8
  jit_solve_poisson_.5 = f32[128]{0} get-tuple-element(jit_solve_poisson_.4), index=0
  constant.89 = f32[] constant(0.05)
  jit_advect_1d_matrix_diag_.4 = f32[128,128]{1,0} call(jit_advect_1d_matrix_diag_.3, jit_solve_poisson_.5, constant.89, constant.90, constant.92), to_apply=advect_1d_matrix_diag_35.12
  jit_advect_1d_matrix_diag_.5 = f32[128,128]{0,1} call(jit_advect_1d_matrix_diag_.4, constant.91, constant.94, constant.95, constant.92), to_apply=advect_1d_matrix_diag.4
