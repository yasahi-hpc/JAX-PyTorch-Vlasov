...
ENTRY main.17 {
  ...
  mul.101 = f32[1,128]{1,0} broadcast(constant.73), dimensions={0,1}
  ...
  mul.105 = f32[1,128]{1,0} broadcast(constant.72), dimensions={0,1}
  ...
  constant.71 = f32[1,128]{1,0} constant({...})
  mul.109 = f32[1,128]{1,0} broadcast(constant.71), dimensions={0,1}
  ...
  constant.70 = f32[1,128]{1,0} constant({...})
  mul.113 = f32[1,128]{1,0} broadcast(constant.70), dimensions={0,1}
  ...
  constant.69 = f32[1,128]{1,0} constant({...})
  mul.117 = f32[1,128]{1,0} broadcast(constant.69), dimensions={0,1}
  ...
  constant.68 = f32[1,128]{1,0} constant({...})
  mul.121 = f32[1,128]{1,0} broadcast(constant.68), dimensions={0,1}
  ...
  constant.77 = f32[65]{0} constant({...})
  constant.75 = f32[] constant(0.0787401572)
  jit_solve_poisson_.4 = (f32[128]{0}, f32[128]{0}, f32[128]{0}) call(add.65, constant.77, constant.75), to_apply=solve_poisson.14
  ...
  jit__where_.42 = f32[128]{0} call(eq.46, sub.23, constant.76), to_apply=_where.15
  ...
  jit__where_.43 = f32[128]{0} call(eq.47, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.44 = f32[128]{0} call(eq.48, sub.28, constant.76), to_apply=_where.15
  ...
  jit__where_.45 = f32[128]{0} call(eq.49, add.72, constant.76), to_apply=_where.15
  ...
  jit__where_.46 = f32[128]{0} call(eq.50, sub.32, constant.76), to_apply=_where.15
  ...
  jit__where_.47 = f32[128]{0} call(eq.51, add.75, constant.76), to_apply=_where.15
  ...
  jit__pad_.1 = f32[128,134]{1,0} call(add.65, constant.74), to_apply=_pad.16
  ...
  jit__where_.48 = f32[128]{0} call(eq.52, sub.23, constant.76), to_apply=_where.15
  eq.53 = pred[128]{0} compare(convert_element_type.7, broadcast.28), direction=EQ
  jit__where_.49 = f32[128]{0} call(eq.53, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.54 = f32[128]{0} call(eq.58, sub.23, constant.76), to_apply=_where.15
  eq.59 = pred[128]{0} compare(convert_element_type.7, broadcast.23), direction=EQ
  jit__where_.55 = f32[128]{0} call(eq.59, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.60 = f32[128]{0} call(eq.64, sub.23, constant.76), to_apply=_where.15
  eq.65 = pred[128]{0} compare(convert_element_type.7, broadcast.22), direction=EQ
  jit__where_.61 = f32[128]{0} call(eq.65, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.66 = f32[128]{0} call(eq.70, sub.23, constant.76), to_apply=_where.15
  eq.71 = pred[128]{0} compare(convert_element_type.7, broadcast.21), direction=EQ
  jit__where_.67 = f32[128]{0} call(eq.71, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.72 = f32[128]{0} call(eq.76, sub.23, constant.76), to_apply=_where.15
  eq.77 = pred[128]{0} compare(convert_element_type.7, broadcast.20), direction=EQ
  jit__where_.73 = f32[128]{0} call(eq.77, add.68, constant.76), to_apply=_where.15
  ...
  jit__where_.78 = f32[128]{0} call(eq.82, sub.23, constant.76), to_apply=_where.15
  eq.83 = pred[128]{0} compare(convert_element_type.7, broadcast.19), direction=EQ
  jit__where_.79 = f32[128]{0} call(eq.83, add.68, constant.76), to_apply=_where.15
  ...
  mul.164 = f32[1,128]{1,0} broadcast(constant.73), dimensions={0,1}
  ...
  mul.168 = f32[1,128]{1,0} broadcast(constant.72), dimensions={0,1}
  ...
  mul.172 = f32[1,128]{1,0} broadcast(constant.71), dimensions={0,1}
  ...
  mul.176 = f32[1,128]{1,0} broadcast(constant.70), dimensions={0,1}
  ...
  mul.180 = f32[1,128]{1,0} broadcast(constant.69), dimensions={0,1}
  ...
  mul.184 = f32[1,128]{1,0} broadcast(constant.68), dimensions={0,1}
