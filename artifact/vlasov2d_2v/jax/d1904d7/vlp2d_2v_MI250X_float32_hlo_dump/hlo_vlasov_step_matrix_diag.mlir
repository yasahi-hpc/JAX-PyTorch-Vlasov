...
_where_64.9 {
  ...
  broadcast_in_dim.27 = f32[6,32768,1]{2,1,0} broadcast(Arg_1.13), dimensions={0,1,2}
  broadcast_in_dim.28 = f32[6,32768]{1,0} reshape(broadcast_in_dim.27)
  broadcast_in_dim.29 = f32[6,32768,32]{2,1,0} broadcast(broadcast_in_dim.28), dimensions={0,1}
  Arg_2.9 = f32[] parameter(2)
  broadcast_in_dim.30 = f32[6,32768,32]{2,1,0} broadcast(Arg_2.9), dimensions={}
  ROOT select_n.7 = f32[6,32768,32]{2,1,0} select(Arg_0.17, broadcast_in_dim.29, broadcast_in_dim.30)
}

build_v_diag_weights.10 {
  iota.1 = s32[32]{0} iota(), iota_dimension=0
  broadcast_in_dim.39 = s32[1,1,32]{2,1,0} reshape(iota.1)
  sub.74 = s32[1,1,32]{2,1,0} broadcast(broadcast_in_dim.39), dimensions={0,1,2}
  ...
  sub.77 = s32[6,32768,1]{2,1,0} broadcast(broadcast_in_dim.40), dimensions={0,1,2}
  ...
  broadcast_in_dim.31 = f32[1,32768]{1,0} reshape(sub.63)
  ...
  broadcast_in_dim.32 = f32[1,32768]{1,0} reshape(add.81)
  ...
  broadcast_in_dim.33 = f32[1,32768]{1,0} reshape(sub.68)
  ...
  broadcast_in_dim.34 = f32[1,32768]{1,0} reshape(add.85)
  ...
  broadcast_in_dim.35 = f32[1,32768]{1,0} reshape(sub.72)
  ...
  broadcast_in_dim.36 = f32[1,32768]{1,0} reshape(add.88)
  concatenate.3 = f32[6,32768]{1,0} concatenate(broadcast_in_dim.31, broadcast_in_dim.32, broadcast_in_dim.33, broadcast_in_dim.34, broadcast_in_dim.35, broadcast_in_dim.36), dimensions={0}
  broadcast_in_dim.41 = f32[6,32768,1]{2,1,0} reshape(concatenate.3)
  constant.85 = f32[] constant(0)
  ROOT jit__where_.3 = f32[6,32768,32]{2,1,0} call(and.3, broadcast_in_dim.41, constant.85), to_apply=_where_64.9
}
...
ENTRY main.12 {
  ...
  broadcast_in_dim.52 = f32[1,32,1]{2,1,0} broadcast(constant.95), dimensions={0,1,2}
  broadcast_in_dim.53 = f32[32]{0} reshape(broadcast_in_dim.52)
  broadcast_in_dim.54 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.53), dimensions={1}
  reshape.19 = f32[32768]{0} reshape(broadcast_in_dim.54)
  ...
  broadcast_in_dim.55 = f32[1,1,32]{2,1,0} broadcast(constant.86), dimensions={0,1,2}
  ...
  reshape.22 = f32[32768]{0} reshape(broadcast_in_dim.57)
  ...
  reshape.25 = f32[32768]{0} reshape(broadcast_in_dim.61)
  ...
  reshape.28 = f32[32768]{0} reshape(broadcast_in_dim.65)
  ...
  broadcast_in_dim.66 = f32[1,1,32]{2,1,0} broadcast(constant.86), dimensions={0,1,2}
  broadcast_in_dim.67 = f32[32]{0} reshape(broadcast_in_dim.66)
  broadcast_in_dim.68 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.67), dimensions={2}
  reshape.31 = f32[32768]{0} reshape(broadcast_in_dim.68)
  ...
  broadcast_in_dim.69 = f32[1,32,1]{2,1,0} broadcast(constant.95), dimensions={0,1,2}
  ...
  reshape.34 = f32[32768]{0} reshape(broadcast_in_dim.71)
