...
advect_1d_roll_diag.4 {
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.6 = f32[32768,1]{1,0} reshape(sub.23)
  mul.48 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.6), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.7 = f32[32768,1]{1,0} reshape(add.37)
  mul.52 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.7), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.8 = f32[32768,1]{1,0} reshape(sub.28)
  mul.56 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.8), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.9 = f32[32768,1]{1,0} reshape(add.41)
  mul.60 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.9), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.10 = f32[32768,1]{1,0} reshape(sub.32)
  mul.64 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.10), dimensions={0,1}
  ...
  broadcast_in_dim_squeeze_broadcast_in_dim.11 = f32[32768,1]{1,0} reshape(add.44)
  mul.68 = f32[32768,1]{1,0} broadcast(broadcast_in_dim_squeeze_broadcast_in_dim.11), dimensions={0,1}
...
_where_65.9 {
  ...
  broadcast_in_dim.29 = f32[6,32768,1]{2,1,0} broadcast(Arg_1.14), dimensions={0,1,2}
  broadcast_in_dim.30 = f32[6,32768]{1,0} reshape(broadcast_in_dim.29)
  broadcast_in_dim.31 = f32[6,32768,32]{2,1,0} broadcast(broadcast_in_dim.30), dimensions={0,1}
  Arg_2.10 = f32[] parameter(2)
  broadcast_in_dim.32 = f32[6,32768,32]{2,1,0} broadcast(Arg_2.10), dimensions={}
  ROOT select_n.7 = f32[6,32768,32]{2,1,0} select(Arg_0.18, broadcast_in_dim.31, broadcast_in_dim.32)
}

build_v_diag_weights.10 {
  iota.1 = s32[32]{0} iota(), iota_dimension=0
  broadcast_in_dim.41 = s32[1,1,32]{2,1,0} reshape(iota.1)
  sub.74 = s32[1,1,32]{2,1,0} broadcast(broadcast_in_dim.41), dimensions={0,1,2}
  ...
  sub.77 = s32[6,32768,1]{2,1,0} broadcast(broadcast_in_dim.42), dimensions={0,1,2}
  ...
  broadcast_in_dim.33 = f32[1,32768]{1,0} reshape(sub.63)
  ...
  broadcast_in_dim.34 = f32[1,32768]{1,0} reshape(add.81)
  ...
  broadcast_in_dim.35 = f32[1,32768]{1,0} reshape(sub.68)
  ...
  broadcast_in_dim.36 = f32[1,32768]{1,0} reshape(add.85)
  ...
  broadcast_in_dim.37 = f32[1,32768]{1,0} reshape(sub.72)
  ...
  broadcast_in_dim.38 = f32[1,32768]{1,0} reshape(add.88)
  concatenate.3 = f32[6,32768]{1,0} concatenate(broadcast_in_dim.33, broadcast_in_dim.34, broadcast_in_dim.35, broadcast_in_dim.36, broadcast_in_dim.37, broadcast_in_dim.38), dimensions={0}
  broadcast_in_dim.43 = f32[6,32768,1]{2,1,0} reshape(concatenate.3)
  constant.94 = f32[] constant(0)
  ROOT jit__where_.3 = f32[6,32768,32]{2,1,0} call(and.3, broadcast_in_dim.43, constant.94), to_apply=_where_65.9
}
...
closed_call.12 {
  ...
  reshape.18 = f32[32768,32]{1,0} reshape(transpose.5)
  Arg_0.21 = f32[32]{0} parameter(0)
  broadcast_in_dim.56 = f32[1,32,1]{2,1,0} reshape(Arg_0.21)
  broadcast_in_dim.57 = f32[1,32,1]{2,1,0} broadcast(broadcast_in_dim.56), dimensions={0,1,2}
  broadcast_in_dim.58 = f32[32]{0} reshape(broadcast_in_dim.57)
  broadcast_in_dim.59 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.58), dimensions={1}
  reshape.19 = f32[32768]{0} reshape(broadcast_in_dim.59)
  ...
  transpose_transpose.3 = f32[32,32,32,32]{0,2,1,3} transpose(reshape.20), dimensions={3,1,2,0}
  reshape.21 = f32[32768,32]{1,0} reshape(transpose_transpose.3)
  Arg_2.13 = f32[32]{0} parameter(2)
  broadcast_in_dim.60 = f32[1,1,32]{2,1,0} reshape(Arg_2.13)
  broadcast_in_dim.61 = f32[1,1,32]{2,1,0} broadcast(broadcast_in_dim.60), dimensions={0,1,2}
  broadcast_in_dim.62 = f32[32]{0} reshape(broadcast_in_dim.61)
  broadcast_in_dim.63 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.62), dimensions={2}
  reshape.22 = f32[32768]{0} reshape(broadcast_in_dim.63)
  ...
  transpose_transpose.4 = f32[32,32,32,32]{1,2,3,0} transpose(reshape.23), dimensions={0,3,2,1}
  reshape.24 = f32[32768,32]{1,0} reshape(transpose_transpose.4)
  transpose.6 = f32[32,32,32,32]{1,3,2,0} transpose(reshape.23), dimensions={0,3,1,2}
  ...
  jit_solve_poisson_.5 = (f32[32,32]{1,0}, f32[32,32]{1,0}, f32[32,32]{1,0}, f32[32,32]{1,0}) call(transpose.6, Arg_3.7, Arg_4.7, Arg_5.3, constant.96, constant.96), to_apply=solve_poisson.8
  jit_solve_poisson_.6 = f32[32,32]{1,0} get-tuple-element(jit_solve_poisson_.5), index=0
  broadcast_in_dim.64 = f32[32,32,1]{2,1,0} reshape(jit_solve_poisson_.6)
  broadcast_in_dim.65 = f32[32,32,1]{2,1,0} broadcast(broadcast_in_dim.64), dimensions={0,1,2}
  broadcast_in_dim.66 = f32[32,32]{1,0} reshape(broadcast_in_dim.65)
  broadcast_in_dim.67 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.66), dimensions={0,1}
  reshape.25 = f32[32768]{0} reshape(broadcast_in_dim.67)
  ...
  transpose.7 = f32[32,32,32,32]{2,3,1,0} transpose(reshape.26), dimensions={0,1,3,2}
  reshape.27 = f32[32768,32]{1,0} reshape(transpose.7)
  jit_solve_poisson_.7 = f32[32,32]{1,0} get-tuple-element(jit_solve_poisson_.5), index=1
  broadcast_in_dim.68 = f32[32,32,1]{2,1,0} reshape(jit_solve_poisson_.7)
  broadcast_in_dim.69 = f32[32,32,1]{2,1,0} broadcast(broadcast_in_dim.68), dimensions={0,1,2}
  broadcast_in_dim.70 = f32[32,32]{1,0} reshape(broadcast_in_dim.69)
  broadcast_in_dim.71 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.70), dimensions={0,1}
  reshape.28 = f32[32768]{0} reshape(broadcast_in_dim.71)
  ...
  transpose.8 = f32[32,32,32,32]{2,1,3,0} transpose(reshape.29), dimensions={0,2,3,1}
  ...
  reshape.31 = f32[32768]{0} reshape(broadcast_in_dim.75)
  ...
  transpose_transpose.5 = f32[32,32,32,32]{0,2,1,3} transpose(reshape.32), dimensions={3,1,2,0}
  reshape.33 = f32[32768,32]{1,0} reshape(transpose_transpose.5)
  broadcast_in_dim.76 = f32[1,32,1]{2,1,0} reshape(Arg_0.21)
  broadcast_in_dim.77 = f32[1,32,1]{2,1,0} broadcast(broadcast_in_dim.76), dimensions={0,1,2}
  broadcast_in_dim.78 = f32[32]{0} reshape(broadcast_in_dim.77)
  broadcast_in_dim.79 = f32[32,32,32]{2,1,0} broadcast(broadcast_in_dim.78), dimensions={1}
  reshape.34 = f32[32768]{0} reshape(broadcast_in_dim.79)
  ...
  transpose.9 = f32[32,32,32,32]{0,3,2,1} transpose(reshape.35), dimensions={3,0,1,2}
