module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32x32xf64>) -> (tensor<32x32x32x32xf64> {jax.result_info = "result[0]"}, tensor<32x32xf64> {jax.result_info = "result[1]"}, tensor<32x32xf64> {jax.result_info = "result[2]"}) {
    ...
    %13 = call @advect_1d_vectorized(%10, %12, %cst_6, %cst_7, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %22 = call @advect_1d_vectorized_58(%19, %21, %cst_10, %cst_11, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %29 = call @advect_1d_vectorized_58(%26, %28, %cst_12, %cst_13, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %36 = call @advect_1d_vectorized(%33, %35, %cst_14, %cst_15, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %44 = call @advect_1d_vectorized(%41, %43, %cst_16, %cst_17, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf64>, %arg1: tensor<32x1xf64>, %arg2: tensor<1x17xf64>, %arg3: tensor<32x17xf64>, %arg4: tensor<f64>, %arg5: tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %12 = call @fft_47(%11) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    ...
    %23 = call @fft_47(%17) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    %24 = call @fft_47(%22) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
  ...
  func.func private @fft_47(%arg0: tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    return %0 : tensor<32x32xf64>
  }
  func.func private @advect_1d_vectorized_58(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    %0 = stablehlo.iota dim = 0 : tensor<32xf64>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<32768xf64>) -> tensor<32768x1xf64>
    %2 = stablehlo.convert %arg2 : tensor<f64>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f64>) -> tensor<32768x1xf64>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f64>
    %44 = call @_where_59(%24, %43, %cst) : (tensor<32768x32x6xi1>, tensor<32768x32x6xf64>, tensor<f64>) -> tensor<32768x32x6xf64>
  ...
  func.func private @_where_59(%arg0: tensor<32768x32x6xi1>, %arg1: tensor<32768x32x6xf64>, %arg2: tensor<f64>) -> tensor<32768x32x6xf64> {
