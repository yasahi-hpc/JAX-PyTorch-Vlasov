module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<32xf32>, %arg1: tensor<6xi32>, %arg2: tensor<32xf32>, %arg3: tensor<32x1xf32>, %arg4: tensor<1x17xf32>, %arg5: tensor<32x17xf32>, %arg6: tensor<32x32x32x32xf32>, %arg7: tensor<32x32xf32>, %arg8: tensor<32x32xf32>) -> (tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %13 = call @advect_1d_roll_diag(%10, %12, %cst_1, %cst_2, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %22 = call @advect_1d_roll_diag_55(%19, %21, %cst_5, %cst_6, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %29 = call @advect_1d_roll_diag_55(%26, %28, %cst_7, %cst_8, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %36 = call @advect_1d_roll_diag(%33, %35, %cst_9, %cst_10, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %44 = call @advect_1d_roll_diag(%41, %43, %cst_11, %cst_12, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf32>, %arg1: tensor<32x1xf32>, %arg2: tensor<1x17xf32>, %arg3: tensor<32x17xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %12 = call @fft_44(%11) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    ...
    %23 = call @fft_44(%17) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    %24 = call @fft_44(%22) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
  ...
  func.func private @fft_44(%arg0: tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    return %0 : tensor<32x32xf32>
  }
  func.func private @advect_1d_roll_diag_55(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %2 = stablehlo.multiply %arg1, %1 : tensor<32768xf32>
    %3 = stablehlo.convert %arg3 : tensor<f32>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<32768xi32>, %arg2: tensor<32768xf32>) -> tensor<6x32768x32xf32> {
    ...
    %120 = call @_where_65(%118, %119, %cst_34) : (tensor<6x32768x32xi1>, tensor<6x32768x1xf32>, tensor<f32>) -> tensor<6x32768x32xf32>
    return %120 : tensor<6x32768x32xf32>
  }
  func.func private @_where_65(%arg0: tensor<6x32768x32xi1>, %arg1: tensor<6x32768x1xf32>, %arg2: tensor<f32>) -> tensor<6x32768x32xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
