module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<32xf32>, %arg1: tensor<6xi32>, %arg2: tensor<32xf32>, %arg3: tensor<32x1xf32>, %arg4: tensor<1x17xf32>, %arg5: tensor<32x17xf32>, %arg6: tensor<32x32x32x32xf32>, %arg7: tensor<32x32xf32>, %arg8: tensor<32x32xf32>) -> (tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %cst_2 = stablehlo.constant dense<0.392699093> : tensor<f32>
    %13 = call @advect_1d_vectorized(%10, %12, %cst_1, %cst_2, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %cst_3 = stablehlo.constant dense<0.322580636> : tensor<f32>
    %cst_4 = stablehlo.constant dense<0.322580636> : tensor<f32>
    %16:4 = call @solve_poisson(%15, %arg3, %arg4, %arg5, %cst_3, %cst_4) : (tensor<32x32x32x32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<f32>, tensor<f32>) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>)
    ...
    %cst_5 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %cst_6 = stablehlo.constant dense<0.322580636> : tensor<f32>
    %22 = call @advect_1d_vectorized_57(%19, %21, %cst_5, %cst_6, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %29 = call @advect_1d_vectorized_57(%26, %28, %cst_7, %cst_8, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %cst_9 = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_10 = stablehlo.constant dense<0.392699093> : tensor<f32>
    %36 = call @advect_1d_vectorized(%33, %35, %cst_9, %cst_10, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %cst_11 = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_12 = stablehlo.constant dense<0.392699093> : tensor<f32>
    %44 = call @advect_1d_vectorized(%41, %43, %cst_11, %cst_12, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf32>, %arg1: tensor<32x1xf32>, %arg2: tensor<1x17xf32>, %arg3: tensor<32x17xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %12 = call @fft_46(%11) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    ...
    %23 = call @fft_46(%17) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    %24 = call @fft_46(%22) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
  ...
  func.func private @fft_46(%arg0: tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    return %0 : tensor<32x32xf32>
  }
  func.func private @advect_1d_vectorized_57(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    %0 = stablehlo.iota dim = 0 : tensor<32xf32>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<32768xf32>) -> tensor<32768x1xf32>
    %2 = stablehlo.convert %arg2 : tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<32768x1xf32>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %42 = call @_where_58(%24, %41, %cst) : (tensor<32768x32x6xi1>, tensor<32768x32x6xf32>, tensor<f32>) -> tensor<32768x32x6xf32>
  ...
  func.func private @_where_58(%arg0: tensor<32768x32x6xi1>, %arg1: tensor<32768x32x6xf32>, %arg2: tensor<f32>) -> tensor<32768x32x6xf32> {
