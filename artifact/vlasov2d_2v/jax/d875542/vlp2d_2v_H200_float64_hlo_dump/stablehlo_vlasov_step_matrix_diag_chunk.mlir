module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32xf64>, %arg1: tensor<32x32xf64>, %arg2: tensor<32x32x32x32xf64>, %arg3: tensor<32x32xf64>, %arg4: tensor<f64>, %arg5: tensor<i64>) -> (tensor<32xf64> {jax.result_info = "result[0][0]"}, tensor<32xf64> {jax.result_info = "result[0][1]"}, tensor<32xf64> {jax.result_info = "result[0][2]"}, tensor<32xf64> {jax.result_info = "result[0][3]"}, tensor<32x1xf64> {jax.result_info = "result[0][4]"}, tensor<1x17xf64> {jax.result_info = "result[0][5]"}, tensor<32x17xf64> {jax.result_info = "result[0][6]"}, tensor<6xi32> {jax.result_info = "result[0][7]"}, tensor<32x32xf64> {jax.result_info = "result[1][0]"}, tensor<32x32xf64> {jax.result_info = "result[1][1]"}, tensor<32x32x32x32xf64> {jax.result_info = "result[2][0]"}, tensor<32x32xf64> {jax.result_info = "result[2][1]"}, tensor<f64> {jax.result_info = "result[3]"}, tensor<i64> {jax.result_info = "result[4]"}) {
    ...
    %0:10 = stablehlo.while(%iterArg = %cst, %iterArg_9 = %c, %iterArg_10 = %cst_0, %iterArg_11 = %cst_1, %iterArg_12 = %cst_2, %iterArg_13 = %cst_3, %iterArg_14 = %c_6, %iterArg_15 = %arg2, %iterArg_16 = %arg0, %iterArg_17 = %arg1) : tensor<32xf64>, tensor<6xi32>, tensor<32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<i64>, tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>
    cond {
      %c_18 = stablehlo.constant dense<128> : tensor<i64>
      %3 = stablehlo.compare  LT, %iterArg_14, %c_18,  SIGNED : (tensor<i64>, tensor<i64>) -> tensor<i1>
      stablehlo.return %3 : tensor<i1>
    } do {
      %3:3 = func.call @closed_call(%iterArg, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %iterArg_13, %iterArg_15, %iterArg_16, %iterArg_17) : (tensor<32xf64>, tensor<6xi32>, tensor<32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) -> (tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>)
      %c_18 = stablehlo.constant dense<1> : tensor<i64>
      %4 = stablehlo.add %iterArg_14, %c_18 : tensor<i64>
      stablehlo.return %iterArg, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %iterArg_13, %4, %3#0, %3#1, %3#2 : tensor<32xf64>, tensor<6xi32>, tensor<32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<i64>, tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>
    }
    %cst_7 = stablehlo.constant dense<6.400000e+00> : tensor<f64>
    %1 = stablehlo.add %arg4, %cst_7 : tensor<f64>
    %c_8 = stablehlo.constant dense<128> : tensor<i64>
    %2 = stablehlo.add %arg5, %c_8 : tensor<i64>
    return %cst_4, %cst_5, %cst, %cst_0, %cst_1, %cst_2, %cst_3, %c, %0#8, %0#9, %0#7, %arg3, %1, %2 : tensor<32xf64>, tensor<32xf64>, tensor<32xf64>, tensor<32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<6xi32>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<f64>, tensor<i64>
  }
  func.func private @closed_call(%arg0: tensor<32xf64>, %arg1: tensor<6xi32>, %arg2: tensor<32xf64>, %arg3: tensor<32x1xf64>, %arg4: tensor<1x17xf64>, %arg5: tensor<32x17xf64>, %arg6: tensor<32x32x32x32xf64>, %arg7: tensor<32x32xf64>, %arg8: tensor<32x32xf64>) -> (tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<32xf64>) -> tensor<1x32x1xf64>
    %1 = stablehlo.transpose %arg6, dims = [1, 2, 3, 0] : (tensor<32x32x32x32xf64>) -> tensor<32x32x32x32xf64>
    ...
    %cst_0 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %5 = call @advect_1d_roll_diag(%2, %4, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %8 = stablehlo.broadcast_in_dim %arg2, dims = [2] : (tensor<32xf64>) -> tensor<1x1x32xf64>
    ...
    %cst_2 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %13 = call @advect_1d_roll_diag(%10, %12, %cst_1, %cst_2, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_3 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %cst_4 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %16:4 = call @solve_poisson(%15, %arg3, %arg4, %arg5, %cst_3, %cst_4) : (tensor<32x32x32x32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<f64>, tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>)
    ...
    %cst_5 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %cst_6 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %22 = call @advect_1d_roll_diag_55(%19, %21, %cst_5, %cst_6, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_8 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %29 = call @advect_1d_roll_diag_55(%26, %28, %cst_7, %cst_8, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    %30 = stablehlo.reshape %29 : (tensor<32768x32xf64>) -> tensor<32x32x32x32xf64>
    %31 = stablehlo.broadcast_in_dim %arg2, dims = [2] : (tensor<32xf64>) -> tensor<1x1x32xf64>
    ...
    %cst_9 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_10 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %36 = call @advect_1d_roll_diag(%33, %35, %cst_9, %cst_10, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %39 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<32xf64>) -> tensor<1x32x1xf64>
    ...
    %cst_11 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_12 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %44 = call @advect_1d_roll_diag(%41, %43, %cst_11, %cst_12, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
  ...
  func.func private @advect_1d_roll_diag(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    ...
    %19 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %22 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %25 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %28 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %31 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %32 = stablehlo.multiply %31, %10 : tensor<32768xf64>
    %cst_7 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %33 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %36 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %39 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %42 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %55 = stablehlo.multiply %54, %11 : tensor<32768xf64>
    %cst_16 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %56 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %59 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %62 = stablehlo.broadcast_in_dim %cst_18, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %65 = stablehlo.broadcast_in_dim %cst_19, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %66 = stablehlo.multiply %65, %10 : tensor<32768xf64>
    %cst_20 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %67 = stablehlo.broadcast_in_dim %cst_20, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %70 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %71 = stablehlo.multiply %70, %11 : tensor<32768xf64>
    %cst_22 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %72 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %75 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %78 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %81 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %84 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %87 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %88 = stablehlo.multiply %87, %11 : tensor<32768xf64>
    %cst_28 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %89 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %92 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %95 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %98 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %99 = stablehlo.divide %7, %98 : tensor<32768xf64>
    %cst_32 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %100 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %103 = stablehlo.broadcast_in_dim %cst_33, dims = [] : (tensor<f64>) -> tensor<32768xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf64>, %arg1: tensor<32x1xf64>, %arg2: tensor<1x17xf64>, %arg3: tensor<32x17xf64>, %arg4: tensor<f64>, %arg5: tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %12 = call @fft_44(%11) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    ...
    %23 = call @fft_44(%17) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    %24 = call @fft_44(%22) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
  ...
  func.func private @fft_44(%arg0: tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    return %0 : tensor<32x32xf64>
  }
  func.func private @advect_1d_roll_diag_55(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %2 = stablehlo.multiply %arg1, %1 : tensor<32768xf64>
    %3 = stablehlo.convert %arg3 : tensor<f64>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<32768xi32>, %arg2: tensor<32768xf64>) -> tensor<6x32768x32xf64> {
    ...
    %cst_1 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %9 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %10 = stablehlo.divide %1, %9 : tensor<32768xf64>
    %11 = stablehlo.subtract %8, %10 : tensor<32768xf64>
    %cst_2 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %12 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %15 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %18 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %19 = stablehlo.divide %arg2, %18 : tensor<32768xf64>
    %20 = stablehlo.negate %19 : tensor<32768xf64>
    %cst_5 = stablehlo.constant dense<2.000000e+00> : tensor<f64>
    %21 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %22 = stablehlo.multiply %21, %0 : tensor<32768xf64>
    %cst_6 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %23 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %26 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %29 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %32 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %44 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %45 = stablehlo.multiply %44, %1 : tensor<32768xf64>
    %cst_15 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %46 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %49 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %55 = stablehlo.broadcast_in_dim %cst_18, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %56 = stablehlo.multiply %55, %0 : tensor<32768xf64>
    %cst_19 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %57 = stablehlo.broadcast_in_dim %cst_19, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %60 = stablehlo.broadcast_in_dim %cst_20, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %61 = stablehlo.multiply %60, %1 : tensor<32768xf64>
    %cst_21 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %62 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %65 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %68 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %71 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %74 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %77 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %78 = stablehlo.multiply %77, %1 : tensor<32768xf64>
    %cst_27 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %79 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %80 = stablehlo.divide %78, %79 : tensor<32768xf64>
    %81 = stablehlo.add %76, %80 : tensor<32768xf64>
    %cst_28 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %82 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %83 = stablehlo.divide %2, %82 : tensor<32768xf64>
    %84 = stablehlo.add %81, %83 : tensor<32768xf64>
    %cst_29 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %85 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %88 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %89 = stablehlo.divide %arg2, %88 : tensor<32768xf64>
    %cst_31 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %90 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %93 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    ...
    %c_33 = stablehlo.constant dense<32> : tensor<i64>
    %117 = stablehlo.broadcast_in_dim %c_33, dims = [] : (tensor<i64>) -> tensor<6x32768x32xi64>
    ...
    %121 = call @_where_66(%119, %120, %cst_34) : (tensor<6x32768x32xi1>, tensor<6x32768x1xf64>, tensor<f64>) -> tensor<6x32768x32xf64>
    return %121 : tensor<6x32768x32xf64>
  }
  func.func private @_where_66(%arg0: tensor<6x32768x32xi1>, %arg1: tensor<6x32768x1xf64>, %arg2: tensor<f64>) -> tensor<6x32768x32xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
