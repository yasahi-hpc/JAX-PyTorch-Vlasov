module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @closed_call(%arg0: tensor<32xf64>, %arg1: tensor<6xi32>, %arg2: tensor<32xf64>, %arg3: tensor<32x1xf64>, %arg4: tensor<1x17xf64>, %arg5: tensor<32x17xf64>, %arg6: tensor<32x32x32x32xf64>, %arg7: tensor<32x32xf64>, %arg8: tensor<32x32xf64>) -> (tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %5 = call @advect_1d_vectorized(%2, %4, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %13 = call @advect_1d_vectorized(%10, %12, %cst_1, %cst_2, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %22 = call @advect_1d_vectorized_59(%19, %21, %cst_5, %cst_6, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %29 = call @advect_1d_vectorized_59(%26, %28, %cst_7, %cst_8, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %36 = call @advect_1d_vectorized(%33, %35, %cst_9, %cst_10, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %44 = call @advect_1d_vectorized(%41, %43, %cst_11, %cst_12, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
  ...
  func.func private @advect_1d_vectorized(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    ...
    %48 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %51 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %62 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %65 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %68 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %71 = stablehlo.broadcast_in_dim %cst_12, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %83 = stablehlo.broadcast_in_dim %cst_17, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %84 = stablehlo.multiply %83, %40 : tensor<32768x32xf64>
    %cst_18 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %85 = stablehlo.broadcast_in_dim %cst_18, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %88 = stablehlo.broadcast_in_dim %cst_19, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %91 = stablehlo.broadcast_in_dim %cst_20, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %94 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %95 = stablehlo.multiply %94, %39 : tensor<32768x32xf64>
    %cst_22 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %96 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %99 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %100 = stablehlo.multiply %99, %40 : tensor<32768x32xf64>
    %cst_24 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %101 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %104 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %107 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %110 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %113 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %116 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %117 = stablehlo.multiply %116, %40 : tensor<32768x32xf64>
    %cst_30 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %118 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %121 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %124 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %127 = stablehlo.broadcast_in_dim %cst_33, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %128 = stablehlo.divide %13, %127 : tensor<32768x32xf64>
    %cst_34 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %129 = stablehlo.broadcast_in_dim %cst_34, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %132 = stablehlo.broadcast_in_dim %cst_35, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf64>, %arg1: tensor<32x1xf64>, %arg2: tensor<1x17xf64>, %arg3: tensor<32x17xf64>, %arg4: tensor<f64>, %arg5: tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %12 = call @fft_48(%11) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    ...
    %23 = call @fft_48(%17) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    %24 = call @fft_48(%22) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
  ...
  func.func private @fft_48(%arg0: tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    return %0 : tensor<32x32xf64>
  }
  func.func private @advect_1d_vectorized_59(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    %0 = stablehlo.iota dim = 0 : tensor<32xf64>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<32768xf64>) -> tensor<32768x1xf64>
    %2 = stablehlo.convert %arg2 : tensor<f64>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f64>) -> tensor<32768x1xf64>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f64>
    %44 = call @_where_60(%24, %43, %cst) : (tensor<32768x32x6xi1>, tensor<32768x32x6xf64>, tensor<f64>) -> tensor<32768x32x6xf64>
    ...
    %54 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %55 = stablehlo.divide %46, %54 : tensor<32768x32xf64>
    %56 = stablehlo.subtract %53, %55 : tensor<32768x32xf64>
    %cst_9 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %57 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %60 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %63 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %66 = stablehlo.broadcast_in_dim %cst_12, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %67 = stablehlo.multiply %66, %45 : tensor<32768x32xf64>
    %cst_13 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %68 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %71 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %74 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %77 = stablehlo.broadcast_in_dim %cst_16, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %89 = stablehlo.broadcast_in_dim %cst_21, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %90 = stablehlo.multiply %89, %46 : tensor<32768x32xf64>
    %cst_22 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %91 = stablehlo.broadcast_in_dim %cst_22, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %94 = stablehlo.broadcast_in_dim %cst_23, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %95 = stablehlo.divide %47, %94 : tensor<32768x32xf64>
    %96 = stablehlo.add %93, %95 : tensor<32768x32xf64>
    %cst_24 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %97 = stablehlo.broadcast_in_dim %cst_24, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %100 = stablehlo.broadcast_in_dim %cst_25, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %101 = stablehlo.multiply %100, %45 : tensor<32768x32xf64>
    %cst_26 = stablehlo.constant dense<3.000000e+00> : tensor<f64>
    %102 = stablehlo.broadcast_in_dim %cst_26, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %105 = stablehlo.broadcast_in_dim %cst_27, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %106 = stablehlo.multiply %105, %46 : tensor<32768x32xf64>
    %cst_28 = stablehlo.constant dense<1.200000e+01> : tensor<f64>
    %107 = stablehlo.broadcast_in_dim %cst_28, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %110 = stablehlo.broadcast_in_dim %cst_29, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %113 = stablehlo.broadcast_in_dim %cst_30, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %116 = stablehlo.broadcast_in_dim %cst_31, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %117 = stablehlo.divide %13, %116 : tensor<32768x32xf64>
    %118 = stablehlo.negate %117 : tensor<32768x32xf64>
    %cst_32 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %119 = stablehlo.broadcast_in_dim %cst_32, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %122 = stablehlo.broadcast_in_dim %cst_33, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %123 = stablehlo.multiply %122, %46 : tensor<32768x32xf64>
    %cst_34 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %124 = stablehlo.broadcast_in_dim %cst_34, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %127 = stablehlo.broadcast_in_dim %cst_35, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %130 = stablehlo.broadcast_in_dim %cst_36, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %133 = stablehlo.broadcast_in_dim %cst_37, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    %134 = stablehlo.divide %13, %133 : tensor<32768x32xf64>
    %cst_38 = stablehlo.constant dense<2.400000e+01> : tensor<f64>
    %135 = stablehlo.broadcast_in_dim %cst_38, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
    ...
    %138 = stablehlo.broadcast_in_dim %cst_39, dims = [] : (tensor<f64>) -> tensor<32768x32xf64>
  ...
  func.func private @_where_60(%arg0: tensor<32768x32x6xi1>, %arg1: tensor<32768x32x6xf64>, %arg2: tensor<f64>) -> tensor<32768x32x6xf64> {
