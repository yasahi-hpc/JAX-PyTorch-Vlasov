module @jit__lambda attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32x32xf64>) -> (tensor<32x32x32x32xf64> {jax.result_info = "result[0]"}, tensor<32x32xf64> {jax.result_info = "result[1]"}, tensor<32x32xf64> {jax.result_info = "result[2]"}) {
    ...
    %cst_7 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %13 = call @advect_1d_roll_diag(%10, %12, %cst_6, %cst_7, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_9 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %16:4 = call @solve_poisson(%15, %cst_1, %cst_2, %cst_3, %cst_8, %cst_9) : (tensor<32x32x32x32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<f64>, tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>)
    ...
    %cst_10 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %cst_11 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %22 = call @advect_1d_roll_diag_54(%19, %21, %cst_10, %cst_11, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_12 = stablehlo.constant dense<5.000000e-02> : tensor<f64>
    %cst_13 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %29 = call @advect_1d_roll_diag_54(%26, %28, %cst_12, %cst_13, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_14 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_15 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %36 = call @advect_1d_roll_diag(%33, %35, %cst_14, %cst_15, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_16 = stablehlo.constant dense<2.500000e-02> : tensor<f64>
    %cst_17 = stablehlo.constant dense<0.39269908169872414> : tensor<f64>
    %44 = call @advect_1d_roll_diag(%41, %43, %cst_16, %cst_17, %c) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf64>, %arg1: tensor<32x1xf64>, %arg2: tensor<1x17xf64>, %arg3: tensor<32x17xf64>, %arg4: tensor<f64>, %arg5: tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %12 = call @fft_43(%11) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    ...
    %23 = call @fft_43(%17) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    %24 = call @fft_43(%22) : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
  ...
  func.func private @fft_43(%arg0: tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f64>>) -> tensor<32x32xf64>
    return %0 : tensor<32x32xf64>
  }
  func.func private @advect_1d_roll_diag_54(%arg0: tensor<32768x32xf64>, %arg1: tensor<32768xf64>, %arg2: tensor<f64>, %arg3: tensor<f64>, %arg4: tensor<6xi32>) -> tensor<32768x32xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f64>) -> tensor<32768xf64>
    %2 = stablehlo.multiply %arg1, %1 : tensor<32768xf64>
    %3 = stablehlo.convert %arg3 : tensor<f64>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<32768xi32>, %arg2: tensor<32768xf64>) -> tensor<6x32768x32xf64> {
    ...
    %121 = call @_where_65(%119, %120, %cst_34) : (tensor<6x32768x32xi1>, tensor<6x32768x1xf64>, tensor<f64>) -> tensor<6x32768x32xf64>
    return %121 : tensor<6x32768x32xf64>
  }
  func.func private @_where_65(%arg0: tensor<6x32768x32xi1>, %arg1: tensor<6x32768x1xf64>, %arg2: tensor<f64>) -> tensor<6x32768x32xf64> {
    %0 = stablehlo.convert %arg2 : tensor<f64>
