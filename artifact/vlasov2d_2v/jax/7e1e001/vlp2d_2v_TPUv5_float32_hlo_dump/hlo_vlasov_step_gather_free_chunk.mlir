...
closed_call.24 {
  ...
  reshape.24 = f32[1,1,32,1]{3,2,1,0} reshape(sub.60)
  mul.246 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.24), dimensions={0,1,2,3}
  ...
  reshape.25 = f32[1,1,32,1]{3,2,1,0} reshape(add.144)
  mul.250 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.25), dimensions={0,1,2,3}
  ...
  reshape.26 = f32[1,1,32,1]{3,2,1,0} reshape(sub.65)
  mul.254 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.26), dimensions={0,1,2,3}
  ...
  reshape.27 = f32[1,1,32,1]{3,2,1,0} reshape(add.148)
  mul.258 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.27), dimensions={0,1,2,3}
  ...
  reshape.28 = f32[1,1,32,1]{3,2,1,0} reshape(sub.69)
  mul.262 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.28), dimensions={0,1,2,3}
  ...
  reshape.29 = f32[1,1,32,1]{3,2,1,0} reshape(add.151)
  mul.266 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.29), dimensions={0,1,2,3}
  ...
  reshape.30 = f32[1,1,1,32]{3,2,1,0} reshape(sub.73)
  mul.270 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.30), dimensions={0,1,2,3}
  ...
  reshape.31 = f32[1,1,1,32]{3,2,1,0} reshape(add.154)
  mul.274 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.31), dimensions={0,1,2,3}
  ...
  reshape.32 = f32[1,1,1,32]{3,2,1,0} reshape(sub.78)
  mul.278 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.32), dimensions={0,1,2,3}
  ...
  reshape.33 = f32[1,1,1,32]{3,2,1,0} reshape(add.158)
  mul.282 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.33), dimensions={0,1,2,3}
  ...
  reshape.34 = f32[1,1,1,32]{3,2,1,0} reshape(sub.82)
  mul.286 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.34), dimensions={0,1,2,3}
  ...
  reshape.35 = f32[1,1,1,32]{3,2,1,0} reshape(add.161)
  mul.290 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.35), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.23 = f32[32,32,1,1]{3,2,1,0} reshape(add.237)
  mul.344 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.23), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.16 = f32[32,32,1,1]{3,2,1,0} reshape(add.186)
  mul.305 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.16), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.17 = f32[32,32,1,1]{3,2,1,0} reshape(add.191)
  mul.309 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.17), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.18 = f32[32,32,1,1]{3,2,1,0} reshape(add.196)
  mul.313 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.18), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.19 = f32[32,32,1,1]{3,2,1,0} reshape(add.201)
  mul.317 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.19), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.20 = f32[32,32,1,1]{3,2,1,0} reshape(add.206)
  mul.321 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.20), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.21 = f32[32,32,1,1]{3,2,1,0} reshape(add.211)
  mul.325 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.21), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.22 = f32[32,32,1,1]{3,2,1,0} reshape(add.216)
  mul.329 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.22), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.24 = f32[32,32,1,1]{3,2,1,0} reshape(add.242)
  mul.348 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.24), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.25 = f32[32,32,1,1]{3,2,1,0} reshape(add.247)
  mul.352 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.25), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.26 = f32[32,32,1,1]{3,2,1,0} reshape(add.252)
  mul.356 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.26), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.27 = f32[32,32,1,1]{3,2,1,0} reshape(add.257)
  mul.360 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.27), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.28 = f32[32,32,1,1]{3,2,1,0} reshape(add.262)
  mul.364 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.28), dimensions={0,1,2,3}
  ...
  broadcast_in_dim.29 = f32[32,32,1,1]{3,2,1,0} reshape(add.267)
  mul.368 = f32[32,32,1,1]{3,2,1,0} broadcast(broadcast_in_dim.29), dimensions={0,1,2,3}
  ...
  reshape.36 = f32[1,1,1,32]{3,2,1,0} reshape(sub.73)
  mul.372 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.36), dimensions={0,1,2,3}
  ...
  reshape.37 = f32[1,1,1,32]{3,2,1,0} reshape(add.154)
  mul.376 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.37), dimensions={0,1,2,3}
  ...
  reshape.38 = f32[1,1,1,32]{3,2,1,0} reshape(sub.78)
  mul.380 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.38), dimensions={0,1,2,3}
  ...
  reshape.39 = f32[1,1,1,32]{3,2,1,0} reshape(add.158)
  mul.384 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.39), dimensions={0,1,2,3}
  ...
  reshape.40 = f32[1,1,1,32]{3,2,1,0} reshape(sub.82)
  mul.388 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.40), dimensions={0,1,2,3}
  ...
  reshape.41 = f32[1,1,1,32]{3,2,1,0} reshape(add.161)
  mul.392 = f32[1,1,1,32]{3,2,1,0} broadcast(reshape.41), dimensions={0,1,2,3}
  ...
  reshape.42 = f32[1,1,32,1]{3,2,1,0} reshape(sub.60)
  mul.396 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.42), dimensions={0,1,2,3}
  ...
  reshape.43 = f32[1,1,32,1]{3,2,1,0} reshape(add.144)
  mul.400 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.43), dimensions={0,1,2,3}
  ...
  reshape.44 = f32[1,1,32,1]{3,2,1,0} reshape(sub.65)
  mul.404 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.44), dimensions={0,1,2,3}
  ...
  reshape.45 = f32[1,1,32,1]{3,2,1,0} reshape(add.148)
  mul.408 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.45), dimensions={0,1,2,3}
  ...
  reshape.46 = f32[1,1,32,1]{3,2,1,0} reshape(sub.69)
  mul.412 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.46), dimensions={0,1,2,3}
  ...
  reshape.47 = f32[1,1,32,1]{3,2,1,0} reshape(add.151)
  mul.416 = f32[1,1,32,1]{3,2,1,0} broadcast(reshape.47), dimensions={0,1,2,3}
