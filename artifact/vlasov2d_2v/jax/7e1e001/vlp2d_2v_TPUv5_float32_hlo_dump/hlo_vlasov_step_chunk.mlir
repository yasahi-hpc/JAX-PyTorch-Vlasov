...
closed_call.11 {
  ...
  jit_solve_poisson_.5 = (f32[32,32]{1,0}, f32[32,32]{1,0}, f32[32,32]{1,0}, f32[32,32]{1,0}) call(transpose.10, Arg_3.7, Arg_4.7, Arg_5.3, constant.106, constant.106), to_apply=solve_poisson.7
