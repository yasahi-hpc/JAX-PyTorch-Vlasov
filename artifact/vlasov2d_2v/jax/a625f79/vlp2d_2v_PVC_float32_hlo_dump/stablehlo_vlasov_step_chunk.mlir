module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32xf32>, %arg1: tensor<32x32xf32>, %arg2: tensor<32x32x32x32xf32>, %arg3: tensor<32x32xf32>, %arg4: tensor<f32>, %arg5: tensor<i32>) -> (tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 3>]"}, tensor<32x1xf32> {jax.result_info = "[<flat index 0>][<flat index 4>]"}, tensor<1x17xf32> {jax.result_info = "[<flat index 0>][<flat index 5>]"}, tensor<32x17xf32> {jax.result_info = "[<flat index 0>][<flat index 6>]"}, tensor<6xi32> {jax.result_info = "[<flat index 0>][<flat index 7>]"}, tensor<32x32xf32> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<32x32xf32> {jax.result_info = "[<flat index 1>][<flat index 1>]"}, tensor<32x32x32x32xf32> {jax.result_info = "[<flat index 2>][<flat index 0>]"}, tensor<32x32xf32> {jax.result_info = "[<flat index 2>][<flat index 1>]"}, tensor<f32> {jax.result_info = "[<flat index 3>]"}, tensor<i32> {jax.result_info = "[<flat index 4>]"}) {
    ...
    %0:10 = stablehlo.while(%iterArg = %cst, %iterArg_9 = %c, %iterArg_10 = %cst_0, %iterArg_11 = %cst_1, %iterArg_12 = %cst_2, %iterArg_13 = %cst_3, %iterArg_14 = %c_6, %iterArg_15 = %arg2, %iterArg_16 = %arg0, %iterArg_17 = %arg1) : tensor<32xf32>, tensor<6xi32>, tensor<32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<i32>, tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>
     cond {
      %c_18 = stablehlo.constant dense<128> : tensor<i32>
      %3 = stablehlo.compare  LT, %iterArg_14, %c_18,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %3 : tensor<i1>
    } do {
      %3:3 = func.call @None(%iterArg, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %iterArg_13, %iterArg_15, %iterArg_16, %iterArg_17) : (tensor<32xf32>, tensor<6xi32>, tensor<32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) -> (tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>)
      %c_18 = stablehlo.constant dense<1> : tensor<i32>
      %4 = stablehlo.add %iterArg_14, %c_18 : tensor<i32>
      stablehlo.return %iterArg, %iterArg_9, %iterArg_10, %iterArg_11, %iterArg_12, %iterArg_13, %4, %3#0, %3#1, %3#2 : tensor<32xf32>, tensor<6xi32>, tensor<32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<i32>, tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>
    }
    %cst_7 = stablehlo.constant dense<6.400000e+00> : tensor<f32>
    %1 = stablehlo.add %arg4, %cst_7 : tensor<f32>
    %c_8 = stablehlo.constant dense<128> : tensor<i32>
    %2 = stablehlo.add %arg5, %c_8 : tensor<i32>
    return %cst_4, %cst_5, %cst, %cst_0, %cst_1, %cst_2, %cst_3, %c, %0#8, %0#9, %0#7, %arg3, %1, %2 : tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<6xi32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<f32>, tensor<i32>
  }
  func.func private @None(%arg0: tensor<32xf32>, %arg1: tensor<6xi32>, %arg2: tensor<32xf32>, %arg3: tensor<32x1xf32>, %arg4: tensor<1x17xf32>, %arg5: tensor<32x17xf32>, %arg6: tensor<32x32x32x32xf32>, %arg7: tensor<32x32xf32>, %arg8: tensor<32x32xf32>) -> (tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<32xf32>) -> tensor<1x32x1xf32>
    %1 = stablehlo.transpose %arg6, dims = [1, 2, 3, 0] : (tensor<32x32x32x32xf32>) -> tensor<32x32x32x32xf32>
    ...
    %cst = stablehlo.constant dense<2.500000e-02> : tensor<f32>
    %cst_0 = stablehlo.constant dense<0.392699093> : tensor<f32>
    %5 = call @advect_1d_vectorized(%2, %4, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %8 = stablehlo.broadcast_in_dim %arg2, dims = [2] : (tensor<32xf32>) -> tensor<1x1x32xf32>
    ...
    %13 = call @advect_1d_vectorized(%10, %12, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %cst_1 = stablehlo.constant dense<0.322580636> : tensor<f32>
    %16:4 = call @solve_poisson(%15, %arg3, %arg4, %arg5, %cst_1, %cst_1) : (tensor<32x32x32x32xf32>, tensor<32x1xf32>, tensor<1x17xf32>, tensor<32x17xf32>, tensor<f32>, tensor<f32>) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>)
    ...
    %cst_2 = stablehlo.constant dense<5.000000e-02> : tensor<f32>
    %22 = call @advect_1d_vectorized_1(%19, %21, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %29 = call @advect_1d_vectorized_1(%26, %28, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    %30 = stablehlo.reshape %29 : (tensor<32768x32xf32>) -> tensor<32x32x32x32xf32>
    %31 = stablehlo.broadcast_in_dim %arg2, dims = [2] : (tensor<32xf32>) -> tensor<1x1x32xf32>
    ...
    %36 = call @advect_1d_vectorized(%33, %35, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %39 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<32xf32>) -> tensor<1x32x1xf32>
    ...
    %44 = call @advect_1d_vectorized(%41, %43, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
  ...
  func.func private @advect_1d_vectorized(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    ...
    %46 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %47 = stablehlo.divide %38, %46 : tensor<32768x32xf32>
    %48 = stablehlo.subtract %45, %47 : tensor<32768x32xf32>
    %49 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %125 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %126 = stablehlo.divide %13, %125 : tensor<32768x32xf32>
    %127 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %128 = stablehlo.divide %38, %127 : tensor<32768x32xf32>
    %129 = stablehlo.subtract %126, %128 : tensor<32768x32xf32>
    %130 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
  ...
  func.func private @solve_poisson(%arg0: tensor<32x32x32x32xf32>, %arg1: tensor<32x1xf32>, %arg2: tensor<1x17xf32>, %arg3: tensor<32x17xf32>, %arg4: tensor<f32>, %arg5: tensor<f32>) -> (tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %12 = call @fft_0(%11) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    ...
    %23 = call @fft_0(%17) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    %24 = call @fft_0(%22) : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
  ...
  func.func private @fft_0(%arg0: tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32> {
    %0 = stablehlo.fft %arg0, type =  IRFFT, length = [32, 32] : (tensor<32x17xcomplex<f32>>) -> tensor<32x32xf32>
    return %0 : tensor<32x32xf32>
  }
  func.func private @advect_1d_vectorized_1(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    %0 = stablehlo.iota dim = 0 : tensor<32xf32>
    %1 = stablehlo.broadcast_in_dim %arg1, dims = [0] : (tensor<32768xf32>) -> tensor<32768x1xf32>
    %2 = stablehlo.convert %arg2 : tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<32768x1xf32>
    ...
    %28 = stablehlo.broadcast_in_dim %c_0, dims = [] : (tensor<i32>) -> tensor<32768x1x1xi32>
    ...
    %34 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<6291456xi32>
    %35 = stablehlo.compare  LT, %33, %34,  SIGNED : (tensor<6291456xi32>, tensor<6291456xi32>) -> tensor<6291456xi1>
    %c_3 = stablehlo.constant dense<1048576> : tensor<i32>
    %36 = stablehlo.broadcast_in_dim %c_3, dims = [] : (tensor<i32>) -> tensor<6291456xi32>
    ...
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %42 = call @_where_2(%24, %41, %cst) : (tensor<32768x32x6xi1>, tensor<32768x32x6xf32>, tensor<f32>) -> tensor<32768x32x6xf32>
    ...
    %47 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %58 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %61 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %62 = stablehlo.divide %13, %61 : tensor<32768x32xf32>
    %63 = stablehlo.negate %62 : tensor<32768x32xf32>
    %64 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %65 = stablehlo.multiply %64, %43 : tensor<32768x32xf32>
    %cst_8 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %66 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %67 = stablehlo.divide %65, %66 : tensor<32768x32xf32>
    %68 = stablehlo.add %63, %67 : tensor<32768x32xf32>
    %69 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %103 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %104 = stablehlo.multiply %103, %44 : tensor<32768x32xf32>
    %105 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %106 = stablehlo.divide %104, %105 : tensor<32768x32xf32>
    %107 = stablehlo.subtract %102, %106 : tensor<32768x32xf32>
    %108 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %109 = stablehlo.divide %45, %108 : tensor<32768x32xf32>
    %110 = stablehlo.subtract %107, %109 : tensor<32768x32xf32>
    %111 = stablehlo.broadcast_in_dim %cst_13, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %117 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %118 = stablehlo.divide %43, %117 : tensor<32768x32xf32>
    %119 = stablehlo.subtract %116, %118 : tensor<32768x32xf32>
    %120 = stablehlo.broadcast_in_dim %cst_14, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %121 = stablehlo.multiply %120, %44 : tensor<32768x32xf32>
    %122 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %123 = stablehlo.divide %121, %122 : tensor<32768x32xf32>
    %124 = stablehlo.add %119, %123 : tensor<32768x32xf32>
    %125 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %126 = stablehlo.divide %45, %125 : tensor<32768x32xf32>
    %127 = stablehlo.add %124, %126 : tensor<32768x32xf32>
    %128 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    ...
    %131 = stablehlo.broadcast_in_dim %cst_15, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %132 = stablehlo.divide %13, %131 : tensor<32768x32xf32>
    %133 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
    %134 = stablehlo.divide %44, %133 : tensor<32768x32xf32>
    %135 = stablehlo.subtract %132, %134 : tensor<32768x32xf32>
    %136 = stablehlo.broadcast_in_dim %cst_6, dims = [] : (tensor<f32>) -> tensor<32768x32xf32>
  ...
  func.func private @_where_2(%arg0: tensor<32768x32x6xi1>, %arg1: tensor<32768x32x6xf32>, %arg2: tensor<f32>) -> tensor<32768x32x6xf32> {
