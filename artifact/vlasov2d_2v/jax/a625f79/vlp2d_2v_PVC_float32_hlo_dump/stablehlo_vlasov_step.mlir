module @jit__lambda_ attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32x32xf32>) -> (tensor<32x32x32x32xf32> {jax.result_info = "[0]"}, tensor<32x32xf32> {jax.result_info = "[1]"}, tensor<32x32xf32> {jax.result_info = "[2]"}) {
    ...
    %22 = call @advect_1d_vectorized_1(%19, %21, %cst_7, %cst_6, %c) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %29 = call @advect_1d_vectorized_1(%26, %28, %cst_7, %cst_6, %c) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
