module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @None(%arg0: tensor<32xf32>, %arg1: tensor<6xi32>, %arg2: tensor<32xf32>, %arg3: tensor<32x1xf32>, %arg4: tensor<1x17xf32>, %arg5: tensor<32x17xf32>, %arg6: tensor<32x32x32x32xf32>, %arg7: tensor<32x32xf32>, %arg8: tensor<32x32xf32>) -> (tensor<32x32x32x32xf32>, tensor<32x32xf32>, tensor<32x32xf32>) {
    ...
    %5 = call @advect_1d_roll_diag(%2, %4, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %13 = call @advect_1d_roll_diag(%10, %12, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %22 = call @advect_1d_roll_diag_1(%19, %21, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %29 = call @advect_1d_roll_diag_1(%26, %28, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %36 = call @advect_1d_roll_diag(%33, %35, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
    ...
    %44 = call @advect_1d_roll_diag(%41, %43, %cst, %cst_0, %arg1) : (tensor<32768x32xf32>, tensor<32768xf32>, tensor<f32>, tensor<f32>, tensor<6xi32>) -> tensor<32768x32xf32>
  ...
  func.func private @advect_1d_roll_diag(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    ...
    %19 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %20 = stablehlo.divide %11, %19 : tensor<32768xf32>
    %21 = stablehlo.subtract %18, %20 : tensor<32768xf32>
    %22 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %25 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %28 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %29 = stablehlo.divide %7, %28 : tensor<32768xf32>
    %30 = stablehlo.negate %29 : tensor<32768xf32>
    %31 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %32 = stablehlo.multiply %31, %10 : tensor<32768xf32>
    %cst_4 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %33 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %34 = stablehlo.divide %32, %33 : tensor<32768xf32>
    %35 = stablehlo.add %30, %34 : tensor<32768xf32>
    %36 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %70 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %71 = stablehlo.multiply %70, %11 : tensor<32768xf32>
    %72 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %73 = stablehlo.divide %71, %72 : tensor<32768xf32>
    %74 = stablehlo.subtract %69, %73 : tensor<32768xf32>
    %75 = stablehlo.broadcast_in_dim %cst_5, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %76 = stablehlo.divide %12, %75 : tensor<32768xf32>
    %77 = stablehlo.subtract %74, %76 : tensor<32768xf32>
    %78 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %79 = stablehlo.divide %13, %78 : tensor<32768xf32>
    %80 = stablehlo.add %77, %79 : tensor<32768xf32>
    %81 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %82 = stablehlo.divide %7, %81 : tensor<32768xf32>
    %83 = stablehlo.negate %82 : tensor<32768xf32>
    %84 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %85 = stablehlo.divide %10, %84 : tensor<32768xf32>
    %86 = stablehlo.subtract %83, %85 : tensor<32768xf32>
    %87 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %88 = stablehlo.multiply %87, %11 : tensor<32768xf32>
    %89 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %90 = stablehlo.divide %88, %89 : tensor<32768xf32>
    %91 = stablehlo.add %86, %90 : tensor<32768xf32>
    %92 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %93 = stablehlo.divide %12, %92 : tensor<32768xf32>
    %94 = stablehlo.add %91, %93 : tensor<32768xf32>
    %95 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %98 = stablehlo.broadcast_in_dim %cst_11, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %99 = stablehlo.divide %7, %98 : tensor<32768xf32>
    %100 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %101 = stablehlo.divide %11, %100 : tensor<32768xf32>
    %102 = stablehlo.subtract %99, %101 : tensor<32768xf32>
    %103 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<32768xf32>
  ...
  func.func private @advect_1d_roll_diag_1(%arg0: tensor<32768x32xf32>, %arg1: tensor<32768xf32>, %arg2: tensor<f32>, %arg3: tensor<f32>, %arg4: tensor<6xi32>) -> tensor<32768x32xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %2 = stablehlo.multiply %arg1, %1 : tensor<32768xf32>
    %3 = stablehlo.convert %arg3 : tensor<f32>
  ...
  func.func private @build_v_diag_weights(%arg0: tensor<6xi32>, %arg1: tensor<32768xi32>, %arg2: tensor<32768xf32>) -> tensor<6x32768x32xf32> {
    ...
    %9 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %10 = stablehlo.divide %1, %9 : tensor<32768xf32>
    %11 = stablehlo.subtract %8, %10 : tensor<32768xf32>
    %12 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %15 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %18 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %19 = stablehlo.divide %arg2, %18 : tensor<32768xf32>
    %20 = stablehlo.negate %19 : tensor<32768xf32>
    %21 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %22 = stablehlo.multiply %21, %0 : tensor<32768xf32>
    %cst_3 = stablehlo.constant dense<3.000000e+00> : tensor<f32>
    %23 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %24 = stablehlo.divide %22, %23 : tensor<32768xf32>
    %25 = stablehlo.add %20, %24 : tensor<32768xf32>
    %26 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %52 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %53 = stablehlo.divide %3, %52 : tensor<32768xf32>
    %54 = stablehlo.subtract %51, %53 : tensor<32768xf32>
    %55 = stablehlo.broadcast_in_dim %cst_2, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %56 = stablehlo.multiply %55, %0 : tensor<32768xf32>
    %57 = stablehlo.broadcast_in_dim %cst_3, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %60 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %61 = stablehlo.multiply %60, %1 : tensor<32768xf32>
    %62 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %63 = stablehlo.divide %61, %62 : tensor<32768xf32>
    %64 = stablehlo.subtract %59, %63 : tensor<32768xf32>
    %65 = stablehlo.broadcast_in_dim %cst_4, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %66 = stablehlo.divide %2, %65 : tensor<32768xf32>
    %67 = stablehlo.subtract %64, %66 : tensor<32768xf32>
    %68 = stablehlo.broadcast_in_dim %cst_8, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %69 = stablehlo.divide %3, %68 : tensor<32768xf32>
    %70 = stablehlo.add %67, %69 : tensor<32768xf32>
    %71 = stablehlo.broadcast_in_dim %cst_7, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %72 = stablehlo.divide %arg2, %71 : tensor<32768xf32>
    %73 = stablehlo.negate %72 : tensor<32768xf32>
    %74 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %75 = stablehlo.divide %0, %74 : tensor<32768xf32>
    %76 = stablehlo.subtract %73, %75 : tensor<32768xf32>
    %77 = stablehlo.broadcast_in_dim %cst_9, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %78 = stablehlo.multiply %77, %1 : tensor<32768xf32>
    %79 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %80 = stablehlo.divide %78, %79 : tensor<32768xf32>
    %81 = stablehlo.add %76, %80 : tensor<32768xf32>
    %82 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %83 = stablehlo.divide %2, %82 : tensor<32768xf32>
    %84 = stablehlo.add %81, %83 : tensor<32768xf32>
    %85 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %88 = stablehlo.broadcast_in_dim %cst_10, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %89 = stablehlo.divide %arg2, %88 : tensor<32768xf32>
    %90 = stablehlo.broadcast_in_dim %cst_0, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    %91 = stablehlo.divide %1, %90 : tensor<32768xf32>
    %92 = stablehlo.subtract %89, %91 : tensor<32768xf32>
    %93 = stablehlo.broadcast_in_dim %cst_1, dims = [] : (tensor<f32>) -> tensor<32768xf32>
    ...
    %c_11 = stablehlo.constant dense<32> : tensor<i32>
    %116 = stablehlo.broadcast_in_dim %c_11, dims = [] : (tensor<i32>) -> tensor<6x32768x32xi32>
    ...
    %120 = call @_where_2(%118, %119, %cst_12) : (tensor<6x32768x32xi1>, tensor<6x32768x1xf32>, tensor<f32>) -> tensor<6x32768x32xf32>
    return %120 : tensor<6x32768x32xf32>
  }
  func.func private @_where_2(%arg0: tensor<6x32768x32xi1>, %arg1: tensor<6x32768x1xf32>, %arg2: tensor<f32>) -> tensor<6x32768x32xf32> {
    %0 = stablehlo.convert %arg2 : tensor<f32>
