module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @None(%arg0: tensor<32xf64>, %arg1: tensor<6xi32>, %arg2: tensor<32xf64>, %arg3: tensor<32x1xf64>, %arg4: tensor<1x17xf64>, %arg5: tensor<32x17xf64>, %arg6: tensor<32x32x32x32xf64>, %arg7: tensor<32x32xf64>, %arg8: tensor<32x32xf64>) -> (tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %13 = call @advect_1d_roll_diag(%10, %12, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %22 = call @advect_1d_roll_diag_1(%19, %21, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %29 = call @advect_1d_roll_diag_1(%26, %28, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %36 = call @advect_1d_roll_diag(%33, %35, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %44 = call @advect_1d_roll_diag(%41, %43, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
