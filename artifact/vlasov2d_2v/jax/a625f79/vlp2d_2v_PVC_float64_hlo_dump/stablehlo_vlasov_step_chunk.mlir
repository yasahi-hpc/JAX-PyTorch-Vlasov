module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @None(%arg0: tensor<32xf64>, %arg1: tensor<6xi32>, %arg2: tensor<32xf64>, %arg3: tensor<32x1xf64>, %arg4: tensor<1x17xf64>, %arg5: tensor<32x17xf64>, %arg6: tensor<32x32x32x32xf64>, %arg7: tensor<32x32xf64>, %arg8: tensor<32x32xf64>) -> (tensor<32x32x32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>) {
    ...
    %13 = call @advect_1d_vectorized(%10, %12, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %cst_1 = stablehlo.constant dense<0.32258064516129031> : tensor<f64>
    %16:4 = call @solve_poisson(%15, %arg3, %arg4, %arg5, %cst_1, %cst_1) : (tensor<32x32x32x32xf64>, tensor<32x1xf64>, tensor<1x17xf64>, tensor<32x17xf64>, tensor<f64>, tensor<f64>) -> (tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>, tensor<32x32xf64>)
    ...
    %22 = call @advect_1d_vectorized_1(%19, %21, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %29 = call @advect_1d_vectorized_1(%26, %28, %cst_2, %cst_1, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %36 = call @advect_1d_vectorized(%33, %35, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
    ...
    %44 = call @advect_1d_vectorized(%41, %43, %cst, %cst_0, %arg1) : (tensor<32768x32xf64>, tensor<32768xf64>, tensor<f64>, tensor<f64>, tensor<6xi32>) -> tensor<32768x32xf64>
