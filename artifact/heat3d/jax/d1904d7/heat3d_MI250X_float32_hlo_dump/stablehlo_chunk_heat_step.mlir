module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>, %arg2: tensor<i32>) -> (tensor<32xf32> {jax.result_info = "result[0][0]"}, tensor<32xf32> {jax.result_info = "result[0][1]"}, tensor<32xf32> {jax.result_info = "result[0][2]"}, tensor<32x32x32xf32> {jax.result_info = "result[1][0]"}, tensor<f32> {jax.result_info = "result[2]"}, tensor<i32> {jax.result_info = "result[3]"}) {
    ...
    cond {
      %c_5 = stablehlo.constant dense<100> : tensor<i32>
    ...
    %c_3 = stablehlo.constant dense<100> : tensor<i32>
  ...
  func.func private @closed_call(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
    ...
    %0 = call @heat_step(%arg0, %cst) : (tensor<32x32x32xf32>, tensor<f32>) -> tensor<32x32x32xf32>
  ...
  func.func private @heat_step(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>) -> tensor<32x32x32xf32> {
    ...
    %8 = call @remainder(%7, %c_2) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    ...
    %11 = stablehlo.broadcast_in_dim %c_3, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %12 = stablehlo.add %10, %11 : tensor<32xi32>
    %c_4 = stablehlo.constant dense<32> : tensor<i32>
    %13 = call @remainder(%12, %c_4) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %14 = call @_take_11(%arg0, %13) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %15 = stablehlo.iota dim = 0 : tensor<32xi32>
    %c_5 = stablehlo.constant dense<1> : tensor<i32>
    %16 = stablehlo.broadcast_in_dim %c_5, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %17 = stablehlo.subtract %15, %16 : tensor<32xi32>
    %c_6 = stablehlo.constant dense<32> : tensor<i32>
    %18 = call @remainder(%17, %c_6) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %19 = call @_take_11(%arg0, %18) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %20 = stablehlo.iota dim = 0 : tensor<32xi32>
    %c_7 = stablehlo.constant dense<1> : tensor<i32>
    %21 = stablehlo.broadcast_in_dim %c_7, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %22 = stablehlo.add %20, %21 : tensor<32xi32>
    %c_8 = stablehlo.constant dense<32> : tensor<i32>
    %23 = call @remainder(%22, %c_8) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %24 = call @_take_15(%arg0, %23) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %25 = stablehlo.iota dim = 0 : tensor<32xi32>
    %c_9 = stablehlo.constant dense<1> : tensor<i32>
    %26 = stablehlo.broadcast_in_dim %c_9, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %27 = stablehlo.subtract %25, %26 : tensor<32xi32>
    %c_10 = stablehlo.constant dense<32> : tensor<i32>
    %28 = call @remainder(%27, %c_10) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %29 = call @_take_15(%arg0, %28) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
  ...
  func.func private @_take(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    ...
    %4 = call @_where_4(%1, %3, %arg1) : (tensor<32xi1>, tensor<32xi32>, tensor<32xi32>) -> tensor<32xi32>
  ...
  func.func private @_where_4(%arg0: tensor<32xi1>, %arg1: tensor<32xi32>, %arg2: tensor<32xi32>) -> tensor<32xi32> {
    %0 = stablehlo.select %arg0, %arg1, %arg2 : tensor<32xi1>, tensor<32xi32>
    return %0 : tensor<32xi32>
  }
  func.func private @_take_11(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    %c = stablehlo.constant dense<0> : tensor<i32>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi32>, tensor<32xi32>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i32>
  ...
  func.func private @_take_15(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    %c = stablehlo.constant dense<0> : tensor<i32>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi32>, tensor<32xi32>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i32>
