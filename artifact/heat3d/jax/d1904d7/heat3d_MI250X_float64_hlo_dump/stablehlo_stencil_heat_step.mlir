module @jit_heat_step attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32xf64>, %arg1: tensor<f64>) -> (tensor<32x32x32xf64> {jax.result_info = "result"}) {
    %0 = call @heat_step(%arg0, %arg1) : (tensor<32x32x32xf64>, tensor<f64>) -> tensor<32x32x32xf64>
  ...
  func.func private @heat_step(%arg0: tensor<32x32x32xf64>, %arg1: tensor<f64>) -> tensor<32x32x32xf64> {
    ...
    %14 = call @_take_11(%arg0, %13) : (tensor<32x32x32xf64>, tensor<32xi64>) -> tensor<32x32x32xf64>
    ...
    %19 = call @_take_11(%arg0, %18) : (tensor<32x32x32xf64>, tensor<32xi64>) -> tensor<32x32x32xf64>
    ...
    %24 = call @_take_15(%arg0, %23) : (tensor<32x32x32xf64>, tensor<32xi64>) -> tensor<32x32x32xf64>
    ...
    %29 = call @_take_15(%arg0, %28) : (tensor<32x32x32xf64>, tensor<32xi64>) -> tensor<32x32x32xf64>
  ...
  func.func private @_take(%arg0: tensor<32x32x32xf64>, %arg1: tensor<32xi64>) -> tensor<32x32x32xf64> {
    ...
    %4 = call @_where_3(%1, %3, %arg1) : (tensor<32xi1>, tensor<32xi64>, tensor<32xi64>) -> tensor<32xi64>
  ...
  func.func private @_where_3(%arg0: tensor<32xi1>, %arg1: tensor<32xi64>, %arg2: tensor<32xi64>) -> tensor<32xi64> {
    %0 = stablehlo.select %arg0, %arg1, %arg2 : tensor<32xi1>, tensor<32xi64>
    return %0 : tensor<32xi64>
  }
  func.func private @_take_11(%arg0: tensor<32x32x32xf64>, %arg1: tensor<32xi64>) -> tensor<32x32x32xf64> {
    %c = stablehlo.constant dense<0> : tensor<i64>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i64>) -> tensor<32xi64>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi64>, tensor<32xi64>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i64>
  ...
  func.func private @_take_15(%arg0: tensor<32x32x32xf64>, %arg1: tensor<32xi64>) -> tensor<32x32x32xf64> {
    %c = stablehlo.constant dense<0> : tensor<i64>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i64>) -> tensor<32xi64>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi64>, tensor<32xi64>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i64>
