module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>, %arg2: tensor<i32>) -> (tensor<32xf32> {jax.result_info = "result[0][0]"}, tensor<32xf32> {jax.result_info = "result[0][1]"}, tensor<32xf32> {jax.result_info = "result[0][2]"}, tensor<32x32x32xf32> {jax.result_info = "result[1][0]"}, tensor<f32> {jax.result_info = "result[2]"}, tensor<i32> {jax.result_info = "result[3]"}) {
    ...
    cond {
      %c_7 = stablehlo.constant dense<20> : tensor<i32>
      %3 = stablehlo.compare  LT, %iterArg_5, %c_7,  SIGNED : (tensor<i32>, tensor<i32>) -> tensor<i1>
      stablehlo.return %3 : tensor<i1>
    } do {
      %3 = func.call @closed_call(%iterArg, %iterArg_6) : (tensor<1x1x3xf32>, tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
    ...
    %cst_3 = stablehlo.constant dense<2.000000e-02> : tensor<f32>
    %1 = stablehlo.add %arg1, %cst_3 : tensor<f32>
    %c_4 = stablehlo.constant dense<20> : tensor<i32>
  ...
  func.func private @closed_call(%arg0: tensor<1x1x3xf32>, %arg1: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
