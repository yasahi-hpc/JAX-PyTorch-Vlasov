module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  ...
  func.func private @heat_step_roll(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>) -> tensor<32x32x32xf32> {
    ...
    %1 = call @_roll_static_0(%arg0) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
    %2 = call @_roll_static_1(%arg0) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
    %3 = call @_roll_static_2(%arg0) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
    %4 = call @_roll_static_3(%arg0) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
    %5 = call @_roll_static_4(%arg0) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
  ...
  func.func private @_roll_static_0(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
  ...
  func.func private @_roll_static_2(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
  ...
  func.func private @_roll_static_3(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
  ...
  func.func private @_roll_static_4(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
