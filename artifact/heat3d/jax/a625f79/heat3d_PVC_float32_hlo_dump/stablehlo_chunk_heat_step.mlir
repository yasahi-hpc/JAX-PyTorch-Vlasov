module @jit_run_chunk attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>, %arg2: tensor<i32>) -> (tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 0>]"}, tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 1>]"}, tensor<32xf32> {jax.result_info = "[<flat index 0>][<flat index 2>]"}, tensor<32x32x32xf32> {jax.result_info = "[<flat index 1>][<flat index 0>]"}, tensor<f32> {jax.result_info = "[<flat index 2>]"}, tensor<i32> {jax.result_info = "[<flat index 3>]"}) {
    ...
    %0:2 = stablehlo.while(%iterArg = %c, %iterArg_4 = %arg0) : tensor<i32>, tensor<32x32x32xf32>
     cond {
      ...
      %3 = func.call @None(%iterArg_4) : (tensor<32x32x32xf32>) -> tensor<32x32x32xf32>
  ...
  func.func private @None(%arg0: tensor<32x32x32xf32>) -> tensor<32x32x32xf32> {
  ...
  func.func private @heat_step(%arg0: tensor<32x32x32xf32>, %arg1: tensor<f32>) -> tensor<32x32x32xf32> {
    ...
    %6 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    ...
    %11 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %12 = stablehlo.add %10, %11 : tensor<32xi32>
    %13 = call @remainder(%12, %c_0) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %14 = call @_take_1(%arg0, %13) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %15 = stablehlo.iota dim = 0 : tensor<32xi32>
    %16 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %17 = stablehlo.subtract %15, %16 : tensor<32xi32>
    %18 = call @remainder(%17, %c_0) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %19 = call @_take_1(%arg0, %18) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %20 = stablehlo.iota dim = 0 : tensor<32xi32>
    %21 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %22 = stablehlo.add %20, %21 : tensor<32xi32>
    %23 = call @remainder(%22, %c_0) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %24 = call @_take_2(%arg0, %23) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
    %25 = stablehlo.iota dim = 0 : tensor<32xi32>
    %26 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %27 = stablehlo.subtract %25, %26 : tensor<32xi32>
    %28 = call @remainder(%27, %c_0) : (tensor<32xi32>, tensor<i32>) -> tensor<32xi32>
    %29 = call @_take_2(%arg0, %28) : (tensor<32x32x32xf32>, tensor<32xi32>) -> tensor<32x32x32xf32>
  ...
  func.func private @remainder(%arg0: tensor<32xi32>, %arg1: tensor<i32>) -> tensor<32xi32> {
    ...
    %5 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %6 = stablehlo.compare  NE, %4, %5,  SIGNED : (tensor<32xi32>, tensor<32xi32>) -> tensor<32xi1>
    %7 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
  ...
  func.func private @_take(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    ...
    %4 = call @_where_0(%1, %3, %arg1) : (tensor<32xi1>, tensor<32xi32>, tensor<32xi32>) -> tensor<32xi32>
  ...
  func.func private @_where_0(%arg0: tensor<32xi1>, %arg1: tensor<32xi32>, %arg2: tensor<32xi32>) -> tensor<32xi32> {
    %0 = stablehlo.select %arg0, %arg1, %arg2 : tensor<32xi1>, tensor<32xi32>
    return %0 : tensor<32xi32>
  }
  func.func private @_take_1(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    %c = stablehlo.constant dense<0> : tensor<i32>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi32>, tensor<32xi32>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i32>
  ...
  func.func private @_take_2(%arg0: tensor<32x32x32xf32>, %arg1: tensor<32xi32>) -> tensor<32x32x32xf32> {
    %c = stablehlo.constant dense<0> : tensor<i32>
    %0 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<32xi32>
    %1 = stablehlo.compare  LT, %arg1, %0,  SIGNED : (tensor<32xi32>, tensor<32xi32>) -> tensor<32xi1>
    %c_0 = stablehlo.constant dense<32> : tensor<i32>
